...
```go
// In test/e2e/tests/kgateway_tests.go
...
.PHONY: load-test
load-test:
    TEST_PKG=./test/e2e/features/load_testing make test

.PHONY: load-test-ci
load-test-ci:
    SKIP_INSTALL=true TEST_PKG=./test/e2e/features/load_testing make test
```

...
* A way to make multiple implementations of the same extension detereminable. ie having 2 instances of extproc added to the filter chain
* Unblock all extensions that rely on these
* Not require a stage to be set and fall back on kgateway maintainers opinionated location for the extension

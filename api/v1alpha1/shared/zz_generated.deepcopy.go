...
func (in *HeaderModifiers) DeepCopyInto(out *HeaderModifiers) {
	*out = *in
	...
	if in.RequestHeadersFromSecret != nil {
		in, out := &in.RequestHeadersFromSecret, &out.RequestHeadersFromSecret
		*out = make([]SecretHeaderMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ResponseHeadersFromSecret != nil {
		in, out := &in.ResponseHeadersFromSecret, &out.ResponseHeadersFromSecret
		*out = make([]SecretHeaderMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretHeaderMapping) DeepCopyInto(out *SecretHeaderMapping) {
	*out = *in
	in.SecretRef.DeepCopyInto(&out.SecretRef)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretHeaderMapping.
func (in *SecretHeaderMapping) DeepCopy() *SecretHeaderMapping {
	if in == nil {
		return nil
	}
	out := new(SecretHeaderMapping)
	in.DeepCopyInto(out)
	return out
}

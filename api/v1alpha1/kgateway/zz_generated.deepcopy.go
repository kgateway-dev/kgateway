...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IoUring) DeepCopyInto(out *IoUring) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IoUring.
func (in *IoUring) DeepCopy() *IoUring {
	if in == nil {
		return nil
	}
	out := new(IoUring)

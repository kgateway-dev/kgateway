...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWKSBackend) DeepCopyInto(out *JWKSBackend) {
	*out = *in
	in.BackendRef.DeepCopyInto(&out.BackendRef)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWKSBackend.
func (in *JWKSBackend) DeepCopy() *JWKSBackend {
	if in == nil {
		return nil
	}
	out := new(JWKSBackend)
...
func (in *OAuth2JWTConfig) DeepCopyInto(out *OAuth2JWTConfig) {
	*out = *in
	...
	if in.JWKSBackend != nil {
		in, out := &in.JWKSBackend, &out.JWKSBackend
		*out = new(JWKSBackend)
		(*in).DeepCopyInto(*out)
	}
	if in.AccessToken != nil {

...
type JWTCache struct {
	...
	// MaxTokenSize is the maximum size, in bytes, of a single cached token. Tokens larger
	// than this are verified as usual but are not cached.
	// If unspecified, the Envoy default of 4096 is used.
	// +optional
	// +kubebuilder:validation:Minimum=1

...
func (b *PortApplyConfiguration) WithPort(value int16) *PortApplyConfiguration {
	b.Port = &value
	return b
}
...
func (b *PortApplyConfiguration) WithNodePort(value int16) *PortApplyConfiguration {
	b.NodePort = &value
	return b
}

...
func allEnvVarsSet() map[string]string {
	return map[string]string{
		...
		"KGW_XDS_SUPPRESS_NACK_RESEND":                  "false",
		"KGW_XDS_RESPOND_ON_RECONNECT":                  "false",
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedSettings: &Settings{
				...
				XdsSuppressNackResend:                 true,
				XdsRespondOnReconnect:                 true,
		...
		},
		{
			...
			expectedSettings: &Settings{
				...
				XdsSuppressNackResend:                 false,
				XdsRespondOnReconnect:                 false,

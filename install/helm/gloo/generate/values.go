...
type GatewayProxy struct {
	...
	IstioDiscoveryAddress          *string                      `json:"istioDiscoveryAddress,omitempty" desc:"discoveryAddress variable part of the PROXY_CONFIG environmental variable. Defaults to \"istiod.istio-system.svc:15012\""`
	LogLevel                       *string                      `json:"logLevel,omitempty" desc:"Level at which the pod should log. Options include \"info\", \"debug\", \"warn\", \"error\", \"panic\" and \"fatal\". Default level is info"`

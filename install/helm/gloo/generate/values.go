...
type GatewayProxyService struct {
	...
	ServiceMonitorEnabled    *bool                 `json:"serviceMonitorEnabled,omitempty" desc:"Whether or not to expose an http-monitoring port that can be scraped by a Prometheus Service Monitor. Requires that stats be enabled for the Deployment"`
	*KubeResourceOverride
}
...
type Stats struct {
	...
	ServiceMonitorEnabled *bool   `json:"serviceMonitorEnabled,omitempty" desc:"Whether or not to expose an http-monitoring port that can be scraped by a Prometheus Service Monitor. Requires that 'stats.enabled' is also true"`
	PodMonitorEnabled     *bool   `json:"podMonitorEnabled,omitempty" desc:"Whether or not to expose an http-monitoring port that can be scraped by a Prometheus Pod Monitor. Requires that 'stats.enabled' is also true"`
}

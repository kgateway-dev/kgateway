...
type Settings struct {
	...
	Helm2                         bool                 `json:"helm2,omitempty" desc:"Helm2 will be deprecated after 1.7.0. If using helm2 set to true to correctly render helm charts. Set to false by default in versions > v1.7.0."`
}

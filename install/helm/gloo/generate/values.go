...
type GatewayProxy struct {
	...
	EnvoyOverloadManager           map[string]interface{}       `json:"envoyOverloadManager,omitempty" desc:"Overload Manager to add to envoy bootstrap config. (https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/overload/v3/overload.proto#overload-manager)."`

...
type IstioIntegration struct {
	...
	// NOTE: these fields will be deprecated in a future release and are not supported with Kubernetes Gateway API.
	...
	DisableAutoinjection        *bool   `json:"disableAutoinjection,omitempty" desc:"Warning: This value is deprecated and will be removed in a future release. Also, you cannot use this value with a Kubernetes Gateway API proxy. Annotate all pods (excluding those whitelisted by other config values) to with an explicit 'do not inject' annotation to prevent Istio from adding sidecars to all pods. It's recommended that this be set to true, as some pods do not immediately work with an Istio sidecar without extra manual configuration."`

...
type GatewayProxyGatewaySettings struct {
	...
	IPv4Only                 bool              `json:"ipv4Only,omitempty" desc:"set to true if your network is ipv4 only. This will set the Gateway spec's bindAddress to 0.0.0.0 instead of ::.'"`

...
type GatewayProxyGatewaySettings struct {
	...
	DisableHttpGateway       bool                     `json:"disableHttpGateway" desc:"Set to true to disable http gateway generation."`
	DisableHttpsGateway      bool                     `json:"disableHttpsGateway" desc:"Set to true to disable https gateway generation."`

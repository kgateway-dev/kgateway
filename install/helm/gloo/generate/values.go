...
type GatewayValidation struct {
	...
	WarnMissingTlsSecret             *bool    `json:"warnMissingTlsSecret,omitempty" desc:"set this to true in order to treat missing tls secret references as warnings, causing validation to allow this state to support eventually consistent workflows. This field has no effect if allowWarnings is false or acceptAllResources is true."`

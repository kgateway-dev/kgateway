...
type Settings struct {
	...
	RegexMaxProgramSize           uint32               `json:"regexMaxProgramSize" desc:"Set this option to specify the default max program size for regexes. If not specified, defaults to 100."`

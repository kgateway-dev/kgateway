...
type GlooDeployment struct {
	...
	LivenessProbeEnabled  *bool             `json:"livenessProbeEnabled,omitempty" desc:"Does gloo have a liveness probe (default false)"`
	*DeploymentSpec
}
...
type GatewayProxyPodTemplate struct {
	...
	LivenessProbeEnabled          *bool                 `json:"livenessProbeEnabled,omitempty" desc:"enable liveness probe, Default is false"`
	Resources                     *ResourceRequirements `json:"resources,omitempty"`

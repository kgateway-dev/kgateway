...
type GatewayProxy struct {
	...
	CustomStaticLayer              interface{}                  `json:"customStaticLayer,omitempty" desc:"static layer configuration (global overrides for envoy behavior) defined in envoy bootstrap yaml https://www.envoyproxy.io/docs/envoy/latest/configuration/operations/runtime#config-runtime cannot set overload or upstream layers"`

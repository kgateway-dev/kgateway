...
type Settings struct {
	...
	RegexMaxProgramSize           uint32               `json:"regexMaxProgramSize" desc:"Set this field to specify the default max program size for RE2 "program size" which is a rough estimate of how complex the compiled regex is to evaluate. If not specified, this defaults to 100."`

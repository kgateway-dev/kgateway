...
type IstioIntegration struct {
	...
	WhitelistDiscovery   bool `json:"whitelistDiscovery,omitempty" desc:"Annotate the discovery pod for Istio sidecar injection to ensure that it gets a sidecar even when namespace-wide auto-injection is disabled'"`

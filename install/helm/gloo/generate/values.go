...
type GatewayValidation struct {
	...
	AllowMissingLinks     bool     `json:"allowMissingLinks" desc:"set this to false in order to ensure validation webhook rejects resources that would have warning status or rejected status, rather than just rejected."`

...
var _ = SynchronizedBeforeSuite(
	func() []byte {
		MustMake(".", "-C", "../..", "install/gloo-gateway.yaml", "HELMFLAGS=--namespace "+namespace+" --set namespace.create=true  --set gatewayProxies.gatewayProxyV2.service.extraAnnotations.test=test")
		return nil
	},
	func(_ []byte) {

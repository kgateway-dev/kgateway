...
var _ = Describe("Helm Test", func() {
	allTests := func(rendererTestCase renderTestCase) {
		...
		Describe(rendererTestCase.rendererName, func() {
			...
			prepareMakefile := func(namespace string, values glooeetestutils.HelmValues) {
			...
			expectRenderError := func(namespace string, values glooeetestutils.HelmValues) {
			...
			prepareMakefileFromValuesFile := func(valuesFile string) {
				prepareMakefile(namespace, glooeetestutils.HelmValues{
...
`)
			...
			It("errors rendering when gloo pdb has both maxUnavailable and minAvailable set", func() {
				expectRenderError(namespace, glooeetestutils.HelmValues{
					ValuesArgs: []string{
						"gloo.podDisruptionBudget.maxUnavailable='2'",
						"gloo.podDisruptionBudget.minAvailable='2'",
					},
  ...
  namespace: ` + namespace)
					...
					Context("custom resource lifecycle", func() {
						It("creates migration, rollout, and cleanup jobs", func() {
							prepareMakefile(namespace, glooeetestutils.HelmValues{ValuesArgs: []string{}})
...
`)
			...
			Describe("Standard k8s values", func() {
				...
				It("should error on an invalid mergePolicy", func() {
					values := glooeetestutils.HelmValues{
						ValuesArgs: []string{
...
*/
func podSecurityContextFieldsStripeGroupA(securityRoot string, extraArgs ...string) glooeetestutils.HelmValues {
	return glooeetestutils.HelmValues{
		ValuesArgs: append([]string{
...
func podSecurityContextFieldsStripeGroupB(securityRoot string, extraArgs ...string) glooeetestutils.HelmValues {
	return glooeetestutils.HelmValues{
		ValuesArgs: append([]string{
...
func securityContextFieldsStripeGroupA(securityRoot string, extraArgs ...string) glooeetestutils.HelmValues {
	return glooeetestutils.HelmValues{
		ValuesArgs: append([]string{
			securityRoot + ".runAsNonRoot=true",
...
func securityContextFieldsStripeGroupB(securityRoot string, extraArgs ...string) glooeetestutils.HelmValues {
	return glooeetestutils.HelmValues{
		ValuesArgs: append([]string{

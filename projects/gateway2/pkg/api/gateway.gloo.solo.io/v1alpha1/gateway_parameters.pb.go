...
type IstioIntegration struct {
	...
	// +optional
	CustomSidecars []*v1.Container `protobuf:"bytes,3,rep,name=custom_sidecars,json=customSidecars,proto3" json:"custom_sidecars,omitempty"`
}
...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xdf, 0x01, 0x0a, 0x10, 0x49, 0x73,
	...
	0x64, 0x65, 0x63, 0x61, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6b,
...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_depIdxs = []int32{
	...
	16, // 19: gateway.gloo.solo.io.SdsContainer.image:type_name -> kube.gateway.gloo.solo.io.Image
	17, // 20: gateway.gloo.solo.io.SdsContainer.security_context:type_name -> k8s.io.api.core.v1.SecurityContext
	18, // 21: gateway.gloo.solo.io.SdsContainer.resources:type_name -> kube.gateway.gloo.solo.io.ResourceRequirements
	7,  // 22: gateway.gloo.solo.io.SdsContainer.bootstrap:type_name -> gateway.gloo.solo.io.SdsBootstrap
	19, // 23: gateway.gloo.solo.io.SdsBootstrap.log_level:type_name -> google.protobuf.StringValue
	16, // 24: gateway.gloo.solo.io.IstioContainer.image:type_name -> kube.gateway.gloo.solo.io.Image
	17, // 25: gateway.gloo.solo.io.IstioContainer.security_context:type_name -> k8s.io.api.core.v1.SecurityContext
	18, // 26: gateway.gloo.solo.io.IstioContainer.resources:type_name -> kube.gateway.gloo.solo.io.ResourceRequirements
	19, // 27: gateway.gloo.solo.io.IstioContainer.log_level:type_name -> google.protobuf.StringValue
	19, // 28: gateway.gloo.solo.io.IstioContainer.istio_discovery_address:type_name -> google.protobuf.StringValue
	19, // 29: gateway.gloo.solo.io.IstioContainer.istio_meta_mesh_id:type_name -> google.protobuf.StringValue
	19, // 30: gateway.gloo.solo.io.IstioContainer.istio_meta_cluster_id:type_name -> google.protobuf.StringValue

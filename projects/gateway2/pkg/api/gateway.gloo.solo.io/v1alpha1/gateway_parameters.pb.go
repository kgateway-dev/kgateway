...
type SdsIntegration struct {
	...
	SdsContainer *SdsContainer `protobuf:"bytes,2,opt,name=sds_container,json=sdsContainer,proto3" json:"sds_container,omitempty"`
	// Istio integration configuration
	// If not provided, the default values will be used.
	IstioIntegration *IstioIntegration `protobuf:"bytes,7,opt,name=istio_integration,json=istioIntegration,proto3" json:"istio_integration,omitempty"`
}
...
func (x *SdsContainer) GetLogLevel() string {
	if x != nil {
		return x.LogLevel
	}
	return ""
...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x67, 0x61,
	...
	0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e,
	...
	0x65, 0x72, 0x49, 0x64, 0x22, 0x82, 0x02, 0x0a, 0x0c, 0x53, 0x64, 0x73, 0x43, 0x6f, 0x6e, 0x74,
...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_depIdxs = []int32{
	...
	11, // 3: gateway.gloo.solo.io.KubernetesProxyConfig.pod_template:type_name -> kube.gateway.gloo.solo.io.Pod
	12, // 4: gateway.gloo.solo.io.KubernetesProxyConfig.service:type_name -> kube.gateway.gloo.solo.io.Service
	13, // 5: gateway.gloo.solo.io.KubernetesProxyConfig.autoscaling:type_name -> kube.gateway.gloo.solo.io.Autoscaling
	5,  // 6: gateway.gloo.solo.io.KubernetesProxyConfig.sds:type_name -> gateway.gloo.solo.io.SdsIntegration
	14, // 7: gateway.gloo.solo.io.ProxyDeployment.replicas:type_name -> google.protobuf.UInt32Value
	4,  // 8: gateway.gloo.solo.io.EnvoyContainer.bootstrap:type_name -> gateway.gloo.solo.io.EnvoyBootstrap
	15, // 9: gateway.gloo.solo.io.EnvoyContainer.image:type_name -> kube.gateway.gloo.solo.io.Image
	16, // 10: gateway.gloo.solo.io.EnvoyContainer.security_context:type_name -> k8s.io.api.core.v1.SecurityContext
	17, // 11: gateway.gloo.solo.io.EnvoyContainer.resources:type_name -> kube.gateway.gloo.solo.io.ResourceRequirements
	10, // 12: gateway.gloo.solo.io.EnvoyBootstrap.component_log_levels:type_name -> gateway.gloo.solo.io.EnvoyBootstrap.ComponentLogLevelsEntry
	...
	18, // 15: gateway.gloo.solo.io.IstioIntegration.enabled:type_name -> google.protobuf.BoolValue

...
// Source: ./projects/gateway/pkg/api/v2alpha1/gateway_client.sk.go
...
func (m *MockGatewayWatcher) Watch(namespace string, opts clients.WatchOpts) (<-chan v2alpha1.GatewayList, <-chan error, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Watch", namespace, opts)
	ret0, _ := ret[0].(<-chan v2alpha1.GatewayList)
...
func (m *MockGatewayClient) Read(namespace, name string, opts clients.ReadOpts) (*v2alpha1.Gateway, error) {
	m.ctrl.T.Helper()
...
func (m *MockGatewayClient) Write(resource *v2alpha1.Gateway, opts clients.WriteOpts) (*v2alpha1.Gateway, error) {
	m.ctrl.T.Helper()
...
func (m *MockGatewayClient) List(namespace string, opts clients.ListOpts) (v2alpha1.GatewayList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", namespace, opts)
	ret0, _ := ret[0].(v2alpha1.GatewayList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Watch mocks base method
func (m *MockGatewayClient) Watch(namespace string, opts clients.WatchOpts) (<-chan v2alpha1.GatewayList, <-chan error, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Watch", namespace, opts)
	ret0, _ := ret[0].(<-chan v2alpha1.GatewayList)
	ret1, _ := ret[1].(<-chan error)

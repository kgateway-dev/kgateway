...
func (r *VirtualService) SetStatusForNamespace(namespace string, status *core.Status) {
...
func (r *VirtualService) GetStatusForNamespace(namespace string) *core.Status {

...
func (r *VirtualHostOption) SetNamespacedStatuses(statuses *core.NamespacedStatuses) {
...
func (r *VirtualHostOption) SetStatusForNamespace(status *core.Status) error {
...
// Note: POD_NAMESPACE environment variable must be set for this function to behave as expected.
// If unset, a podNamespaceErr is returned.
func (r *VirtualHostOption) GetStatusForNamespace() (*core.Status, error) {

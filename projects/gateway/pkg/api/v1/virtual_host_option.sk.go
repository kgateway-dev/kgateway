...
func (r *VirtualHostOption) SetStatusForNamespace(namespace string, status *core.Status) {
...
func (r *VirtualHostOption) GetStatusForNamespace(namespace string) *core.Status {

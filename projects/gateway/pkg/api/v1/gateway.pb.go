...
// source: projects/gateway/api/v1/gateway.proto
...
func (*Gateway) Descriptor() ([]byte, []int) {
	return fileDescriptor_09228a26f085b5fd, []int{0}
}
...
func (*HttpGateway) Descriptor() ([]byte, []int) {
	return fileDescriptor_09228a26f085b5fd, []int{1}
}
...
func (*TcpGateway) Descriptor() ([]byte, []int) {
	return fileDescriptor_09228a26f085b5fd, []int{2}
}
...
func init() {
	proto.RegisterFile("projects/gateway/api/v1/gateway.proto", fileDescriptor_09228a26f085b5fd)
}

var fileDescriptor_09228a26f085b5fd = []byte{
	// 729 bytes of a gzipped FileDescriptorProto
	,
}

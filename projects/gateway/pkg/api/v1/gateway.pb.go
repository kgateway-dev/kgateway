...
type VirtualServiceSelector_Expression_Operator int32

const (
	// =
	VirtualServiceSelector_Expression_Equals VirtualServiceSelector_Expression_Operator = 0
	// ==
	VirtualServiceSelector_Expression_DoubleEquals VirtualServiceSelector_Expression_Operator = 1
	// !=
	VirtualServiceSelector_Expression_NotEquals VirtualServiceSelector_Expression_Operator = 2
	// in
	VirtualServiceSelector_Expression_In VirtualServiceSelector_Expression_Operator = 3
	// notin
	VirtualServiceSelector_Expression_NotIn VirtualServiceSelector_Expression_Operator = 4
	// exists
	VirtualServiceSelector_Expression_Exists VirtualServiceSelector_Expression_Operator = 5
	// !
	VirtualServiceSelector_Expression_DoesNotExist VirtualServiceSelector_Expression_Operator = 6
	// gt
	VirtualServiceSelector_Expression_GreaterThan VirtualServiceSelector_Expression_Operator = 7
	// lt
	VirtualServiceSelector_Expression_LessThan VirtualServiceSelector_Expression_Operator = 8
)

// Enum value maps for VirtualServiceSelector_Expression_Operator.
var (
	VirtualServiceSelector_Expression_Operator_name = map[int32]string{
		0: "Equals",
		1: "DoubleEquals",
		2: "NotEquals",
		3: "In",
	...
	VirtualServiceSelector_Expression_Operator_value = map[string]int32{
		"Equals":       0,
		"DoubleEquals": 1,
		"NotEquals":    2,
		"In":           3,
...
func (x VirtualServiceSelector_Expression_Operator) Enum() *VirtualServiceSelector_Expression_Operator {
	p := new(VirtualServiceSelector_Expression_Operator)
	*p = x
	return p
}

func (x VirtualServiceSelector_Expression_Operator) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VirtualServiceSelector_Expression_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_enumTypes[0].Descriptor()
}

func (VirtualServiceSelector_Expression_Operator) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_enumTypes[0]
}

func (x VirtualServiceSelector_Expression_Operator) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VirtualServiceSelector_Expression_Operator.Descriptor instead.
func (VirtualServiceSelector_Expression_Operator) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_rawDescGZIP(), []int{3, 1, 0}
}
...
type HttpGateway struct {
	...
	// Only one of `virtualServices` or `virtualServiceSelector` should be provided.
	VirtualServiceSelector *VirtualServiceSelector `protobuf:"bytes,2,opt,name=virtual_service_selector,json=virtualServiceSelector,proto3" json:"virtual_service_selector,omitempty"`
...
func (x *HttpGateway) GetVirtualServiceSelector() *VirtualServiceSelector {
	if x != nil {
...
type VirtualServiceSelector struct {
	...
	// Namespaces to select Virtual Services from. If omitted, Gloo will only select Virtual Services in the same namespace
	// as the Virtual Service that owns this selector. The reserved value "*" can be used to
	// select Virtual Services in all namespaces watched by Gloo.
	Namespaces []string `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
	// Select Virtual Services whose labels match the ones specified here.
	...
	Expressions []*VirtualServiceSelector_Expression `protobuf:"bytes,3,rep,name=expressions,proto3" json:"expressions,omitempty"`
}

func (x *VirtualServiceSelector) Reset() {
	*x = VirtualServiceSelector{}
	if protoimpl.UnsafeEnabled {
...
func (x *VirtualServiceSelector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VirtualServiceSelector) ProtoMessage() {}

func (x *VirtualServiceSelector) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VirtualServiceSelector.ProtoReflect.Descriptor instead.
func (*VirtualServiceSelector) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_rawDescGZIP(), []int{3}
}

func (x *VirtualServiceSelector) GetNamespaces() []string {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
func (x *VirtualServiceSelector) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (x *VirtualServiceSelector) GetExpressions() []*VirtualServiceSelector_Expression {
	if x != nil {
...
type VirtualServiceSelector_Expression struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Operator VirtualServiceSelector_Expression_Operator `protobuf:"varint,2,opt,name=operator,proto3,enum=gateway.solo.io.VirtualServiceSelector_Expression_Operator" json:"operator,omitempty"`
	Values   []string                                   `protobuf:"bytes,3,rep,name=values,proto3" json:"values,omitempty"`
}

func (x *VirtualServiceSelector_Expression) Reset() {
	*x = VirtualServiceSelector_Expression{}
	if protoimpl.UnsafeEnabled {
...
func (x *VirtualServiceSelector_Expression) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VirtualServiceSelector_Expression) ProtoMessage() {}

func (x *VirtualServiceSelector_Expression) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VirtualServiceSelector_Expression.ProtoReflect.Descriptor instead.
func (*VirtualServiceSelector_Expression) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_rawDescGZIP(), []int{3, 1}
}

func (x *VirtualServiceSelector_Expression) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *VirtualServiceSelector_Expression) GetOperator() VirtualServiceSelector_Expression_Operator {
	if x != nil {
		return x.Operator
	}
	return VirtualServiceSelector_Expression_Equals
}

func (x *VirtualServiceSelector_Expression) GetValues() []string {
	if x != nil {
		return x.Values
	}
	return nil
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_rawDesc = []byte{
	...
	0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x22, 0xb1, 0x02, 0x0a, 0x0b,
	...
	0x73, 0x12, 0x61, 0x0a, 0x18, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x5f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x73, 0x6f,
	0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x16, 0x76, 0x69,
	0x72, 0x74, 0x75, 0x61, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x12, 0x3c, 0x0a, 0x1a, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x5f,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb2, 0x04,
	...
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x12, 0x4b, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65,
	0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77,
	...
	0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x54, 0x0a, 0x0b, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x67, 0x61, 0x74,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x99, 0x02, 0x0a, 0x0a, 0x45, 0x78, 0x70, 0x72, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x57, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61,
	0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3b, 0x2e, 0x67, 0x61, 0x74, 0x65,
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_goTypes = []interface{}{
	(VirtualServiceSelector_Expression_Operator)(0), // 0: gateway.solo.io.VirtualServiceSelector.Expression.Operator
	...
	(*VirtualServiceSelector)(nil), // 4: gateway.solo.io.VirtualServiceSelector
	nil,                            // 5: gateway.solo.io.VirtualServiceSelector.LabelsEntry
	(*VirtualServiceSelector_Expression)(nil), // 6: gateway.solo.io.VirtualServiceSelector.Expression
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_depIdxs = []int32{
	...
	4,  // 8: gateway.solo.io.HttpGateway.virtual_service_selector:type_name -> gateway.solo.io.VirtualServiceSelector
	13, // 9: gateway.solo.io.HttpGateway.options:type_name -> gloo.solo.io.HttpListenerOptions
	14, // 10: gateway.solo.io.TcpGateway.tcp_hosts:type_name -> gloo.solo.io.TcpHost
	15, // 11: gateway.solo.io.TcpGateway.options:type_name -> gloo.solo.io.TcpListenerOptions
	5,  // 12: gateway.solo.io.VirtualServiceSelector.labels:type_name -> gateway.solo.io.VirtualServiceSelector.LabelsEntry
	6,  // 13: gateway.solo.io.VirtualServiceSelector.expressions:type_name -> gateway.solo.io.VirtualServiceSelector.Expression
	0,  // 14: gateway.solo.io.VirtualServiceSelector.Expression.operator:type_name -> gateway.solo.io.VirtualServiceSelector.Expression.Operator
...
func file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VirtualServiceSelector); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VirtualServiceSelector_Expression); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

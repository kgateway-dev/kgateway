...
func (x *Gateway) GetMultiHttpGateway() *MultiHttpGateway {
	if x, ok := x.GetGatewayType().(*Gateway_MultiHttpGateway); ok {
		return x.MultiHttpGateway
	}
	return nil
}
...
type Gateway_MultiHttpGateway struct {
	MultiHttpGateway *MultiHttpGateway `protobuf:"bytes,15,opt,name=multi_http_gateway,json=multiHttpGateway,proto3,oneof"`
}
...
func (*Gateway_MultiHttpGateway) isGateway_GatewayType() {}
...
type MultiHttpGateway struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// How to select MatchableHttpGateways to aggregate
	//
	// Types that are assignable to SelectionType:
	//	*MultiHttpGateway_Ref
	//	*MultiHttpGateway_Selector
	SelectionType isMultiHttpGateway_SelectionType `protobuf_oneof:"selection_type"`
}

func (x *MultiHttpGateway) Reset() {
	*x = MultiHttpGateway{}
	if protoimpl.UnsafeEnabled {
...
func (x *MultiHttpGateway) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MultiHttpGateway) ProtoMessage() {}

func (x *MultiHttpGateway) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MultiHttpGateway.ProtoReflect.Descriptor instead.
func (*MultiHttpGateway) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_rawDescGZIP(), []int{3}
}

func (m *MultiHttpGateway) GetSelectionType() isMultiHttpGateway_SelectionType {
	if m != nil {
...
func (x *MultiHttpGateway) GetRef() *core.ResourceRef {
	if x, ok := x.GetSelectionType().(*MultiHttpGateway_Ref); ok {
		return x.Ref
	}
	return nil
}

func (x *MultiHttpGateway) GetSelector() *selectors.Selector {
	if x, ok := x.GetSelectionType().(*MultiHttpGateway_Selector); ok {
		return x.Selector
	}
	return nil
}

type isMultiHttpGateway_SelectionType interface {
	isMultiHttpGateway_SelectionType()
}

type MultiHttpGateway_Ref struct {
...
type MultiHttpGateway_Selector struct {
...
func (*MultiHttpGateway_Ref) isMultiHttpGateway_SelectionType() {}

func (*MultiHttpGateway_Selector) isMultiHttpGateway_SelectionType() {}
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_rawDesc = []byte{
	...
	0xa8, 0x06, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x73,
	...
	0x48, 0x00, 0x52, 0x0a, 0x74, 0x63, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x4b,
	...
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x42, 0x02, 0x18, 0x01, 0x48, 0x00, 0x52, 0x0d, 0x68, 0x79,
	0x62, 0x72, 0x69, 0x64, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x51, 0x0a, 0x12, 0x6d,
	0x75, 0x6c, 0x74, 0x69, 0x5f, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x48,
	0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x48, 0x00, 0x52, 0x10, 0x6d, 0x75,
	0x6c, 0x74, 0x69, 0x48, 0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x1f,
	...
	0x54, 0x79, 0x70, 0x65, 0x4a, 0x04, 0x08, 0x06, 0x10, 0x07, 0x22, 0x7c, 0x0a, 0x0a, 0x54, 0x63,
	...
	0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x5b, 0x0a, 0x0d, 0x48, 0x79, 0x62, 0x72,
	...
	0x65, 0x77, 0x61, 0x79, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x10, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x48,
	0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x2d, 0x0a, 0x03, 0x72, 0x65,
	...
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x73, 0x65,
	...
	0x74, 0x65, 0x77, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x22, 0x9c, 0x01, 0x0a, 0x07, 0x4d, 0x61,
	...
	0x69, 0x78, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x42, 0x41, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68,
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_goTypes = []interface{}{
	...
	(*MultiHttpGateway)(nil),             // 3: gateway.solo.io.MultiHttpGateway
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_gateway_proto_depIdxs = []int32{
	...
	3,  // 7: gateway.solo.io.Gateway.multi_http_gateway:type_name -> gateway.solo.io.MultiHttpGateway
	11, // 8: gateway.solo.io.Gateway.route_options:type_name -> gloo.solo.io.RouteConfigurationOptions
	12, // 9: gateway.solo.io.TcpGateway.tcp_hosts:type_name -> gloo.solo.io.TcpHost
	13, // 10: gateway.solo.io.TcpGateway.options:type_name -> gloo.solo.io.TcpListenerOptions
	4,  // 11: gateway.solo.io.HybridGateway.matched_gateways:type_name -> gateway.solo.io.MatchedGateway
	14, // 12: gateway.solo.io.MultiHttpGateway.ref:type_name -> core.solo.io.ResourceRef
	15, // 13: gateway.solo.io.MultiHttpGateway.selector:type_name -> selectors.core.gloo.solo.io.Selector

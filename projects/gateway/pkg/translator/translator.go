...
type Translator interface {
	Translate(ctx context.Context, proxyName, namespace string, snap *gloov1snap.ApiSnapshot, filteredGateways v1.GatewayList) (*gloov1.Proxy, reporter.ResourceReports)
}
...
func (t *GwTranslator) Translate(ctx context.Context, proxyName, namespace string, snap *gloov1snap.ApiSnapshot, gatewaysByProxy v1.GatewayList) (*gloov1.Proxy, reporter.ResourceReports) {

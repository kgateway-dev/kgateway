...
func (m *MockTranslator) Translate(arg0 context.Context, arg1, arg2 string, arg3 *gloosnapshot.ApiSnapshot, arg4 v1.GatewayList) (*v10.Proxy, reporter.ResourceReports) {
	m.ctrl.T.Helper()

...
type GetProxy struct {
	...
	// K8sGatewaySource is true if the GetProxy request should only consider Proxy resources
	// that were generated by the K8s Gateway Translation
	K8sGatewaySource bool

	// EdgeGatewaySource is true if the GetProxy request should only consider Proxy resources

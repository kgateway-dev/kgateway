...
func AddVaultSecretFlags(set *pflag.FlagSet, vault *options.Vault) {
	...
	set.StringVar(&vault.PathPrefix, "vault-path-prefix", bootstrap.DefaultPathPrefix, "The path prefix tells Vault which Secrets Engine to which it should route traffic.")

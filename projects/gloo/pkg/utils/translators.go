...
const (
	// ProxyId is the label key applied to Proxies as a unique identifier
	ProxyId = "proxy_id"

	// ProxyTypeKey is the label key applied to Proxies generated by the Gloo Edge translator
	ProxyTypeKey = "created_by"

	// GlooEdgeProxyValue is the label value for ProxyTypeKey applied to ProxyId CRs
	// that have been generated from Gloo Edge Gateway API resources
	GlooEdgeProxyValue = "gloo-gateway"

	// GatewayApiProxyValue is the label value for ProxyTypeKey applied to ProxyId CRs
	...
	// GatewayNamespaceKey is the label key applied to a ProxyId CR
	// The value represents the namespace of the Gateway resource that generated it
	// This will only exist on ProxyId CRs that have been generated from Kubernetes Gateway CRs

...
func (m *MockConsulWatcher) WatchServices(ctx context.Context, dataCenters []string, filter string, cm consul.ConsulConsistencyModes, queryOpts *consul.QueryOptions) (<-chan []*consul0.ServiceMeta, <-chan error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchServices", ctx, dataCenters, filter, cm, queryOpts)
...
func (mr *MockConsulWatcherMockRecorder) WatchServices(ctx, dataCenters, filter, cm, queryOpts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchServices", reflect.TypeOf((*MockConsulWatcher)(nil).WatchServices), ctx, dataCenters, filter, cm, queryOpts)
}

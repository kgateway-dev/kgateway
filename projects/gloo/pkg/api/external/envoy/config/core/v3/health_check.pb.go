...
type HealthCheck_HttpHealthCheck struct {
	...
	ExpectedStatuses []*v31.Int64Range `protobuf:"bytes,9,rep,name=expected_statuses,json=expectedStatuses,proto3" json:"expected_statuses,omitempty"`
	// Use specified application protocol for health checks.
	CodecClientType v31.CodecClientType `protobuf:"varint,10,opt,name=codec_client_type,json=codecClientType,proto3,enum=solo.io.envoy.type.v3.CodecClientType" json:"codec_client_type,omitempty"`
	// An optional service name parameter which is used to validate the identity of
	// the health checked cluster using a :ref:`StringMatcher
	// <envoy_api_msg_type.matcher.v3.StringMatcher>`. See the :ref:`architecture overview
	// <arch_overview_health_checking_identity>` for more information.
	ServiceNameMatcher *v32.StringMatcher `protobuf:"bytes,11,opt,name=service_name_matcher,json=serviceNameMatcher,proto3" json:"service_name_matcher,omitempty"`
}
...
func (x *HealthCheck_HttpHealthCheck) GetRequestHeadersToAdd() []*v3.HeaderValueOption {
	if x != nil {
...
func (x *HealthCheck_HttpHealthCheck) GetExpectedStatuses() []*v31.Int64Range {
	if x != nil {
...
func (x *HealthCheck_HttpHealthCheck) GetCodecClientType() v31.CodecClientType {
	if x != nil {
		return x.CodecClientType
	}
	return v31.CodecClientType_HTTP1
}

func (x *HealthCheck_HttpHealthCheck) GetServiceNameMatcher() *v32.StringMatcher {
	if x != nil {
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x55, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x33, 0x2f, 0x68, 0x74, 0x74, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x4c, 0x67, 0x69,
	...
	0x0a, 0x08, 0x44, 0x45, 0x47, 0x52, 0x41, 0x44, 0x45, 0x44, 0x10, 0x05, 0x42, 0x9d, 0x01, 0x0a,
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_proto_goTypes = []interface{}{
	...
	(*v3.HeaderValueOption)(nil),          // 14: solo.io.envoy.config.core.v3.HeaderValueOption
	(*v31.Int64Range)(nil),                // 15: solo.io.envoy.type.v3.Int64Range
	(v31.CodecClientType)(0),              // 16: solo.io.envoy.type.v3.CodecClientType
	(*v32.StringMatcher)(nil),             // 17: solo.io.envoy.type.matcher.v3.StringMatcher

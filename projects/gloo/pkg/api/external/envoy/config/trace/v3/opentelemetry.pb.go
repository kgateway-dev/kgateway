...
type OpenTelemetryConfig struct {
	...
	ServiceNameSource *OpenTelemetryConfig_ServiceNameSource `protobuf:"bytes,3,opt,name=service_name_source,json=serviceNameSource,proto3" json:"service_name_source,omitempty"`
}
...
type OpenTelemetryConfig_ServiceNameSource struct {
	...
	//
	//	*OpenTelemetryConfig_ServiceNameSource_GatewayName_
...
func (x *OpenTelemetryConfig_ServiceNameSource) GetGatewayName() *OpenTelemetryConfig_ServiceNameSource_GatewayName {
	if x, ok := x.GetSourceType().(*OpenTelemetryConfig_ServiceNameSource_GatewayName_); ok {
...
type OpenTelemetryConfig_ServiceNameSource_GatewayName_ struct {
	// Use the name of the gateway under which the collector is configured as the `service.name`
	// This is the default behavior.
	// The details of how the gateway name is determined are documented [here](https://github.com/solo-io/gloo/tree/main/devel/architecture/static_metadata.md)
	GatewayName *OpenTelemetryConfig_ServiceNameSource_GatewayName `protobuf:"bytes,1,opt,name=gateway_name,json=gatewayName,proto3,oneof"`
}

func (*OpenTelemetryConfig_ServiceNameSource_GatewayName_) isOpenTelemetryConfig_ServiceNameSource_SourceType() {
}
...
func (x *OpenTelemetryConfig_ServiceNameSource_GatewayName) Reset() {
	*x = OpenTelemetryConfig_ServiceNameSource_GatewayName{}
	if protoimpl.UnsafeEnabled {
...
func (x *OpenTelemetryConfig_ServiceNameSource_GatewayName) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpenTelemetryConfig_ServiceNameSource_GatewayName) ProtoMessage() {}

func (x *OpenTelemetryConfig_ServiceNameSource_GatewayName) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpenTelemetryConfig_ServiceNameSource_GatewayName.ProtoReflect.Descriptor instead.
func (*OpenTelemetryConfig_ServiceNameSource_GatewayName) Descriptor() ([]byte, []int) {
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_rawDesc = []byte{
	...
	0x2f, 0x65, 0x78, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf6, 0x03, 0x0a, 0x13, 0x4f,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x44, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69,
	...
	0x1a, 0xa8, 0x01, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65,
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x75, 0x0a, 0x0c, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x50, 0x2e, 0x73,
	...
	0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x53, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x48, 0x00,
	0x52, 0x0b, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x0d, 0x0a,
	0x0b, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x0d, 0x0a, 0x0b,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x3a, 0x31, 0x8a, 0xc8, 0xde,
	...
	0x74, 0x65, 0x72, 0x42, 0xdb, 0x01, 0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5, 0x04, 0x01, 0xd0, 0xf5,
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_goTypes = []interface{}{
	...
	(*OpenTelemetryConfig_ServiceNameSource_GatewayName)(nil), // 2: solo.io.envoy.config.trace.v3.OpenTelemetryConfig.ServiceNameSource.GatewayName
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_depIdxs = []int32{
	...
	2, // 2: solo.io.envoy.config.trace.v3.OpenTelemetryConfig.ServiceNameSource.gateway_name:type_name -> solo.io.envoy.config.trace.v3.OpenTelemetryConfig.ServiceNameSource.GatewayName
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OpenTelemetryConfig_ServiceNameSource_GatewayName); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*OpenTelemetryConfig_ServiceNameSource_GatewayName_)(nil),
	}
	type x struct{}

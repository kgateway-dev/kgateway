...
type Executor_Remote struct {
	...
	UpstreamRef string                               `protobuf:"bytes,1,opt,name=upstream_ref,json=upstreamRef,proto3" json:"upstream_ref,omitempty"`
...
func (x *Executor_Remote) GetUpstreamRef() string {
	if x != nil {
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0xe7, 0x08, 0x0a, 0x08, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x12,
	...
	0x08, 0x6d, 0x61, 0x78, 0x44, 0x65, 0x70, 0x74, 0x68, 0x1a, 0x84, 0x06, 0x0a, 0x06, 0x52, 0x65,
	0x6d, 0x6f, 0x74, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x75, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x5f, 0x72, 0x65, 0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x75, 0x70, 0x73, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x66, 0x12, 0x62, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79,
	...
	0x73, 0x70, 0x61, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x51, 0x0a, 0x0a, 0x45, 0x78, 0x74, 0x72,
	...
	0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00,
	0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x42, 0x11, 0x0a, 0x0f, 0x65, 0x78, 0x74, 0x72,
	...
	0x42, 0x0a, 0x0a, 0x08, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x42, 0xaa, 0x01, 0x0a,
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_goTypes = []interface{}{
	...
	nil,                             // 43: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.HeadersEntry
	nil,                             // 44: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.QueryParamsEntry
	(*v3.HttpUri)(nil),              // 45: solo.io.envoy.config.core.v3.HttpUri
	(*v3.DataSource)(nil),           // 46: solo.io.envoy.config.core.v3.DataSource
	(*v3.TypedExtensionConfig)(nil), // 47: solo.io.envoy.config.core.v3.TypedExtensionConfig
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_depIdxs = []int32{
	...
	45, // 14: envoy.config.filter.http.graphql.v2.RESTResolver.server_uri:type_name -> solo.io.envoy.config.core.v3.HttpUri
	...
	46, // 19: envoy.config.filter.http.graphql.v2.GrpcDescriptorRegistry.proto_descriptors:type_name -> solo.io.envoy.config.core.v3.DataSource
	45, // 20: envoy.config.filter.http.graphql.v2.GrpcResolver.server_uri:type_name -> solo.io.envoy.config.core.v3.HttpUri
	...
	47, // 25: envoy.config.filter.http.graphql.v2.Resolution.resolver:type_name -> solo.io.envoy.config.core.v3.TypedExtensionConfig
	...
	48, // 27: envoy.config.filter.http.graphql.v2.CacheControl.max_age:type_name -> google.protobuf.UInt32Value
	...
	46, // 31: envoy.config.filter.http.graphql.v2.ExecutableSchema.schema_definition:type_name -> solo.io.envoy.config.core.v3.DataSource
	...
	49, // 47: envoy.config.filter.http.graphql.v2.ExecutableSchema.ExtensionsEntry.value:type_name -> google.protobuf.Any
	...
	42, // 49: envoy.config.filter.http.graphql.v2.Executor.Remote.request:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest
	43, // 50: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.headers:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.HeadersEntry
	44, // 51: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.query_params:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.QueryParamsEntry
	41, // 52: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.HeadersEntry.value:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.Extraction
	41, // 53: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.QueryParamsEntry.value:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.Extraction

...
func (x *Executor_Remote_RemoteSchemaRequest) GetHeaders() map[string]string {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *Executor_Remote_RemoteSchemaRequest) GetQueryParams() map[string]string {
	if x != nil {
		return x.QueryParams
	}
	return nil
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0x92, 0x07, 0x0a, 0x08, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x12,
	...
	0x08, 0x6d, 0x61, 0x78, 0x44, 0x65, 0x70, 0x74, 0x68, 0x1a, 0xaf, 0x04, 0x0a, 0x06, 0x52, 0x65,
	...
	0x73, 0x70, 0x61, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x80, 0x03, 0x0a, 0x13, 0x52, 0x65, 0x6d,
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_goTypes = []interface{}{
	...
	(*Executor_Remote_RemoteSchemaRequest)(nil), // 41: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest
	nil,                             // 42: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.HeadersEntry
	nil,                             // 43: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.QueryParamsEntry
	(*v3.HttpUri)(nil),              // 44: solo.io.envoy.config.core.v3.HttpUri
	(*v3.DataSource)(nil),           // 45: solo.io.envoy.config.core.v3.DataSource
	(*v3.TypedExtensionConfig)(nil), // 46: solo.io.envoy.config.core.v3.TypedExtensionConfig
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_graphql_graphql_proto_depIdxs = []int32{
	...
	44, // 14: envoy.config.filter.http.graphql.v2.RESTResolver.server_uri:type_name -> solo.io.envoy.config.core.v3.HttpUri
	...
	45, // 19: envoy.config.filter.http.graphql.v2.GrpcDescriptorRegistry.proto_descriptors:type_name -> solo.io.envoy.config.core.v3.DataSource
	44, // 20: envoy.config.filter.http.graphql.v2.GrpcResolver.server_uri:type_name -> solo.io.envoy.config.core.v3.HttpUri
	...
	46, // 25: envoy.config.filter.http.graphql.v2.Resolution.resolver:type_name -> solo.io.envoy.config.core.v3.TypedExtensionConfig
	...
	47, // 27: envoy.config.filter.http.graphql.v2.CacheControl.max_age:type_name -> google.protobuf.UInt32Value
	...
	45, // 31: envoy.config.filter.http.graphql.v2.ExecutableSchema.schema_definition:type_name -> solo.io.envoy.config.core.v3.DataSource
	...
	48, // 47: envoy.config.filter.http.graphql.v2.ExecutableSchema.ExtensionsEntry.value:type_name -> google.protobuf.Any
	...
	41, // 49: envoy.config.filter.http.graphql.v2.Executor.Remote.request:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest
	42, // 50: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.headers:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.HeadersEntry
	43, // 51: envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.query_params:type_name -> envoy.config.filter.http.graphql.v2.Executor.Remote.RemoteSchemaRequest.QueryParamsEntry

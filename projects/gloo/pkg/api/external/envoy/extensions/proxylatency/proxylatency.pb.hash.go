...
func (m *ProxyLatency) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.filter.http.proxylatency.v2.github.com/solo-io/gloo/projects/gloo/pkg/api/external/envoy/extensions/proxylatency.ProxyLatency")); err != nil {
		return 0, err
	}

...
// source: projects/gloo/api/external/envoy/api/v2/core/health_check.proto
...
func (HealthStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0}
}
...
func (*HealthCheck_Payload) Descriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0, 0}
}
...
func (*HealthCheck_HttpHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0, 1}
}
...
func (*HealthCheck_TcpHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0, 2}
}
...
func (*HealthCheck_RedisHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0, 3}
}
...
func (*HealthCheck_GrpcHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0, 4}
}
...
func (*HealthCheck_CustomHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_9720647a283397a3, []int{0, 5}
}
...
func init() {
	proto.RegisterFile("projects/gloo/api/external/envoy/api/v2/core/health_check.proto", fileDescriptor_9720647a283397a3)
}

var fileDescriptor_9720647a283397a3 = []byte{
	...
	,
}

...
func (m *AdaptiveRequestConcurrencyPolicySpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.AdaptiveRequestConcurrencyPolicySpec")); err != nil {
		return 0, err
	}
...
func (m *AdaptiveRequestConcurrencyPolicySpec_MinRoundtripTimeCalculationParams) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.AdaptiveRequestConcurrencyPolicySpec_MinRoundtripTimeCalculationParams")); err != nil {
		return 0, err
	}

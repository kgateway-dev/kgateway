...
func (m *ConnectionBalanceConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *ConnectionBalanceConfig_ExtendBalance:
		...
		if h, ok := interface{}(m.GetExtendBalance()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("ExtendBalance")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetExtendBalance(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("ExtendBalance")); err != nil {
					return 0, err
...
func (m *TypedExtensionConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.TypedExtensionConfig")); err != nil {
		return 0, err
	}

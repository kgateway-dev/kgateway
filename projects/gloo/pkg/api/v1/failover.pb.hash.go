...
// Hash function
func (m *Failover_PrioritizedLocality_LocalityLbEndpoints) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.Failover_PrioritizedLocality_LocalityLbEndpoints")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *Failover_PrioritizedLocality_LocalityLbEndpoints_LbEndpoint) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.Failover_PrioritizedLocality_LocalityLbEndpoints_LbEndpoint")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *Failover_PrioritizedLocality_LocalityLbEndpoints_LbEndpoint_HealthCheckConfig) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.Failover_PrioritizedLocality_LocalityLbEndpoints_LbEndpoint_HealthCheckConfig")); err != nil {
		return 0, err
	}

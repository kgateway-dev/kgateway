...
type Failover_PrioritizedLocality struct {
	...
	KubeServices         []*Failover_PrioritizedLocality_ServiceRef `protobuf:"bytes,2,rep,name=kube_services,json=kubeServices,proto3" json:"kube_services,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                   `json:"-"`
	XXX_unrecognized     []byte                                     `json:"-"`
	XXX_sizecache        int32                                      `json:"-"`
}
...
func (m *Failover_PrioritizedLocality) GetKubeServices() []*Failover_PrioritizedLocality_ServiceRef {
	if m != nil {
...
type Failover_PrioritizedLocality_ServiceRef struct {
...
func (m *Failover_PrioritizedLocality_ServiceRef) Reset() {
	*m = Failover_PrioritizedLocality_ServiceRef{}
}
func (m *Failover_PrioritizedLocality_ServiceRef) String() string { return proto.CompactTextString(m) }
func (*Failover_PrioritizedLocality_ServiceRef) ProtoMessage()    {}
func (*Failover_PrioritizedLocality_ServiceRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_78ccbfab63a57f32, []int{0, 0, 0}
}
func (m *Failover_PrioritizedLocality_ServiceRef) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Failover_PrioritizedLocality_ServiceRef.Unmarshal(m, b)
}
func (m *Failover_PrioritizedLocality_ServiceRef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Failover_PrioritizedLocality_ServiceRef.Marshal(b, m, deterministic)
}
func (m *Failover_PrioritizedLocality_ServiceRef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Failover_PrioritizedLocality_ServiceRef.Merge(m, src)
}
func (m *Failover_PrioritizedLocality_ServiceRef) XXX_Size() int {
	return xxx_messageInfo_Failover_PrioritizedLocality_ServiceRef.Size(m)
}
func (m *Failover_PrioritizedLocality_ServiceRef) XXX_DiscardUnknown() {
	xxx_messageInfo_Failover_PrioritizedLocality_ServiceRef.DiscardUnknown(m)
}

var xxx_messageInfo_Failover_PrioritizedLocality_ServiceRef proto.InternalMessageInfo

func (m *Failover_PrioritizedLocality_ServiceRef) GetServiceName() string {
	if m != nil {
...
func (m *Failover_PrioritizedLocality_ServiceRef) GetServiceNamespace() string {
	if m != nil {
...
func (m *Failover_PrioritizedLocality_ServiceRef) GetServicePort() uint32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Failover_PrioritizedLocality_ServiceRef)(nil), "gloo.solo.io.Failover.PrioritizedLocality.ServiceRef")
...
var fileDescriptor_78ccbfab63a57f32 = []byte{
	...
	,
}
...
func (this *Failover_PrioritizedLocality_ServiceRef) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Failover_PrioritizedLocality_ServiceRef)
	if !ok {
		that2, ok := that.(Failover_PrioritizedLocality_ServiceRef)
		if ok {
			that1 = &that2
		} else {
			return false

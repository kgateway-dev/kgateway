...
func (*ServiceSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c38363714ea465d8, []int{0}
}
...
func (*ServiceSpec_GrpcService) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c38363714ea465d8, []int{0, 0}
}
...
func (*DestinationSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c38363714ea465d8, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo/projects/gloo/api/v1/plugins/grpc/grpc.proto", fileDescriptor_grpc_c38363714ea465d8)
}

var fileDescriptor_grpc_c38363714ea465d8 = []byte{

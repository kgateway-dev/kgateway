...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_dlp_dlp_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3a, 0x0a,
	...
	0x6c, 0x65, 0x64, 0x46, 0x6f, 0x72, 0x22, 0x3e, 0x0a, 0x09, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	0x46, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x0e, 0x4f, 0x4e, 0x4c, 0x59, 0x5f, 0x52, 0x45, 0x53, 0x50,
	0x4f, 0x4e, 0x53, 0x45, 0x53, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x4f, 0x4e, 0x4c, 0x59, 0x5f,
	...
	0x44, 0x53, 0x10, 0x09, 0x22, 0x8c, 0x01, 0x0a, 0x0c, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x41,
	...
	0x65, 0x6e, 0x74, 0x42, 0x51, 0x5a, 0x47, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x73, 0x65, 0x2f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x64, 0x6c, 0x70, 0xc0, 0xf5,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_dlp_dlp_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_dlp_dlp_proto_goTypes = []interface{}{
	(Config_EnableFor)(0),    // 0: dlp.options.gloo.solo.io.Config.EnableFor
	(Action_ActionType)(0),   // 1: dlp.options.gloo.solo.io.Action.ActionType
	(*FilterConfig)(nil),     // 2: dlp.options.gloo.solo.io.FilterConfig
	(*DlpRule)(nil),          // 3: dlp.options.gloo.solo.io.DlpRule
	(*Config)(nil),           // 4: dlp.options.gloo.solo.io.Config
	(*Action)(nil),           // 5: dlp.options.gloo.solo.io.Action
	(*CustomAction)(nil),     // 6: dlp.options.gloo.solo.io.CustomAction
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_dlp_dlp_proto_depIdxs = []int32{
	3, // 0: dlp.options.gloo.solo.io.FilterConfig.dlp_rules:type_name -> dlp.options.gloo.solo.io.DlpRule
	7, // 1: dlp.options.gloo.solo.io.DlpRule.matcher:type_name -> matchers.core.gloo.solo.io.Matcher
	5, // 2: dlp.options.gloo.solo.io.DlpRule.actions:type_name -> dlp.options.gloo.solo.io.Action
	5, // 3: dlp.options.gloo.solo.io.Config.actions:type_name -> dlp.options.gloo.solo.io.Action
	0, // 4: dlp.options.gloo.solo.io.Config.enabled_for:type_name -> dlp.options.gloo.solo.io.Config.EnableFor
	1, // 5: dlp.options.gloo.solo.io.Action.action_type:type_name -> dlp.options.gloo.solo.io.Action.ActionType
	6, // 6: dlp.options.gloo.solo.io.Action.custom_action:type_name -> dlp.options.gloo.solo.io.CustomAction
	8, // 7: dlp.options.gloo.solo.io.CustomAction.percent:type_name -> solo.io.envoy.type.Percent

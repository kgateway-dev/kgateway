...
func (m *Failover_PrioritizedLocality) Hash(hasher hash.Hash64) (uint64, error) {
	...
	switch m.DiscoveryMethod.(type) {

	case *Failover_PrioritizedLocality_Explicit_:
	...
	case *Failover_PrioritizedLocality_KubeService:
...
// Hash function
func (m *Failover_PrioritizedLocality_Explicit) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("failover.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/failover.Failover_PrioritizedLocality_Explicit")); err != nil {
		return 0, err
	}

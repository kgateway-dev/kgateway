...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("graphqlapis"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Graphql().V1beta1().GraphQLApis().Informer()}, nil

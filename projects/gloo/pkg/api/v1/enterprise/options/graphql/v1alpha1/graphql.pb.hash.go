...
func (m *RESTResolver) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetServerUri()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("ServerUri")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetServerUri(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("ServerUri")); err != nil {
				return 0, err
...
// Hash function
func (m *RESTResolverCP) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *SubgraphResolver) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *ConstantResolver) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *AbstractTypeResolver) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *Query) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if h, ok := interface{}(m.GetQuery()).(safe_hasher.SafeHasher); ok {
		...
		if fieldValue, err := hashstructure.Hash(m.GetQuery(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("Query")); err != nil {
				return 0, err
...
func (m *Resolution) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *Resolution_DefaultResolver:
		...
		if h, ok := interface{}(m.GetDefaultResolver()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("DefaultResolver")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetDefaultResolver(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("DefaultResolver")); err != nil {
					return 0, err
...
// Hash function
func (m *GraphQLConfig) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *GraphQLExtendedSchema) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *ValueProvider_TypedValueProvider_GraphQLParentExtraction) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *RESTResolverCP_OpenApi) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte(m.GetBaseUrl())); err != nil {
		return 0, err
	}
...
// Hash function
func (m *RESTResolverCP_OpenApi_RemoteSource) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	case *RESTResolverCP_OpenApi_RemoteSource_RemoteFile:
		...
		if _, err = hasher.Write([]byte(m.GetRemoteFile())); err != nil {
			return 0, err
		}

	case *RESTResolverCP_OpenApi_RemoteSource_UrlEndpoint:

		if _, err = hasher.Write([]byte(m.GetUrlEndpoint())); err != nil {
			return 0, err
		}
...
// Hash function
func (m *RESTResolverCP_OpenApi_SelectQueryOrMutationField) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {

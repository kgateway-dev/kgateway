...
type JWTPrincipal struct {
	...
	// All claims must be present on the JWT. Nested claims, such as 'parent.child.foo', may also be used; however,
	// the Policy must have a non-empty string value set for `nested_claim_delimiter`.

...
func (x *Embedding) GetGemini() *Embedding_Gemini {
	if x, ok := x.GetEmbedding().(*Embedding_Gemini_); ok {
		return x.Gemini
	}
	return nil
}
...
type Embedding_Gemini_ struct {
	// Gemini embedding
	Gemini *Embedding_Gemini `protobuf:"bytes,3,opt,name=gemini,proto3,oneof"`
}
...
func (*Embedding_Gemini_) isEmbedding_Embedding() {}
...
type Embedding_Gemini struct {
	...
	// Types that are assignable to AuthTokenSource:
	//
	//	*Embedding_Gemini_AuthToken
	AuthTokenSource isEmbedding_Gemini_AuthTokenSource `protobuf_oneof:"auth_token_source"`
	// The model name to use
	// This value can be found https://generativelanguage.googleapis.com/{version}/models/{model}:generateContent?key={api_key}
	Model string `protobuf:"bytes,2,opt,name=model,proto3" json:"model,omitempty"`
	// The version of the API to use
...
func (x *Embedding_Gemini) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Embedding_Gemini) ProtoMessage() {}

func (x *Embedding_Gemini) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Embedding_Gemini.ProtoReflect.Descriptor instead.
func (*Embedding_Gemini) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{5, 2}
}

func (m *Embedding_Gemini) GetAuthTokenSource() isEmbedding_Gemini_AuthTokenSource {
	if m != nil {
		return m.AuthTokenSource
	}
	return nil
...
func (x *Embedding_Gemini) GetAuthToken() *SingleAuthToken {
	if x, ok := x.GetAuthTokenSource().(*Embedding_Gemini_AuthToken); ok {
		return x.AuthToken
	}
	return nil
}

func (x *Embedding_Gemini) GetModel() string {
	if x != nil {
		return x.Model
	}
	return ""
...
func (x *Embedding_Gemini) GetApiVersion() string {
	if x != nil {
		return x.ApiVersion
	}
	return ""
...
type isEmbedding_Gemini_AuthTokenSource interface {
	isEmbedding_Gemini_AuthTokenSource()
}

type Embedding_Gemini_AuthToken struct {
	// Auth Token to use for the Gemini API
	// This token will be placed into the `key` header
	AuthToken *SingleAuthToken `protobuf:"bytes,1,opt,name=auth_token,json=authToken,proto3,oneof"` // TODO: use oauth
}

func (*Embedding_Gemini_AuthToken) isEmbedding_Gemini_AuthTokenSource() {}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xd9, 0x05, 0x0a, 0x09, 0x45, 0x6d, 0x62,
	...
	0x12, 0x43, 0x0a, 0x06, 0x67, 0x65, 0x6d, 0x69, 0x6e, 0x69, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x64, 0x69, 0x6e, 0x67, 0x2e, 0x47, 0x65, 0x6d, 0x69, 0x6e, 0x69, 0x48, 0x00, 0x52, 0x06, 0x67,
	0x65, 0x6d, 0x69, 0x6e, 0x69, 0x1a, 0x68, 0x0a, 0x06, 0x4f, 0x70, 0x65, 0x6e, 0x41, 0x49, 0x12,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x85, 0x09, 0x0a, 0x0d, 0x41, 0x49, 0x50, 0x72,
	...
	,
	...
	0x54, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x3a, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_goTypes = []any{
	...
	(*Embedding_Gemini)(nil),                         // 25: ai.options.gloo.solo.io.Embedding.Gemini
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_depIdxs = []int32{
	37, // 0: ai.options.gloo.solo.io.SingleAuthToken.secret_ref:type_name -> core.solo.io.ResourceRef
	...
	38, // 13: ai.options.gloo.solo.io.FieldDefault.value:type_name -> google.protobuf.Value
	...
	25, // 16: ai.options.gloo.solo.io.Embedding.gemini:type_name -> ai.options.gloo.solo.io.Embedding.Gemini
	28, // 17: ai.options.gloo.solo.io.SemanticCache.datastore:type_name -> ai.options.gloo.solo.io.SemanticCache.DataStore
	9,  // 18: ai.options.gloo.solo.io.SemanticCache.embedding:type_name -> ai.options.gloo.solo.io.Embedding
	1,  // 19: ai.options.gloo.solo.io.SemanticCache.mode:type_name -> ai.options.gloo.solo.io.SemanticCache.Mode
	29, // 20: ai.options.gloo.solo.io.RAG.datastore:type_name -> ai.options.gloo.solo.io.RAG.DataStore
	9,  // 21: ai.options.gloo.solo.io.RAG.embedding:type_name -> ai.options.gloo.solo.io.Embedding
	30, // 22: ai.options.gloo.solo.io.AIPromptEnrichment.prepend:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment.Message
	30, // 23: ai.options.gloo.solo.io.AIPromptEnrichment.append:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment.Message
	33, // 24: ai.options.gloo.solo.io.AIPromptGuard.request:type_name -> ai.options.gloo.solo.io.AIPromptGuard.Request
	34, // 25: ai.options.gloo.solo.io.AIPromptGuard.response:type_name -> ai.options.gloo.solo.io.AIPromptGuard.Response
	4,  // 26: ai.options.gloo.solo.io.UpstreamSpec.OpenAI.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	14, // 27: ai.options.gloo.solo.io.UpstreamSpec.OpenAI.custom_host:type_name -> ai.options.gloo.solo.io.UpstreamSpec.CustomHost
	4,  // 28: ai.options.gloo.solo.io.UpstreamSpec.AzureOpenAI.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	4,  // 29: ai.options.gloo.solo.io.UpstreamSpec.Gemini.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	...
	4,  // 43: ai.options.gloo.solo.io.Embedding.Gemini.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	26, // 44: ai.options.gloo.solo.io.SemanticCache.DataStore.redis:type_name -> ai.options.gloo.solo.io.SemanticCache.Redis
	27, // 45: ai.options.gloo.solo.io.SemanticCache.DataStore.weaviate:type_name -> ai.options.gloo.solo.io.SemanticCache.Weaviate
	8,  // 46: ai.options.gloo.solo.io.RAG.DataStore.postgres:type_name -> ai.options.gloo.solo.io.Postgres
	2,  // 47: ai.options.gloo.solo.io.AIPromptGuard.Regex.builtins:type_name -> ai.options.gloo.solo.io.AIPromptGuard.Regex.BuiltIn
	35, // 48: ai.options.gloo.solo.io.AIPromptGuard.Webhook.headers:type_name -> ai.options.gloo.solo.io.AIPromptGuard.Webhook.HeaderMatch
	36, // 49: ai.options.gloo.solo.io.AIPromptGuard.Request.custom_response:type_name -> ai.options.gloo.solo.io.AIPromptGuard.Request.CustomResponse
	...
	3,  // 54: ai.options.gloo.solo.io.AIPromptGuard.Webhook.HeaderMatch.match_type:type_name -> ai.options.gloo.solo.io.AIPromptGuard.Webhook.HeaderMatch.MatchType
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[21].OneofWrappers = []any{
		(*Embedding_Gemini_AuthToken)(nil),
	}

...
type UpstreamSpec_VertexAI_Provider int32

const (
	UpstreamSpec_VertexAI_GEMINI UpstreamSpec_VertexAI_Provider = 0
)

// Enum value maps for UpstreamSpec_VertexAI_Provider.
var (
	UpstreamSpec_VertexAI_Provider_name = map[int32]string{
		0: "GEMINI",
	}
	UpstreamSpec_VertexAI_Provider_value = map[string]int32{
		"GEMINI": 0,
	}
)

func (x UpstreamSpec_VertexAI_Provider) Enum() *UpstreamSpec_VertexAI_Provider {
	p := new(UpstreamSpec_VertexAI_Provider)
	*p = x
	return p
}

func (x UpstreamSpec_VertexAI_Provider) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UpstreamSpec_VertexAI_Provider) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_enumTypes[0].Descriptor()
}

func (UpstreamSpec_VertexAI_Provider) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_enumTypes[0]
}

func (x UpstreamSpec_VertexAI_Provider) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UpstreamSpec_VertexAI_Provider.Descriptor instead.
func (UpstreamSpec_VertexAI_Provider) EnumDescriptor() ([]byte, []int) {
...
type UpstreamSpec_VertexAI struct {
	...
	// The type of model publishers to use, currently only Google's Gemini is supported in
	// https://{LOCATION}-aiplatform.googleapis.com/{VERSION}/projects/{PROJECT_ID}/locations/{LOCATION}/publishers/{PROVIDER}/<model-path>
	Provider UpstreamSpec_VertexAI_Provider `protobuf:"varint,6,opt,name=provider,proto3,enum=ai.options.gloo.solo.io.UpstreamSpec_VertexAI_Provider" json:"provider,omitempty"`
}
...
func (x *UpstreamSpec_VertexAI) GetProvider() UpstreamSpec_VertexAI_Provider {
	if x != nil {
		return x.Provider
	}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xa7, 0x14, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x70,
	...
	0x65, 0x6e, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xc9, 0x02, 0x0a, 0x08, 0x56, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x53, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x37, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e,
	0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x56, 0x65, 0x72,
	0x74, 0x65, 0x78, 0x41, 0x49, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x08,
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x22, 0x16, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x12, 0x0a, 0x0a, 0x06, 0x47, 0x45, 0x4d, 0x49, 0x4e, 0x49, 0x10, 0x00,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_goTypes = []any{
	(UpstreamSpec_VertexAI_Provider)(0),              // 0: ai.options.gloo.solo.io.UpstreamSpec.VertexAI.Provider
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_depIdxs = []int32{
	...
	0,  // 31: ai.options.gloo.solo.io.UpstreamSpec.VertexAI.provider:type_name -> ai.options.gloo.solo.io.UpstreamSpec.VertexAI.Provider

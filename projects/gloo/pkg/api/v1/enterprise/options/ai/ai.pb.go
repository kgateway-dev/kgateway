...
func (x *UpstreamSpec) GetMulti() *UpstreamSpec_Multi {
	if x, ok := x.GetLlm().(*UpstreamSpec_Multi_); ok {
		return x.Multi
	}
	return nil
}
...
type UpstreamSpec_Multi_ struct {
	// multi upstream
	Multi *UpstreamSpec_Multi `protobuf:"bytes,5,opt,name=multi,proto3,oneof"`
}
...
func (*UpstreamSpec_Multi_) isUpstreamSpec_Llm() {}
...
type UpstreamSpec_Multi struct {
	...
	Priorities []*UpstreamSpec_Multi_Priority `protobuf:"bytes,1,rep,name=priorities,proto3" json:"priorities,omitempty"`
}

func (x *UpstreamSpec_Multi) Reset() {
	*x = UpstreamSpec_Multi{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpstreamSpec_Multi) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamSpec_Multi) ProtoMessage() {}

func (x *UpstreamSpec_Multi) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamSpec_Multi.ProtoReflect.Descriptor instead.
func (*UpstreamSpec_Multi) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{1, 5}
}

func (x *UpstreamSpec_Multi) GetPriorities() []*UpstreamSpec_Multi_Priority {
	if x != nil {
		return x.Priorities
	}
	return nil
...
type UpstreamSpec_Multi_Backend struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Llm:
	//
	//	*UpstreamSpec_Multi_Backend_Openai
	//	*UpstreamSpec_Multi_Backend_Mistral
	//	*UpstreamSpec_Multi_Backend_Anthropic
	//	*UpstreamSpec_Multi_Backend_AzureOpenai
	Llm isUpstreamSpec_Multi_Backend_Llm `protobuf_oneof:"llm"`
}

func (x *UpstreamSpec_Multi_Backend) Reset() {
	*x = UpstreamSpec_Multi_Backend{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpstreamSpec_Multi_Backend) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamSpec_Multi_Backend) ProtoMessage() {}

func (x *UpstreamSpec_Multi_Backend) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamSpec_Multi_Backend.ProtoReflect.Descriptor instead.
func (*UpstreamSpec_Multi_Backend) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{1, 5, 0}
}

func (m *UpstreamSpec_Multi_Backend) GetLlm() isUpstreamSpec_Multi_Backend_Llm {
	if m != nil {
		return m.Llm
	}
	return nil
...
func (x *UpstreamSpec_Multi_Backend) GetOpenai() *UpstreamSpec_OpenAI {
	if x, ok := x.GetLlm().(*UpstreamSpec_Multi_Backend_Openai); ok {
		return x.Openai
	}
	return nil
}

func (x *UpstreamSpec_Multi_Backend) GetMistral() *UpstreamSpec_Mistral {
	if x, ok := x.GetLlm().(*UpstreamSpec_Multi_Backend_Mistral); ok {
		return x.Mistral
	}
	return nil
}

func (x *UpstreamSpec_Multi_Backend) GetAnthropic() *UpstreamSpec_Anthropic {
	if x, ok := x.GetLlm().(*UpstreamSpec_Multi_Backend_Anthropic); ok {
		return x.Anthropic
	}
	return nil
}

func (x *UpstreamSpec_Multi_Backend) GetAzureOpenai() *UpstreamSpec_AzureOpenAI {
	if x, ok := x.GetLlm().(*UpstreamSpec_Multi_Backend_AzureOpenai); ok {
		return x.AzureOpenai
	}
	return nil
}

type isUpstreamSpec_Multi_Backend_Llm interface {
	isUpstreamSpec_Multi_Backend_Llm()
}

type UpstreamSpec_Multi_Backend_Openai struct {
	// OpenAI upstream
	Openai *UpstreamSpec_OpenAI `protobuf:"bytes,1,opt,name=openai,proto3,oneof"`
}

type UpstreamSpec_Multi_Backend_Mistral struct {
	// Mistral upstream
	Mistral *UpstreamSpec_Mistral `protobuf:"bytes,2,opt,name=mistral,proto3,oneof"`
}

type UpstreamSpec_Multi_Backend_Anthropic struct {
	// Anthropic upstream
	Anthropic *UpstreamSpec_Anthropic `protobuf:"bytes,3,opt,name=anthropic,proto3,oneof"`
}

type UpstreamSpec_Multi_Backend_AzureOpenai struct {
	// Azure OpenAI upstream
	AzureOpenai *UpstreamSpec_AzureOpenAI `protobuf:"bytes,4,opt,name=azure_openai,json=azureOpenai,proto3,oneof"`
}

func (*UpstreamSpec_Multi_Backend_Openai) isUpstreamSpec_Multi_Backend_Llm() {}

func (*UpstreamSpec_Multi_Backend_Mistral) isUpstreamSpec_Multi_Backend_Llm() {}

func (*UpstreamSpec_Multi_Backend_Anthropic) isUpstreamSpec_Multi_Backend_Llm() {}

func (*UpstreamSpec_Multi_Backend_AzureOpenai) isUpstreamSpec_Multi_Backend_Llm() {}

type UpstreamSpec_Multi_Priority struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Pool     []*UpstreamSpec_Multi_Backend `protobuf:"bytes,1,rep,name=pool,proto3" json:"pool,omitempty"`
	Priority uint32                        `protobuf:"varint,2,opt,name=priority,proto3" json:"priority,omitempty"`
}

func (x *UpstreamSpec_Multi_Priority) Reset() {
	*x = UpstreamSpec_Multi_Priority{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpstreamSpec_Multi_Priority) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamSpec_Multi_Priority) ProtoMessage() {}

func (x *UpstreamSpec_Multi_Priority) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamSpec_Multi_Priority.ProtoReflect.Descriptor instead.
func (*UpstreamSpec_Multi_Priority) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{1, 5, 1}
}

func (x *UpstreamSpec_Multi_Priority) GetPool() []*UpstreamSpec_Multi_Backend {
	if x != nil {
		return x.Pool
	}
	return nil
...
func (x *UpstreamSpec_Multi_Priority) GetPriority() uint32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x97, 0x0e, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x70,
	...
	0x00, 0x52, 0x0b, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x4f, 0x70, 0x65, 0x6e, 0x61, 0x69, 0x12, 0x43,
	0x0a, 0x05, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e,
	...
	0x53, 0x70, 0x65, 0x63, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x48, 0x00, 0x52, 0x05, 0x6d, 0x75,
	0x6c, 0x74, 0x69, 0x1a, 0x34, 0x0a, 0x0a, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x48, 0x6f, 0x73,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xbb, 0x01, 0x0a,
	0x07, 0x4d, 0x69, 0x73, 0x74, 0x72, 0x61, 0x6c, 0x12, 0x47, 0x0a, 0x0a, 0x61, 0x75, 0x74, 0x68,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0xd7, 0x01, 0x0a, 0x09, 0x41,
	...
	0x6f, 0x64, 0x65, 0x6c, 0x1a, 0x9d, 0x04, 0x0a, 0x05, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x12, 0x54,
	0x0a, 0x0a, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x34, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e,
	0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x55, 0x70, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x2e,
	0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x52, 0x0a, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x1a, 0xcc, 0x02, 0x0a, 0x07, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64,
	...
	,
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x15, 0x0a, 0x09, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x43, 0x48, 0x41, 0x54, 0x10, 0x00, 0x22, 0x6e, 0x0a, 0x0c,
	...
	0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xf2,
	0x03, 0x0a, 0x09, 0x45, 0x6d, 0x62, 0x65, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x43, 0x0a, 0x06,
	0x6f, 0x70, 0x65, 0x6e, 0x61, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61,
	0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73,
	...
	0x69, 0x12, 0x53, 0x0a, 0x0c, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61,
	0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69,
	0x6f, 0x2e, 0x45, 0x6d, 0x62, 0x65, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x2e, 0x41, 0x7a, 0x75, 0x72,
	0x65, 0x4f, 0x70, 0x65, 0x6e, 0x41, 0x49, 0x48, 0x00, 0x52, 0x0b, 0x61, 0x7a, 0x75, 0x72, 0x65,
	0x4f, 0x70, 0x65, 0x6e, 0x61, 0x69, 0x1a, 0x68, 0x0a, 0x06, 0x4f, 0x70, 0x65, 0x6e, 0x41, 0x49,
	...
	0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x53,
	0x69, 0x6e, 0x67, 0x6c, 0x65, 0x41, 0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x48, 0x00,
	0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x61,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x0b, 0x0a, 0x09, 0x65, 0x6d, 0x62, 0x65, 0x64, 0x64,
	0x69, 0x6e, 0x67, 0x22, 0xa0, 0x05, 0x0a, 0x0d, 0x53, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x69, 0x63,
	0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x4e, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e,
	...
	0x62, 0x65, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x74, 0x6c, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x74, 0x6c, 0x12, 0x3f, 0x0a, 0x04, 0x6d, 0x6f, 0x64,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69,
	0x6f, 0x2e, 0x53, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x69, 0x63, 0x43, 0x61, 0x63, 0x68, 0x65, 0x2e,
	0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x1a, 0x5d, 0x0a, 0x05, 0x52, 0x65,
	...
	0x09, 0x64, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x22, 0x3c, 0x0a, 0x0c, 0x52, 0x61,
	0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x2c, 0x0a, 0x12, 0x72, 0x61,
	0x74, 0x65, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x72, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69,
	0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x22, 0xe9, 0x01, 0x0a, 0x12, 0x41, 0x49, 0x50,
	...
	0x74, 0x65, 0x6e, 0x74, 0x22, 0xc1, 0x03, 0x0a, 0x0d, 0x41, 0x49, 0x50, 0x72, 0x6f, 0x6d, 0x70,
	...
	0x6e, 0x73, 0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0x5b, 0x0a,
	0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63,
	0x68, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x73, 0x12, 0x36, 0x0a, 0x17, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x72, 0x65, 0x73,
	...
	0x6e, 0x73, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0xbb, 0x01, 0x0a, 0x08, 0x52,
	...
	0x73, 0x12, 0x53, 0x0a, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x74, 0x69, 0x6e, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0e, 0x32, 0x37, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x74, 0x49, 0x6e, 0x52, 0x08, 0x62, 0x75,
	0x69, 0x6c, 0x74, 0x69, 0x6e, 0x73, 0x22, 0x40, 0x0a, 0x07, 0x42, 0x75, 0x69, 0x6c, 0x74, 0x49,
	0x6e, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x4e, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x43, 0x52,
	0x45, 0x44, 0x49, 0x54, 0x5f, 0x43, 0x41, 0x52, 0x44, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x45,
	0x4d, 0x41, 0x49, 0x4c, 0x10, 0x02, 0x12, 0x10, 0x0a, 0x0c, 0x50, 0x48, 0x4f, 0x4e, 0x45, 0x5f,
	0x4e, 0x55, 0x4d, 0x42, 0x45, 0x52, 0x10, 0x03, 0x42, 0x54, 0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_goTypes = []interface{}{
	...
	(*UpstreamSpec_Multi)(nil),          // 19: ai.options.gloo.solo.io.UpstreamSpec.Multi
	(*UpstreamSpec_Multi_Backend)(nil),  // 20: ai.options.gloo.solo.io.UpstreamSpec.Multi.Backend
	(*UpstreamSpec_Multi_Priority)(nil), // 21: ai.options.gloo.solo.io.UpstreamSpec.Multi.Priority
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_depIdxs = []int32{
	...
	19, // 5: ai.options.gloo.solo.io.UpstreamSpec.multi:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Multi
	...
	21, // 31: ai.options.gloo.solo.io.UpstreamSpec.Multi.priorities:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Multi.Priority
	15, // 32: ai.options.gloo.solo.io.UpstreamSpec.Multi.Backend.openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.OpenAI
	17, // 33: ai.options.gloo.solo.io.UpstreamSpec.Multi.Backend.mistral:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Mistral
	18, // 34: ai.options.gloo.solo.io.UpstreamSpec.Multi.Backend.anthropic:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Anthropic
	16, // 35: ai.options.gloo.solo.io.UpstreamSpec.Multi.Backend.azure_openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.AzureOpenAI
	20, // 36: ai.options.gloo.solo.io.UpstreamSpec.Multi.Priority.pool:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Multi.Backend
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpstreamSpec_Multi); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpstreamSpec_Multi_Backend); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpstreamSpec_Multi_Priority); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[17].OneofWrappers = []interface{}{
		(*UpstreamSpec_Multi_Backend_Openai)(nil),
		(*UpstreamSpec_Multi_Backend_Mistral)(nil),
		(*UpstreamSpec_Multi_Backend_Anthropic)(nil),
		(*UpstreamSpec_Multi_Backend_AzureOpenai)(nil),
	}

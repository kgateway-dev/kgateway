...
type SemanticCache_Weaviate struct {
	...
	// Same as http_url but for GRPC connections
	...
	// This will default to true if `http_port` is set to 443
	ConnectionSecure bool `protobuf:"varint,5,opt,name=connection_secure,json=connectionSecure,proto3" json:"connection_secure,omitempty"`
	// Similarity score threshold value between 0.0 and 1.0 that determines how similar
	// two queries need to be in order to return a cached result.
	// The lower the number, the more similar the queries need to be for a cache hit.
	//
...
func (x *SemanticCache_Weaviate) GetHttpUrl() string {
	if x != nil {
		return x.HttpUrl
	}
	return ""
...
func (x *SemanticCache_Weaviate) GetGrpcUrl() string {
	if x != nil {
		return x.GrpcUrl
	}
	return ""
...
func (x *SemanticCache_Weaviate) GetConnectionSecure() bool {
	if x != nil {
		return x.ConnectionSecure
	}
	return false
}

func (x *SemanticCache_Weaviate) GetScoreThreshold() float32 {
	if x != nil {
		return x.ScoreThreshold
	}
	return 0
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDesc = []byte{
	...
	0xfd, 0x05, 0x0a, 0x0d, 0x53, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x69, 0x63, 0x43, 0x61, 0x63, 0x68,
	...
	,

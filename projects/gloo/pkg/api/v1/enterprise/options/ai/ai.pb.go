...
func (x *UpstreamSpec) GetPools() *UpstreamSpec_Composite {
	if x, ok := x.GetLlm().(*UpstreamSpec_Pools); ok {
		return x.Pools
	}
	return nil
}
...
type UpstreamSpec_Pools struct {
	// Composite upstream
	Pools *UpstreamSpec_Composite `protobuf:"bytes,5,opt,name=pools,proto3,oneof"`
}
...
func (*UpstreamSpec_Pools) isUpstreamSpec_Llm() {}
...
type RouteSettings struct {
	...
	// The type of route this is, either CHAT or COMPLETIONS
	RouteType RouteSettings_RouteType `protobuf:"varint,7,opt,name=route_type,json=routeType,proto3,enum=ai.options.gloo.solo.io.RouteSettings_RouteType" json:"route_type,omitempty"`
}
...
// name: azure-secret
// namespace: gloo-system
type UpstreamSpec_Composite struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Pools    []*UpstreamSpec_Composite_Pool `protobuf:"bytes,1,rep,name=pools,proto3" json:"pools,omitempty"`
	Priority uint32                         `protobuf:"varint,2,opt,name=priority,proto3" json:"priority,omitempty"`
}

func (x *UpstreamSpec_Composite) Reset() {
	*x = UpstreamSpec_Composite{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpstreamSpec_Composite) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamSpec_Composite) ProtoMessage() {}

func (x *UpstreamSpec_Composite) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamSpec_Composite.ProtoReflect.Descriptor instead.
func (*UpstreamSpec_Composite) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{1, 5}
}

func (x *UpstreamSpec_Composite) GetPools() []*UpstreamSpec_Composite_Pool {
	if x != nil {
		return x.Pools
	}
	return nil
...
func (x *UpstreamSpec_Composite) GetPriority() uint32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
type UpstreamSpec_Composite_Backend struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Llm:
	//
	//	*UpstreamSpec_Composite_Backend_Openai
	//	*UpstreamSpec_Composite_Backend_Mistral
	//	*UpstreamSpec_Composite_Backend_Anthropic
	//	*UpstreamSpec_Composite_Backend_AzureOpenai
	Llm isUpstreamSpec_Composite_Backend_Llm `protobuf_oneof:"llm"`
}

func (x *UpstreamSpec_Composite_Backend) Reset() {
	*x = UpstreamSpec_Composite_Backend{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpstreamSpec_Composite_Backend) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamSpec_Composite_Backend) ProtoMessage() {}

func (x *UpstreamSpec_Composite_Backend) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamSpec_Composite_Backend.ProtoReflect.Descriptor instead.
func (*UpstreamSpec_Composite_Backend) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{1, 5, 0}
}

func (m *UpstreamSpec_Composite_Backend) GetLlm() isUpstreamSpec_Composite_Backend_Llm {
	if m != nil {
		return m.Llm
	}
	return nil
...
func (x *UpstreamSpec_Composite_Backend) GetOpenai() *UpstreamSpec_OpenAI {
	if x, ok := x.GetLlm().(*UpstreamSpec_Composite_Backend_Openai); ok {
		return x.Openai
	}
	return nil
}

func (x *UpstreamSpec_Composite_Backend) GetMistral() *UpstreamSpec_Mistral {
	if x, ok := x.GetLlm().(*UpstreamSpec_Composite_Backend_Mistral); ok {
		return x.Mistral
	}
	return nil
}

func (x *UpstreamSpec_Composite_Backend) GetAnthropic() *UpstreamSpec_Anthropic {
	if x, ok := x.GetLlm().(*UpstreamSpec_Composite_Backend_Anthropic); ok {
		return x.Anthropic
	}
	return nil
}

func (x *UpstreamSpec_Composite_Backend) GetAzureOpenai() *UpstreamSpec_AzureOpenAI {
	if x, ok := x.GetLlm().(*UpstreamSpec_Composite_Backend_AzureOpenai); ok {
		return x.AzureOpenai
	}
	return nil
}

type isUpstreamSpec_Composite_Backend_Llm interface {
	isUpstreamSpec_Composite_Backend_Llm()
}

type UpstreamSpec_Composite_Backend_Openai struct {
	// OpenAI upstream
	Openai *UpstreamSpec_OpenAI `protobuf:"bytes,1,opt,name=openai,proto3,oneof"`
}

type UpstreamSpec_Composite_Backend_Mistral struct {
	// Mistral upstream
	Mistral *UpstreamSpec_Mistral `protobuf:"bytes,2,opt,name=mistral,proto3,oneof"`
}

type UpstreamSpec_Composite_Backend_Anthropic struct {
	// Anthropic upstream
	Anthropic *UpstreamSpec_Anthropic `protobuf:"bytes,3,opt,name=anthropic,proto3,oneof"`
}

type UpstreamSpec_Composite_Backend_AzureOpenai struct {
	// Azure OpenAI upstream
	AzureOpenai *UpstreamSpec_AzureOpenAI `protobuf:"bytes,4,opt,name=azure_openai,json=azureOpenai,proto3,oneof"`
}

func (*UpstreamSpec_Composite_Backend_Openai) isUpstreamSpec_Composite_Backend_Llm() {}

func (*UpstreamSpec_Composite_Backend_Mistral) isUpstreamSpec_Composite_Backend_Llm() {}

func (*UpstreamSpec_Composite_Backend_Anthropic) isUpstreamSpec_Composite_Backend_Llm() {}

func (*UpstreamSpec_Composite_Backend_AzureOpenai) isUpstreamSpec_Composite_Backend_Llm() {}

// List of upstreams to use
// repeated UpstreamSpec upstreams = 1;
type UpstreamSpec_Composite_Pool struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Upstreams []*UpstreamSpec_Composite_Backend `protobuf:"bytes,1,rep,name=upstreams,proto3" json:"upstreams,omitempty"`
}

func (x *UpstreamSpec_Composite_Pool) Reset() {
	*x = UpstreamSpec_Composite_Pool{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpstreamSpec_Composite_Pool) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpstreamSpec_Composite_Pool) ProtoMessage() {}

func (x *UpstreamSpec_Composite_Pool) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpstreamSpec_Composite_Pool.ProtoReflect.Descriptor instead.
func (*UpstreamSpec_Composite_Pool) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{1, 5, 1}
}

func (x *UpstreamSpec_Composite_Pool) GetUpstreams() []*UpstreamSpec_Composite_Backend {
	if x != nil {
		return x.Upstreams
	}
	return nil
...
<<<<<<< HEAD
	0x65, 0x22, 0xdd, 0x0d, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x70,
=======
	0x65, 0x22, 0x93, 0x0d, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x70,
>>>>>>> 87bee30db (as per Denis' spec)
	...
	0x0a, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e,
	...
	0x53, 0x70, 0x65, 0x63, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x65, 0x48, 0x00,
	0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x1a, 0x34, 0x0a, 0x0a, 0x43, 0x75, 0x73, 0x74, 0x6f,
...
<<<<<<< HEAD
	0x48, 0x6f, 0x73, 0x74, 0x1a, 0xd3, 0x01, 0x0a, 0x0b, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x4f, 0x70,
=======
	0x48, 0x6f, 0x73, 0x74, 0x1a, 0x89, 0x01, 0x0a, 0x0b, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x4f, 0x70,
>>>>>>> 87bee30db (as per Denis' spec)
...
<<<<<<< HEAD
	...
	0x6b, 0x65, 0x6e, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xa5, 0x01, 0x0a, 0x07, 0x4d,
	0x69, 0x73, 0x74, 0x72, 0x61, 0x6c, 0x12, 0x47, 0x0a, 0x0a, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x74,
=======
	0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x42, 0x13, 0x0a, 0x11, 0x61,
...
<<<<<<< HEAD
	0x73, 0x74, 0x1a, 0xc1, 0x01, 0x0a, 0x09, 0x41, 0x6e, 0x74, 0x68, 0x72, 0x6f, 0x70, 0x69, 0x63,
	...
	,
	...
	,
	...
	0x50, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x47, 0x61, 0x75, 0x72, 0x64, 0x52, 0x0b, 0x70, 0x72, 0x6f,
	...
	0x70, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c,
	0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x12, 0x41, 0x0a, 0x08,
	0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25,
	0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f,
	...
	0x4f, 0x0a, 0x0a, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20,
	...
	0x22, 0x15, 0x0a, 0x09, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a,
	0x04, 0x43, 0x48, 0x41, 0x54, 0x10, 0x00, 0x22, 0x6e, 0x0a, 0x0c, 0x46, 0x69, 0x65, 0x6c, 0x64,
	...
	0x61, 0x75, 0x74, 0x68, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x42, 0x0b, 0x0a, 0x09, 0x65, 0x6d, 0x62, 0x65, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x22, 0xa0,
	...
	0x04, 0x6d, 0x6f, 0x64, 0x65, 0x1a, 0x5d, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x2b,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x27, 0x0a, 0x0f, 0x73,
	0x63, 0x6f, 0x72, 0x65, 0x5f, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x02, 0x52, 0x0e, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x54, 0x68, 0x72, 0x65, 0x73,
	0x68, 0x6f, 0x6c, 0x64, 0x1a, 0x74, 0x0a, 0x08, 0x57, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x68, 0x6f, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x70, 0x6f, 0x72,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x67, 0x72, 0x70, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x1a,
	0x0a, 0x08, 0x69, 0x6e, 0x73, 0x65, 0x63, 0x75, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x08, 0x69, 0x6e, 0x73, 0x65, 0x63, 0x75, 0x72, 0x65, 0x1a, 0xad, 0x01, 0x0a, 0x09, 0x44,
	...
	,
	...
	0xc1, 0x03, 0x0a, 0x0d, 0x41, 0x49, 0x50, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x47, 0x61, 0x75, 0x72,
	...
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0x5b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x12, 0x36, 0x0a,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0xbb, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
=======
	...
	,
	...
	0x7a, 0x75, 0x72, 0x65, 0x4f, 0x70, 0x65, 0x6e, 0x61, 0x69, 0x42, 0x05, 0x0a, 0x03, 0x6c, 0x6c,
	0x6d, 0x1a, 0x5d, 0x0a, 0x04, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x55, 0x0a, 0x09, 0x75, 0x70, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x61,
	0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73,
	0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53,
	0x70, 0x65, 0x63, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x65, 0x2e, 0x42, 0x61,
	0x63, 0x6b, 0x65, 0x6e, 0x64, 0x52, 0x09, 0x75, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73,
	...
	0x73, 0x22, 0xe9, 0x01, 0x0a, 0x12, 0x41, 0x49, 0x50, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x45, 0x6e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xc1, 0x03,
	0x0a, 0x0d, 0x41, 0x49, 0x50, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x47, 0x61, 0x75, 0x72, 0x64, 0x12,
	0x48, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x2e, 0x2e, 0x61, 0x69, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x67, 0x6c,
	...
	,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_goTypes = []interface{}{
	...
	(*UpstreamSpec_Composite)(nil),         // 19: ai.options.gloo.solo.io.UpstreamSpec.Composite
	(*UpstreamSpec_Composite_Backend)(nil), // 20: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend
	(*UpstreamSpec_Composite_Pool)(nil),    // 21: ai.options.gloo.solo.io.UpstreamSpec.Composite.Pool
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_depIdxs = []int32{
	...
	19, // 5: ai.options.gloo.solo.io.UpstreamSpec.pools:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Composite
	...
	21, // 31: ai.options.gloo.solo.io.UpstreamSpec.Composite.pools:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Composite.Pool
	15, // 32: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.OpenAI
	17, // 33: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.mistral:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Mistral
	18, // 34: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.anthropic:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Anthropic
	16, // 35: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.azure_openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.AzureOpenAI
	20, // 36: ai.options.gloo.solo.io.UpstreamSpec.Composite.Pool.upstreams:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_goTypes = []interface{}{
	...
	(*UpstreamSpec_Composite)(nil),         // 18: ai.options.gloo.solo.io.UpstreamSpec.Composite
	(*UpstreamSpec_Composite_Backend)(nil), // 19: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend
	(*UpstreamSpec_Composite_Pool)(nil),    // 20: ai.options.gloo.solo.io.UpstreamSpec.Composite.Pool
	(*Embedding_OpenAI)(nil),               // 21: ai.options.gloo.solo.io.Embedding.OpenAI
	(*Embedding_AzureOpenAI)(nil),          // 22: ai.options.gloo.solo.io.Embedding.AzureOpenAI
	(*SemanticCache_Redis)(nil),            // 23: ai.options.gloo.solo.io.SemanticCache.Redis
	(*SemanticCache_Weaviate)(nil),         // 24: ai.options.gloo.solo.io.SemanticCache.Weaviate
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_depIdxs = []int32{
	30, // 0: ai.options.gloo.solo.io.SingleAuthToken.secret_ref:type_name -> core.solo.io.ResourceRef
	...
	18, // 5: ai.options.gloo.solo.io.UpstreamSpec.pools:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Composite
	11, // 6: ai.options.gloo.solo.io.RouteSettings.prompt_enrichment:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment
	12, // 7: ai.options.gloo.solo.io.RouteSettings.prompt_guard:type_name -> ai.options.gloo.solo.io.AIPromptGaurd
	9,  // 8: ai.options.gloo.solo.io.RouteSettings.rag:type_name -> ai.options.gloo.solo.io.RAG
	8,  // 9: ai.options.gloo.solo.io.RouteSettings.semantic_cache:type_name -> ai.options.gloo.solo.io.SemanticCache
	5,  // 10: ai.options.gloo.solo.io.RouteSettings.defaults:type_name -> ai.options.gloo.solo.io.FieldDefault
	31, // 11: ai.options.gloo.solo.io.FieldDefault.value:type_name -> google.protobuf.Value
	21, // 12: ai.options.gloo.solo.io.Embedding.openai:type_name -> ai.options.gloo.solo.io.Embedding.OpenAI
	22, // 13: ai.options.gloo.solo.io.Embedding.azure_openai:type_name -> ai.options.gloo.solo.io.Embedding.AzureOpenAI
	25, // 14: ai.options.gloo.solo.io.SemanticCache.datastore:type_name -> ai.options.gloo.solo.io.SemanticCache.DataStore
	7,  // 15: ai.options.gloo.solo.io.SemanticCache.embedding:type_name -> ai.options.gloo.solo.io.Embedding
	0,  // 16: ai.options.gloo.solo.io.SemanticCache.mode:type_name -> ai.options.gloo.solo.io.SemanticCache.Mode
	26, // 17: ai.options.gloo.solo.io.RAG.datastore:type_name -> ai.options.gloo.solo.io.RAG.DataStore
	7,  // 18: ai.options.gloo.solo.io.RAG.embedding:type_name -> ai.options.gloo.solo.io.Embedding
	27, // 19: ai.options.gloo.solo.io.AIPromptEnrichment.prepend:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment.Message
	27, // 20: ai.options.gloo.solo.io.AIPromptEnrichment.append:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment.Message
	28, // 21: ai.options.gloo.solo.io.AIPromptGaurd.request:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Request
	29, // 22: ai.options.gloo.solo.io.AIPromptGaurd.response:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Response
	2,  // 23: ai.options.gloo.solo.io.UpstreamSpec.OpenAI.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	13, // 24: ai.options.gloo.solo.io.UpstreamSpec.OpenAI.custom_host:type_name -> ai.options.gloo.solo.io.UpstreamSpec.CustomHost
	2,  // 25: ai.options.gloo.solo.io.UpstreamSpec.AzureOpenAI.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	2,  // 26: ai.options.gloo.solo.io.UpstreamSpec.Mistral.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	13, // 27: ai.options.gloo.solo.io.UpstreamSpec.Mistral.custom_host:type_name -> ai.options.gloo.solo.io.UpstreamSpec.CustomHost
	2,  // 28: ai.options.gloo.solo.io.UpstreamSpec.Anthropic.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	13, // 29: ai.options.gloo.solo.io.UpstreamSpec.Anthropic.custom_host:type_name -> ai.options.gloo.solo.io.UpstreamSpec.CustomHost
	20, // 30: ai.options.gloo.solo.io.UpstreamSpec.Composite.pools:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Composite.Pool
	14, // 31: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.OpenAI
	16, // 32: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.mistral:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Mistral
	17, // 33: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.anthropic:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Anthropic
	15, // 34: ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend.azure_openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.AzureOpenAI
	19, // 35: ai.options.gloo.solo.io.UpstreamSpec.Composite.Pool.upstreams:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Composite.Backend
	2,  // 36: ai.options.gloo.solo.io.Embedding.OpenAI.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	2,  // 37: ai.options.gloo.solo.io.Embedding.AzureOpenAI.auth_token:type_name -> ai.options.gloo.solo.io.SingleAuthToken
	23, // 38: ai.options.gloo.solo.io.SemanticCache.DataStore.redis:type_name -> ai.options.gloo.solo.io.SemanticCache.Redis
	24, // 39: ai.options.gloo.solo.io.SemanticCache.DataStore.weaviate:type_name -> ai.options.gloo.solo.io.SemanticCache.Weaviate
	6,  // 40: ai.options.gloo.solo.io.RAG.DataStore.postgres:type_name -> ai.options.gloo.solo.io.Postgres
	1,  // 41: ai.options.gloo.solo.io.AIPromptGaurd.Response.builtins:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Response.BuiltIn
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpstreamSpec_Composite); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpstreamSpec_Composite_Backend); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpstreamSpec_Composite_Pool); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[17].OneofWrappers = []interface{}{
		(*UpstreamSpec_Composite_Backend_Openai)(nil),
		(*UpstreamSpec_Composite_Backend_Mistral)(nil),
		(*UpstreamSpec_Composite_Backend_Anthropic)(nil),
		(*UpstreamSpec_Composite_Backend_AzureOpenai)(nil),
	}

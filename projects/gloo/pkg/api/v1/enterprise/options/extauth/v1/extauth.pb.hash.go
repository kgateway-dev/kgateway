...
func (m *AzureOidc) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.AzureOidc")); err != nil {
		return 0, err
	}
...
func (m *OidcAuthorizationCode_DefaultOIDCProvider) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.OidcAuthorizationCode_DefaultOIDCProvider")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthConfig_MSEnteraOauth2ConfigSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.ExtAuthConfig_MSEnteraOauth2ConfigSettings")); err != nil {
		return 0, err
	}

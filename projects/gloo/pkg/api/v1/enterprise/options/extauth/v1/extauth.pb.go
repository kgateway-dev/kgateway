...
type ApiKeyAuth_K8SSecretApikeyStorage struct {
	K8SSecretApikeyStorage *K8SSecretApiKeyStorage `protobuf:"bytes,1,opt,name=k8s_secret_apikey_storage,json=k8sSecretApikeyStorage,proto3,oneof"`
}

type ApiKeyAuth_AerospikeApikeyStorage struct {
	AerospikeApikeyStorage *AerospikeApiKeyStorage `protobuf:"bytes,2,opt,name=aerospike_apikey_storage,json=aerospikeApikeyStorage,proto3,oneof"`
}
...
type K8SSecretApiKeyStorage struct {
	...
	HeadersFromMetadata map[string]*K8SSecretApiKeyStorage_SecretKey `protobuf:"bytes,4,rep,name=headers_from_metadata,json=headersFromMetadata,proto3" json:"headers_from_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *K8SSecretApiKeyStorage) GetHeaderName() string {
	if x != nil {
		return x.HeaderName
	}
	return ""
...
func (x *K8SSecretApiKeyStorage) GetHeadersFromMetadata() map[string]*K8SSecretApiKeyStorage_SecretKey {
	if x != nil {
...
type AerospikeApiKeyStorage struct {
	...
	//	*AerospikeApiKeyStorage_Session
	//	*AerospikeApiKeyStorage_Linearize
	//	*AerospikeApiKeyStorage_Replica
	//	*AerospikeApiKeyStorage_AllowUnavailable
	ReadModeSc isAerospikeApiKeyStorage_ReadModeSc `protobuf_oneof:"read_mode_sc"`
	// Read settings for availability (AP)
	//
	// Types that are assignable to ReadModeAp:
	//	*AerospikeApiKeyStorage_One
	//	*AerospikeApiKeyStorage_All
	ReadModeAp isAerospikeApiKeyStorage_ReadModeAp `protobuf_oneof:"read_mode_ap"`
	// TLS Settings, mtls is enabled on the server side
	NodeTlsName string `protobuf:"bytes,14,opt,name=node_tls_name,json=nodeTlsName,proto3" json:"node_tls_name,omitempty"`
	CertPath    string `protobuf:"bytes,15,opt,name=cert_path,json=certPath,proto3" json:"cert_path,omitempty"`
	KeyPath     string `protobuf:"bytes,16,opt,name=key_path,json=keyPath,proto3" json:"key_path,omitempty"`
	...
	RootCaPath string `protobuf:"bytes,18,opt,name=root_ca_path,json=rootCaPath,proto3" json:"root_ca_path,omitempty"`
	// TLS version, defaults to 1.3
	TlsVersion string `protobuf:"bytes,19,opt,name=tls_version,json=tlsVersion,proto3" json:"tls_version,omitempty"`
	// TLS identifiers for the elliptic curves used
	TlsCurveGroups []*AerospikeApiKeyStorageTlsCurveID `protobuf:"bytes,20,rep,name=tls_curve_groups,json=tlsCurveGroups,proto3" json:"tls_curve_groups,omitempty"`
}
...
func (m *AerospikeApiKeyStorage) GetReadModeSc() isAerospikeApiKeyStorage_ReadModeSc {
	if m != nil {
		return m.ReadModeSc
	}
	return nil
...
func (x *AerospikeApiKeyStorage) GetSession() uint32 {
	if x, ok := x.GetReadModeSc().(*AerospikeApiKeyStorage_Session); ok {
		return x.Session
	}
	return 0
}

func (x *AerospikeApiKeyStorage) GetLinearize() uint32 {
	if x, ok := x.GetReadModeSc().(*AerospikeApiKeyStorage_Linearize); ok {
		return x.Linearize
	}
	return 0
}

func (x *AerospikeApiKeyStorage) GetReplica() uint32 {
	if x, ok := x.GetReadModeSc().(*AerospikeApiKeyStorage_Replica); ok {
		return x.Replica
	}
	return 0
}

func (x *AerospikeApiKeyStorage) GetAllowUnavailable() uint32 {
	if x, ok := x.GetReadModeSc().(*AerospikeApiKeyStorage_AllowUnavailable); ok {
		return x.AllowUnavailable
	}
	return 0
}

func (m *AerospikeApiKeyStorage) GetReadModeAp() isAerospikeApiKeyStorage_ReadModeAp {
	if m != nil {
		return m.ReadModeAp
	}
	return nil
...
func (x *AerospikeApiKeyStorage) GetOne() uint32 {
	if x, ok := x.GetReadModeAp().(*AerospikeApiKeyStorage_One); ok {
		return x.One
	}
	return 0
}

func (x *AerospikeApiKeyStorage) GetAll() uint32 {
	if x, ok := x.GetReadModeAp().(*AerospikeApiKeyStorage_All); ok {
		return x.All
	}
	return 0
}
...
type isAerospikeApiKeyStorage_ReadModeSc interface {
	isAerospikeApiKeyStorage_ReadModeSc()
}

type AerospikeApiKeyStorage_Session struct {
	...
	Session uint32 `protobuf:"varint,8,opt,name=session,proto3,oneof"`
}

type AerospikeApiKeyStorage_Linearize struct {
	// linearize ensures ALL clients will only see an increasing sequence of record versions.
	// Server only reads from master.
	Linearize uint32 `protobuf:"varint,9,opt,name=linearize,proto3,oneof"`
}

type AerospikeApiKeyStorage_Replica struct {
	// replica indicates that the server may read from master or any full (non-migrating) replica.
	// Increasing sequence of record versions is not guaranteed.
	Replica uint32 `protobuf:"varint,10,opt,name=replica,proto3,oneof"`
}

type AerospikeApiKeyStorage_AllowUnavailable struct {
	...
	AllowUnavailable uint32 `protobuf:"varint,11,opt,name=allow_unavailable,json=allowUnavailable,proto3,oneof"`
}

func (*AerospikeApiKeyStorage_Session) isAerospikeApiKeyStorage_ReadModeSc() {}

func (*AerospikeApiKeyStorage_Linearize) isAerospikeApiKeyStorage_ReadModeSc() {}

func (*AerospikeApiKeyStorage_Replica) isAerospikeApiKeyStorage_ReadModeSc() {}

func (*AerospikeApiKeyStorage_AllowUnavailable) isAerospikeApiKeyStorage_ReadModeSc() {}

type isAerospikeApiKeyStorage_ReadModeAp interface {
	isAerospikeApiKeyStorage_ReadModeAp()
}

type AerospikeApiKeyStorage_One struct {
	// one indicates that a single node should be involved in the read operation.
	One uint32 `protobuf:"varint,12,opt,name=one,proto3,oneof"`
}

type AerospikeApiKeyStorage_All struct {
	// all indicates that all duplicates should be consulted in
	// the read operation.
	All uint32 `protobuf:"varint,13,opt,name=all,proto3,oneof"`
}

func (*AerospikeApiKeyStorage_One) isAerospikeApiKeyStorage_ReadModeAp() {}

func (*AerospikeApiKeyStorage_All) isAerospikeApiKeyStorage_ReadModeAp() {}
...
func (x *RawApiKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawApiKey) ProtoMessage() {}

func (x *RawApiKey) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawApiKey.ProtoReflect.Descriptor instead.
func (*RawApiKey) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_rawDescGZIP(), []int{34}
}

func (x *RawApiKey) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
type K8SSecretApiKeyStorage_SecretKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *K8SSecretApiKeyStorage_SecretKey) Reset() {
	*x = K8SSecretApiKeyStorage_SecretKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *K8SSecretApiKeyStorage_SecretKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*K8SSecretApiKeyStorage_SecretKey) ProtoMessage() {}

func (x *K8SSecretApiKeyStorage_SecretKey) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use K8SSecretApiKeyStorage_SecretKey.ProtoReflect.Descriptor instead.
func (*K8SSecretApiKeyStorage_SecretKey) Descriptor() ([]byte, []int) {
...
func (x *K8SSecretApiKeyStorage_SecretKey) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *K8SSecretApiKeyStorage_SecretKey) GetRequired() bool {
	if x != nil {
		return x.Required
	}
	return false
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_rawDesc = []byte{
	...
	0xfa, 0x01, 0x0a, 0x0a, 0x41, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x41, 0x75, 0x74, 0x68, 0x12, 0x6c,
	0x0a, 0x19, 0x6b, 0x38, 0x73, 0x5f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x61, 0x70, 0x69,
	0x6b, 0x65, 0x79, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x5f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f,
	0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f,
	...
	0x65, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x42, 0x11, 0x0a, 0x0f, 0x73, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x22, 0xef, 0x04, 0x0a,
	...
	0x09, 0x52, 0x0a, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x7c, 0x0a,
	0x15, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x5f, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x6d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x65,
	0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73,
	0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4b, 0x38, 0x73, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74,
	0x41, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x48, 0x65,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x65, 0x6e,
	0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f,
	0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4b, 0x38, 0x73, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x41,
	0x70, 0x69, 0x4b, 0x65, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x65, 0x63,
	...
	0x07, 0x0a, 0x16, 0x41, 0x65, 0x72, 0x6f, 0x73, 0x70, 0x69, 0x6b, 0x65, 0x41, 0x70, 0x69, 0x4b,
	...
	,
	...
	0x74, 0x68, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x61,
	0x50, 0x61, 0x74, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6c, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x74, 0x6c, 0x73, 0x56, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x64, 0x0a, 0x10, 0x74, 0x6c, 0x73, 0x5f, 0x63, 0x75, 0x72,
	0x76, 0x65, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x43, 0x75, 0x72, 0x76, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x1a, 0x96, 0x01, 0x0a, 0x0a,
	...
	0x65, 0x76, 0x65, 0x6c, 0x42, 0x0e, 0x0a, 0x0c, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x6d, 0x6f, 0x64,
	0x65, 0x5f, 0x73, 0x63, 0x42, 0x0e, 0x0a, 0x0c, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x6d, 0x6f, 0x64,
	0x65, 0x5f, 0x61, 0x70, 0x22, 0xa9, 0x01, 0x0a, 0x06, 0x41, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x12,
	0x17, 0x0a, 0x07, 0x61, 0x70, 0x69, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x12, 0x49, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61,
	...
	0x22, 0xcf, 0x03, 0x0a, 0x04, 0x4c, 0x64, 0x61, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa9, 0x2b, 0x0a, 0x0d, 0x45, 0x78, 0x74,
	...
	0x08, 0x02, 0x10, 0x03, 0x22, 0x24, 0x0a, 0x09, 0x52, 0x61, 0x77, 0x41, 0x70, 0x69, 0x4b, 0x65,
	0x79, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x69, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x32, 0xdd, 0x02, 0x0a, 0x17, 0x45,
	...
	,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes = make([]protoimpl.MessageInfo, 81)
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_goTypes = []interface{}{
	...
	(*RawApiKey)(nil),                          // 38: enterprise.gloo.solo.io.RawApiKey
	(*AuthConfig_Config)(nil),                  // 39: enterprise.gloo.solo.io.AuthConfig.Config
	...
	nil,                                      // 56: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.LabelSelectorEntry
	nil,                                      // 57: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.HeadersFromMetadataEntry
	(*K8SSecretApiKeyStorage_SecretKey)(nil), // 58: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.SecretKey
	(*AerospikeApiKeyStorageTlsCurveID)(nil), // 59: enterprise.gloo.solo.io.AerospikeApiKeyStorage.tlsCurveID
	nil,                                      // 60: enterprise.gloo.solo.io.ApiKey.MetadataEntry
	(*Ldap_ConnectionPool)(nil),              // 61: enterprise.gloo.solo.io.Ldap.ConnectionPool
	(*PassThroughHttp_Request)(nil),          // 62: enterprise.gloo.solo.io.PassThroughHttp.Request
	(*PassThroughHttp_Response)(nil),         // 63: enterprise.gloo.solo.io.PassThroughHttp.Response
	nil,                                      // 64: enterprise.gloo.solo.io.PassThroughHttp.Request.HeadersToAddEntry
	(*ExtAuthConfig_OAuthConfig)(nil),        // 65: enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig
	(*ExtAuthConfig_OidcAuthorizationCodeConfig)(nil), // 66: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig
	(*ExtAuthConfig_AccessTokenValidationConfig)(nil), // 67: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig
	...
	(*ExtAuthConfig_ApiKeyAuthConfig_KeyMetadata)(nil),                         // 80: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata
	nil,                               // 81: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.ValidApiKeysEntry
	nil,                               // 82: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.HeadersFromKeyMetadataEntry
	nil,                               // 83: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata.MetadataEntry
	nil,                               // 84: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.ModulesEntry
	(*core.NamespacedStatuses)(nil),   // 85: core.solo.io.NamespacedStatuses
	(*core.Metadata)(nil),             // 86: core.solo.io.Metadata
	(*wrappers.StringValue)(nil),      // 87: google.protobuf.StringValue
	(*core.ResourceRef)(nil),          // 88: core.solo.io.ResourceRef
	...
	(*wrappers.UInt32Value)(nil),      // 93: google.protobuf.UInt32Value
	(*v2.DiscoveryRequest)(nil),       // 94: envoy.api.v2.DiscoveryRequest
	(*v2.DeltaDiscoveryRequest)(nil),  // 95: envoy.api.v2.DeltaDiscoveryRequest
	(*v2.DiscoveryResponse)(nil),      // 96: envoy.api.v2.DiscoveryResponse
	(*v2.DeltaDiscoveryResponse)(nil), // 97: envoy.api.v2.DeltaDiscoveryResponse
}
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_depIdxs = []int32{
	85,  // 0: enterprise.gloo.solo.io.AuthConfig.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	86,  // 1: enterprise.gloo.solo.io.AuthConfig.metadata:type_name -> core.solo.io.Metadata
	39,  // 2: enterprise.gloo.solo.io.AuthConfig.configs:type_name -> enterprise.gloo.solo.io.AuthConfig.Config
	87,  // 3: enterprise.gloo.solo.io.AuthConfig.boolean_expr:type_name -> google.protobuf.StringValue
	88,  // 4: enterprise.gloo.solo.io.ExtAuthExtension.config_ref:type_name -> core.solo.io.ResourceRef
	10,  // 5: enterprise.gloo.solo.io.ExtAuthExtension.custom_auth:type_name -> enterprise.gloo.solo.io.CustomAuth
	88,  // 6: enterprise.gloo.solo.io.Settings.extauthz_server_ref:type_name -> core.solo.io.ResourceRef
	...
	89,  // 9: enterprise.gloo.solo.io.Settings.request_timeout:type_name -> google.protobuf.Duration
	...
	40,  // 12: enterprise.gloo.solo.io.HttpService.request:type_name -> enterprise.gloo.solo.io.HttpService.Request
	41,  // 13: enterprise.gloo.solo.io.HttpService.response:type_name -> enterprise.gloo.solo.io.HttpService.Response
	43,  // 14: enterprise.gloo.solo.io.CustomAuth.context_extensions:type_name -> enterprise.gloo.solo.io.CustomAuth.ContextExtensionsEntry
	90,  // 15: enterprise.gloo.solo.io.AuthPlugin.config:type_name -> google.protobuf.Struct
	44,  // 16: enterprise.gloo.solo.io.BasicAuth.apr:type_name -> enterprise.gloo.solo.io.BasicAuth.Apr
	88,  // 17: enterprise.gloo.solo.io.OAuth.client_secret_ref:type_name -> core.solo.io.ResourceRef
	47,  // 18: enterprise.gloo.solo.io.OAuth.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.OAuth.AuthEndpointQueryParamsEntry
	...
	50,  // 22: enterprise.gloo.solo.io.UserSession.cookie_options:type_name -> enterprise.gloo.solo.io.UserSession.CookieOptions
	48,  // 23: enterprise.gloo.solo.io.UserSession.cookie:type_name -> enterprise.gloo.solo.io.UserSession.InternalSession
	49,  // 24: enterprise.gloo.solo.io.UserSession.redis:type_name -> enterprise.gloo.solo.io.UserSession.RedisSession
	91,  // 25: enterprise.gloo.solo.io.HeaderConfiguration.use_bearer_schema_for_authorization:type_name -> google.protobuf.BoolValue
	92,  // 26: enterprise.gloo.solo.io.JwksOnDemandCacheRefreshPolicy.never:type_name -> google.protobuf.Empty
	92,  // 27: enterprise.gloo.solo.io.JwksOnDemandCacheRefreshPolicy.always:type_name -> google.protobuf.Empty
	...
	88,  // 29: enterprise.gloo.solo.io.OidcAuthorizationCode.client_secret_ref:type_name -> core.solo.io.ResourceRef
	51,  // 30: enterprise.gloo.solo.io.OidcAuthorizationCode.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.AuthEndpointQueryParamsEntry
	52,  // 31: enterprise.gloo.solo.io.OidcAuthorizationCode.token_endpoint_query_params:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.TokenEndpointQueryParamsEntry
	...
	89,  // 35: enterprise.gloo.solo.io.OidcAuthorizationCode.discovery_poll_interval:type_name -> google.protobuf.Duration
	...
	53,  // 39: enterprise.gloo.solo.io.JwtValidation.remote_jwks:type_name -> enterprise.gloo.solo.io.JwtValidation.RemoteJwks
	54,  // 40: enterprise.gloo.solo.io.JwtValidation.local_jwks:type_name -> enterprise.gloo.solo.io.JwtValidation.LocalJwks
	88,  // 41: enterprise.gloo.solo.io.IntrospectionValidation.client_secret_ref:type_name -> core.solo.io.ResourceRef
	...
	89,  // 44: enterprise.gloo.solo.io.AccessTokenValidation.cache_timeout:type_name -> google.protobuf.Duration
	55,  // 45: enterprise.gloo.solo.io.AccessTokenValidation.required_scopes:type_name -> enterprise.gloo.solo.io.AccessTokenValidation.ScopeList
	28,  // 46: enterprise.gloo.solo.io.ApiKeyAuth.k8s_secret_apikey_storage:type_name -> enterprise.gloo.solo.io.K8sSecretApiKeyStorage
	29,  // 47: enterprise.gloo.solo.io.ApiKeyAuth.aerospike_apikey_storage:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage
	56,  // 48: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.label_selector:type_name -> enterprise.gloo.solo.io.K8sSecretApiKeyStorage.LabelSelectorEntry
	88,  // 49: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.api_key_secret_refs:type_name -> core.solo.io.ResourceRef
	57,  // 50: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.headers_from_metadata:type_name -> enterprise.gloo.solo.io.K8sSecretApiKeyStorage.HeadersFromMetadataEntry
	59,  // 51: enterprise.gloo.solo.io.AerospikeApiKeyStorage.tls_curve_groups:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage.tlsCurveID
	60,  // 52: enterprise.gloo.solo.io.ApiKey.metadata:type_name -> enterprise.gloo.solo.io.ApiKey.MetadataEntry
	88,  // 53: enterprise.gloo.solo.io.OpaAuth.modules:type_name -> core.solo.io.ResourceRef
	32,  // 54: enterprise.gloo.solo.io.OpaAuth.options:type_name -> enterprise.gloo.solo.io.OpaAuthOptions
	61,  // 55: enterprise.gloo.solo.io.Ldap.pool:type_name -> enterprise.gloo.solo.io.Ldap.ConnectionPool
	...
	90,  // 58: enterprise.gloo.solo.io.PassThroughAuth.config:type_name -> google.protobuf.Struct
	89,  // 59: enterprise.gloo.solo.io.PassThroughGrpc.connection_timeout:type_name -> google.protobuf.Duration
	62,  // 60: enterprise.gloo.solo.io.PassThroughHttp.request:type_name -> enterprise.gloo.solo.io.PassThroughHttp.Request
	63,  // 61: enterprise.gloo.solo.io.PassThroughHttp.response:type_name -> enterprise.gloo.solo.io.PassThroughHttp.Response
	89,  // 62: enterprise.gloo.solo.io.PassThroughHttp.connection_timeout:type_name -> google.protobuf.Duration
	71,  // 63: enterprise.gloo.solo.io.ExtAuthConfig.configs:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.Config
	87,  // 64: enterprise.gloo.solo.io.ExtAuthConfig.boolean_expr:type_name -> google.protobuf.StringValue
	87,  // 65: enterprise.gloo.solo.io.AuthConfig.Config.name:type_name -> google.protobuf.StringValue
	12,  // 66: enterprise.gloo.solo.io.AuthConfig.Config.basic_auth:type_name -> enterprise.gloo.solo.io.BasicAuth
	13,  // 67: enterprise.gloo.solo.io.AuthConfig.Config.oauth:type_name -> enterprise.gloo.solo.io.OAuth
	14,  // 68: enterprise.gloo.solo.io.AuthConfig.Config.oauth2:type_name -> enterprise.gloo.solo.io.OAuth2
	27,  // 69: enterprise.gloo.solo.io.AuthConfig.Config.api_key_auth:type_name -> enterprise.gloo.solo.io.ApiKeyAuth
	11,  // 70: enterprise.gloo.solo.io.AuthConfig.Config.plugin_auth:type_name -> enterprise.gloo.solo.io.AuthPlugin
	31,  // 71: enterprise.gloo.solo.io.AuthConfig.Config.opa_auth:type_name -> enterprise.gloo.solo.io.OpaAuth
	33,  // 72: enterprise.gloo.solo.io.AuthConfig.Config.ldap:type_name -> enterprise.gloo.solo.io.Ldap
	92,  // 73: enterprise.gloo.solo.io.AuthConfig.Config.jwt:type_name -> google.protobuf.Empty
	34,  // 74: enterprise.gloo.solo.io.AuthConfig.Config.pass_through_auth:type_name -> enterprise.gloo.solo.io.PassThroughAuth
	42,  // 75: enterprise.gloo.solo.io.HttpService.Request.headers_to_add:type_name -> enterprise.gloo.solo.io.HttpService.Request.HeadersToAddEntry
	46,  // 76: enterprise.gloo.solo.io.BasicAuth.Apr.users:type_name -> enterprise.gloo.solo.io.BasicAuth.Apr.UsersEntry
	45,  // 77: enterprise.gloo.solo.io.BasicAuth.Apr.UsersEntry.value:type_name -> enterprise.gloo.solo.io.BasicAuth.Apr.SaltedHashedPassword
	91,  // 78: enterprise.gloo.solo.io.UserSession.InternalSession.allow_refreshing:type_name -> google.protobuf.BoolValue
	15,  // 79: enterprise.gloo.solo.io.UserSession.RedisSession.options:type_name -> enterprise.gloo.solo.io.RedisOptions
	91,  // 80: enterprise.gloo.solo.io.UserSession.RedisSession.allow_refreshing:type_name -> google.protobuf.BoolValue
	89,  // 81: enterprise.gloo.solo.io.UserSession.RedisSession.pre_expiry_buffer:type_name -> google.protobuf.Duration
	93,  // 82: enterprise.gloo.solo.io.UserSession.CookieOptions.max_age:type_name -> google.protobuf.UInt32Value
	91,  // 83: enterprise.gloo.solo.io.UserSession.CookieOptions.http_only:type_name -> google.protobuf.BoolValue
	87,  // 84: enterprise.gloo.solo.io.UserSession.CookieOptions.path:type_name -> google.protobuf.StringValue
	2,   // 85: enterprise.gloo.solo.io.UserSession.CookieOptions.same_site:type_name -> enterprise.gloo.solo.io.UserSession.CookieOptions.SameSite
	89,  // 86: enterprise.gloo.solo.io.JwtValidation.RemoteJwks.refresh_interval:type_name -> google.protobuf.Duration
	58,  // 87: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.HeadersFromMetadataEntry.value:type_name -> enterprise.gloo.solo.io.K8sSecretApiKeyStorage.SecretKey
	93,  // 88: enterprise.gloo.solo.io.Ldap.ConnectionPool.maxSize:type_name -> google.protobuf.UInt32Value
	93,  // 89: enterprise.gloo.solo.io.Ldap.ConnectionPool.initialSize:type_name -> google.protobuf.UInt32Value
	64,  // 90: enterprise.gloo.solo.io.PassThroughHttp.Request.headers_to_add:type_name -> enterprise.gloo.solo.io.PassThroughHttp.Request.HeadersToAddEntry
	72,  // 91: enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig.AuthEndpointQueryParamsEntry
	73,  // 92: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.AuthEndpointQueryParamsEntry
	74,  // 93: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.token_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.TokenEndpointQueryParamsEntry
	16,  // 94: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.session:type_name -> enterprise.gloo.solo.io.UserSession
	17,  // 95: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.headers:type_name -> enterprise.gloo.solo.io.HeaderConfiguration
	18,  // 96: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.discovery_override:type_name -> enterprise.gloo.solo.io.DiscoveryOverride
	89,  // 97: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.discovery_poll_interval:type_name -> google.protobuf.Duration
	19,  // 98: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.jwks_cache_refresh_policy:type_name -> enterprise.gloo.solo.io.JwksOnDemandCacheRefreshPolicy
	20,  // 99: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.auto_map_from_metadata:type_name -> enterprise.gloo.solo.io.AutoMapFromMetadata
	21,  // 100: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.end_session_properties:type_name -> enterprise.gloo.solo.io.EndSessionProperties
	75,  // 101: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.jwt:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation
	76,  // 102: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.introspection:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.IntrospectionValidation
	89,  // 103: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.cache_timeout:type_name -> google.protobuf.Duration
	77,  // 104: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.required_scopes:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.ScopeList
	66,  // 105: enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config.oidc_authorization_code:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig
	67,  // 106: enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config.access_token_validation_config:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig
	81,  // 107: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.valid_api_keys:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.ValidApiKeysEntry
	82,  // 108: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.headers_from_key_metadata:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.HeadersFromKeyMetadataEntry
	84,  // 109: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.modules:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.ModulesEntry
	32,  // 110: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.options:type_name -> enterprise.gloo.solo.io.OpaAuthOptions
	87,  // 111: enterprise.gloo.solo.io.ExtAuthConfig.Config.name:type_name -> google.protobuf.StringValue
	65,  // 112: enterprise.gloo.solo.io.ExtAuthConfig.Config.oauth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig
	68,  // 113: enterprise.gloo.solo.io.ExtAuthConfig.Config.oauth2:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config
	12,  // 114: enterprise.gloo.solo.io.ExtAuthConfig.Config.basic_auth:type_name -> enterprise.gloo.solo.io.BasicAuth
	69,  // 115: enterprise.gloo.solo.io.ExtAuthConfig.Config.api_key_auth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig
	11,  // 116: enterprise.gloo.solo.io.ExtAuthConfig.Config.plugin_auth:type_name -> enterprise.gloo.solo.io.AuthPlugin
	70,  // 117: enterprise.gloo.solo.io.ExtAuthConfig.Config.opa_auth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig
	33,  // 118: enterprise.gloo.solo.io.ExtAuthConfig.Config.ldap:type_name -> enterprise.gloo.solo.io.Ldap
	92,  // 119: enterprise.gloo.solo.io.ExtAuthConfig.Config.jwt:type_name -> google.protobuf.Empty
	34,  // 120: enterprise.gloo.solo.io.ExtAuthConfig.Config.pass_through_auth:type_name -> enterprise.gloo.solo.io.PassThroughAuth
	78,  // 121: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.remote_jwks:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.RemoteJwks
	79,  // 122: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.local_jwks:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.LocalJwks
	89,  // 123: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.RemoteJwks.refresh_interval:type_name -> google.protobuf.Duration
	83,  // 124: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata.metadata:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata.MetadataEntry
	80,  // 125: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.ValidApiKeysEntry.value:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata
	94,  // 126: enterprise.gloo.solo.io.ExtAuthDiscoveryService.StreamExtAuthConfig:input_type -> envoy.api.v2.DiscoveryRequest
	95,  // 127: enterprise.gloo.solo.io.ExtAuthDiscoveryService.DeltaExtAuthConfig:input_type -> envoy.api.v2.DeltaDiscoveryRequest
	94,  // 128: enterprise.gloo.solo.io.ExtAuthDiscoveryService.FetchExtAuthConfig:input_type -> envoy.api.v2.DiscoveryRequest
	38,  // 129: enterprise.gloo.solo.io.ApiKeyService.Create:input_type -> enterprise.gloo.solo.io.RawApiKey
	38,  // 130: enterprise.gloo.solo.io.ApiKeyService.Read:input_type -> enterprise.gloo.solo.io.RawApiKey
	30,  // 131: enterprise.gloo.solo.io.ApiKeyService.Update:input_type -> enterprise.gloo.solo.io.ApiKey
	38,  // 132: enterprise.gloo.solo.io.ApiKeyService.Delete:input_type -> enterprise.gloo.solo.io.RawApiKey
	96,  // 133: enterprise.gloo.solo.io.ExtAuthDiscoveryService.StreamExtAuthConfig:output_type -> envoy.api.v2.DiscoveryResponse
	97,  // 134: enterprise.gloo.solo.io.ExtAuthDiscoveryService.DeltaExtAuthConfig:output_type -> envoy.api.v2.DeltaDiscoveryResponse
	96,  // 135: enterprise.gloo.solo.io.ExtAuthDiscoveryService.FetchExtAuthConfig:output_type -> envoy.api.v2.DiscoveryResponse
	30,  // 136: enterprise.gloo.solo.io.ApiKeyService.Create:output_type -> enterprise.gloo.solo.io.ApiKey
	30,  // 137: enterprise.gloo.solo.io.ApiKeyService.Read:output_type -> enterprise.gloo.solo.io.ApiKey
	30,  // 138: enterprise.gloo.solo.io.ApiKeyService.Update:output_type -> enterprise.gloo.solo.io.ApiKey
	92,  // 139: enterprise.gloo.solo.io.ApiKeyService.Delete:output_type -> google.protobuf.Empty
	133, // [133:140] is the sub-list for method output_type
	126, // [126:133] is the sub-list for method input_type
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*K8SSecretApiKeyStorage_SecretKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes[25].OneofWrappers = []interface{}{
		...
		(*AerospikeApiKeyStorage_Session)(nil),
		(*AerospikeApiKeyStorage_Linearize)(nil),
		(*AerospikeApiKeyStorage_Replica)(nil),
		(*AerospikeApiKeyStorage_AllowUnavailable)(nil),
		(*AerospikeApiKeyStorage_One)(nil),
		(*AerospikeApiKeyStorage_All)(nil),
	}
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_proto_msgTypes[35].OneofWrappers = []interface{}{
...
type ApiKeyServiceClient interface {
	Create(ctx context.Context, in *RawApiKey, opts ...grpc.CallOption) (*ApiKey, error)
	Read(ctx context.Context, in *RawApiKey, opts ...grpc.CallOption) (*ApiKey, error)
	Update(ctx context.Context, in *ApiKey, opts ...grpc.CallOption) (*ApiKey, error)
	Delete(ctx context.Context, in *RawApiKey, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *apiKeyServiceClient) Create(ctx context.Context, in *RawApiKey, opts ...grpc.CallOption) (*ApiKey, error) {
	out := new(ApiKey)
...
func (c *apiKeyServiceClient) Read(ctx context.Context, in *RawApiKey, opts ...grpc.CallOption) (*ApiKey, error) {
	out := new(ApiKey)
...
func (c *apiKeyServiceClient) Update(ctx context.Context, in *ApiKey, opts ...grpc.CallOption) (*ApiKey, error) {
	out := new(ApiKey)
...
func (c *apiKeyServiceClient) Delete(ctx context.Context, in *RawApiKey, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ApiKeyServiceServer interface {
	Create(context.Context, *RawApiKey) (*ApiKey, error)
	Read(context.Context, *RawApiKey) (*ApiKey, error)
	Update(context.Context, *ApiKey) (*ApiKey, error)
	Delete(context.Context, *RawApiKey) (*empty.Empty, error)
}
...
func (*UnimplementedApiKeyServiceServer) Create(context.Context, *RawApiKey) (*ApiKey, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedApiKeyServiceServer) Read(context.Context, *RawApiKey) (*ApiKey, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Read not implemented")
}
func (*UnimplementedApiKeyServiceServer) Update(context.Context, *ApiKey) (*ApiKey, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (*UnimplementedApiKeyServiceServer) Delete(context.Context, *RawApiKey) (*empty.Empty, error) {
...
func _ApiKeyService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServiceServer).Create(ctx, req.(*RawApiKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiKeyService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServiceServer).Read(ctx, req.(*RawApiKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiKeyService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServiceServer).Update(ctx, req.(*ApiKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiKeyService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServiceServer).Delete(ctx, req.(*RawApiKey))
	}
	return interceptor(ctx, in, info, handler)
}

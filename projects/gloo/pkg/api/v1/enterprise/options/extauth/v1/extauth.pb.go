...
type AuthConfig struct {
	...
	// behavior can be changed to OR logic (any config that passes allows request) by setting
	// `allowAnyConfig` to true.
	Configs []*AuthConfig_Config `protobuf:"bytes,3,rep,name=configs,proto3" json:"configs,omitempty"`
	// By default, every config on an auth config must be authorized for the entire request to be
	// authorized. This behavior can be changed to OR logic (any config that passes allows request)
	// by setting `allowAnyConfig` to true.
	AllowAnyConfig       bool     `protobuf:"varint,8,opt,name=allowAnyConfig,proto3" json:"allowAnyConfig,omitempty"`
...
func (m *AuthConfig) GetAllowAnyConfig() bool {
	if m != nil {
		return m.AllowAnyConfig
	}
	return false
}
...
var fileDescriptor_043e68ecbb4b7f5e = []byte{
	...
	0x15, 0xd7, 0x92, 0x14, 0x45, 0x3d, 0x4a, 0xb2, 0x34, 0x96, 0x25, 0x79, 0x9d, 0x58, 0x0e, 0x63,
	...
	,
}
...
func (this *AuthConfig) Equal(that interface{}) bool {
	...
	if this.AllowAnyConfig != that1.AllowAnyConfig {
		return false
	}

...
func (m *CircuitBreakerConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetMaxConnections()).(interface {
	...
	if h, ok := interface{}(m.GetMaxPendingRequests()).(interface {
		Hash(hasher hash.Hash64) (uint64, error)
	}); ok {
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
	...
	if h, ok := interface{}(m.GetMaxRequests()).(interface {
		Hash(hasher hash.Hash64) (uint64, error)
	}); ok {
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
	...
	if h, ok := interface{}(m.GetMaxRetries()).(interface {
		Hash(hasher hash.Hash64) (uint64, error)
	}); ok {
		if _, err = h.Hash(hasher); err != nil {
			return 0, err

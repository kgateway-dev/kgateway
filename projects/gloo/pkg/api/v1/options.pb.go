...
type VirtualHostOptions struct {
	...
	//	*VirtualHostOptions_JwtStagedVhostConfig
...
func (x *VirtualHostOptions) GetJwtStagedVhostConfig() *jwt.JwtStagedVhostExtension {
	if x, ok := x.GetJwtConfig().(*VirtualHostOptions_JwtStagedVhostConfig); ok {
...
type VirtualHostOptions_JwtStagedVhostConfig struct {
	// Enterprise-only: Config for reading and verifying JWTs. Copy verifiable information from JWTs into other
	// headers to make routing decisions or combine with RBAC for fine-grained access control.
	...
	JwtStagedVhostConfig *jwt.JwtStagedVhostExtension `protobuf:"bytes,19,opt,name=jwt_staged_vhost_config,json=jwtStagedVhostConfig,proto3,oneof"`
}

func (*VirtualHostOptions_Jwt) isVirtualHostOptions_JwtConfig() {}

func (*VirtualHostOptions_JwtStagedVhostConfig) isVirtualHostOptions_JwtConfig() {}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_rawDesc = []byte{
	...
	0x6f, 0x78, 0x79, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x9f, 0x0d, 0x0a, 0x12,
	...
	0x6f, 0x6e, 0x42, 0x02, 0x18, 0x01, 0x48, 0x01, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x12, 0x6a, 0x0a,
	0x17, 0x6a, 0x77, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x64, 0x5f, 0x76, 0x68, 0x6f, 0x73,
	0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31,
	...
	0x6e, 0x48, 0x01, 0x52, 0x14, 0x6a, 0x77, 0x74, 0x53, 0x74, 0x61, 0x67, 0x65, 0x64, 0x56, 0x68,
	0x6f, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x40, 0x0a, 0x04, 0x72, 0x62, 0x61,
	...
	0x0c, 0x0a, 0x0a, 0x6a, 0x77, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x8d, 0x10,
	...
	0x6e, 0x73, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e,
	0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x52, 0x03, 0x77, 0x61, 0x66, 0x12, 0x3e, 0x0a,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x42, 0x02, 0x18, 0x01, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x12, 0x40, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x68, 0x0a, 0x17, 0x6a, 0x77, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x67,
	0x65, 0x64, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18,
	...
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x14, 0x6a, 0x77, 0x74, 0x53, 0x74, 0x61,
	0x67, 0x65, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x13,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_depIdxs = []int32{
	...
	34, // 30: gloo.solo.io.VirtualHostOptions.jwt_staged_vhost_config:type_name -> jwt.options.gloo.solo.io.JwtStagedVhostExtension
	...
	35, // 57: gloo.solo.io.RouteOptions.rbac:type_name -> rbac.options.gloo.solo.io.ExtensionSettings
	36, // 58: gloo.solo.io.RouteOptions.extauth:type_name -> enterprise.gloo.solo.io.ExtAuthExtension
	37, // 59: gloo.solo.io.RouteOptions.dlp:type_name -> dlp.options.gloo.solo.io.Config
	38, // 60: gloo.solo.io.RouteOptions.buffer_per_route:type_name -> solo.io.envoy.extensions.filters.http.buffer.v3.BufferPerRoute
	21, // 61: gloo.solo.io.RouteOptions.csrf:type_name -> solo.io.envoy.extensions.filters.http.csrf.v3.CsrfPolicy
	39, // 62: gloo.solo.io.RouteOptions.staged_transformations:type_name -> transformation.options.gloo.solo.io.TransformationStages
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*VirtualHostOptions_JwtStagedVhostConfig)(nil),
	}

...
type RouteOptions struct {
	...
	// Types that are assignable to JwtConfig:
	//	*RouteOptions_Jwt
	//	*RouteOptions_JwtStagedRouteConfig
...
func (x *RouteOptions) GetJwtStagedRouteConfig() *jwt.JwtStagedRouteExtension {
	if x, ok := x.GetJwtConfig().(*RouteOptions_JwtStagedRouteConfig); ok {
...
type RouteOptions_JwtStagedRouteConfig struct {
	// Enterprise-only: Config for reading and verifying JWTs. Copy verifiable information from JWTs into other
	// headers to make routing decisions or combine with RBAC for fine-grained access control.
	// JWT configuration has stages "BeforExtAuth" and "AfterExtAuth". BeforeExtAuth JWT
	// validation runs before the external authentication service. This is useful when JWT
	// is used in conjunction with other auth mechanisms specified in the [boolean expression Extauth API](https://docs.solo.io/gloo-edge/latest/reference/api/github.com/solo-io/gloo/projects/gloo/api/v1/enterprise/options/extauth/v1/extauth.proto.sk/#authconfig).
	JwtStagedRouteConfig *jwt.JwtStagedRouteExtension `protobuf:"bytes,25,opt,name=jwt_staged_route_config,json=jwtStagedRouteConfig,proto3,oneof"`
}

func (*RouteOptions_Jwt) isRouteOptions_JwtConfig() {}

func (*RouteOptions_JwtStagedRouteConfig) isRouteOptions_JwtConfig() {}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_rawDesc = []byte{
	...
	0x0c, 0x0a, 0x0a, 0x6a, 0x77, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x9f, 0x10,
	...
	0x6a, 0x0a, 0x17, 0x6a, 0x77, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x64, 0x5f, 0x72, 0x6f,
	0x75, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x19, 0x20, 0x01, 0x28, 0x0b,
	...
	0x69, 0x6f, 0x6e, 0x48, 0x02, 0x52, 0x14, 0x6a, 0x77, 0x74, 0x53, 0x74, 0x61, 0x67, 0x65, 0x64,
	0x52, 0x6f, 0x75, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x40, 0x0a, 0x04, 0x72,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_depIdxs = []int32{
	...
	49, // 57: gloo.solo.io.RouteOptions.jwt_staged_route_config:type_name -> jwt.options.gloo.solo.io.JwtStagedRouteExtension
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_msgTypes[4].OneofWrappers = []interface{}{
		...
		(*RouteOptions_JwtStagedRouteConfig)(nil),
	}

...
type SslConfig struct {
	...
	OneWayTls bool `protobuf:"varint,8,opt,name=oneWayTls,proto3" json:"oneWayTls,omitempty"`
}
...
type UpstreamSslConfig struct {
	...
	// if the SSL config has the ca.crt (root CA) provided, Gloo uses it to perform mTLS by default.
	// Set oneWayTls to true to disable mTLS in favor of server-only TLS (one-way TLS), even if Gloo has the root CA
	OneWayTls bool `protobuf:"varint,9,opt,name=oneWayTls,proto3" json:"oneWayTls,omitempty"`
}
...
func (x *UpstreamSslConfig) GetOneWayTls() bool {
	if x != nil {
		return x.OneWayTls
	}
	return false
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_ssl_proto_rawDesc = []byte{
	...
	0x65, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x94, 0x03, 0x0a, 0x09, 0x53, 0x73, 0x6c,
	...
	0x6c, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x6f, 0x6e, 0x65, 0x57, 0x61, 0x79, 0x54, 0x6c, 0x73, 0x18,
	...
	0x52, 0x06, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x61, 0x22, 0x8d, 0x03, 0x0a, 0x11, 0x55, 0x70, 0x73,
	...
	0x70, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x6f,
	0x6e, 0x65, 0x57, 0x61, 0x79, 0x54, 0x6c, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09,
	0x6f, 0x6e, 0x65, 0x57, 0x61, 0x79, 0x54, 0x6c, 0x73, 0x42, 0x0d, 0x0a, 0x0b, 0x73, 0x73, 0x6c,

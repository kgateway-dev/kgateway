...
type RoutePlugins struct {
	...
	Retries              *retries.RetryPolicy                 `protobuf:"bytes,5,opt,name=retries,proto3" json:"retries,omitempty"`
	AccessLoggingService *als.AccessLoggingService            `protobuf:"bytes,6,opt,name=access_logging_service,json=accessLoggingService,proto3" json:"access_logging_service,omitempty"`
...
func (m *RoutePlugins) GetAccessLoggingService() *als.AccessLoggingService {
	if m != nil {
		return m.AccessLoggingService
	}
	return nil
...
var fileDescriptor_ae47d2df5fad2a45 = []byte{
	...
	,
}

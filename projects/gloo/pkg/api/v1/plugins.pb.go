...
type ExtensionPlugins struct {
	Plugins              map[string]*types.Struct `protobuf:"bytes,1,rep,name=plugins" json:"plugins,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}

func (m *ExtensionPlugins) Reset()         { *m = ExtensionPlugins{} }
func (m *ExtensionPlugins) String() string { return proto.CompactTextString(m) }
func (*ExtensionPlugins) ProtoMessage()    {}
func (*ExtensionPlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_3c435604d56a537a, []int{0}
}
func (m *ExtensionPlugins) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExtensionPlugins.Unmarshal(m, b)
}
func (m *ExtensionPlugins) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExtensionPlugins.Marshal(b, m, deterministic)
}
func (dst *ExtensionPlugins) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExtensionPlugins.Merge(dst, src)
}
func (m *ExtensionPlugins) XXX_Size() int {
	return xxx_messageInfo_ExtensionPlugins.Size(m)
}
func (m *ExtensionPlugins) XXX_DiscardUnknown() {
	xxx_messageInfo_ExtensionPlugins.DiscardUnknown(m)
}

var xxx_messageInfo_ExtensionPlugins proto.InternalMessageInfo

func (m *ExtensionPlugins) GetPlugins() map[string]*types.Struct {
	if m != nil {
		return m.Plugins
	}
	return nil
...
func (*ListenerPlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_3c435604d56a537a, []int{1}
}
...
type VirtualHostPlugins struct {
	Plugins              *ExtensionPlugins `protobuf:"bytes,1,opt,name=plugins" json:"plugins,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*VirtualHostPlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_3c435604d56a537a, []int{2}
}
...
func (m *VirtualHostPlugins) GetPlugins() *ExtensionPlugins {
	if m != nil {
		return m.Plugins
	}
	return nil
...
func (*RoutePlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_3c435604d56a537a, []int{3}
}
...
func (*DestinationSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_3c435604d56a537a, []int{4}
}
...
func (*UpstreamSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_3c435604d56a537a, []int{5}
}
...
func init() {
	proto.RegisterType((*ExtensionPlugins)(nil), "gloo.solo.io.ExtensionPlugins")
	proto.RegisterMapType((map[string]*types.Struct)(nil), "gloo.solo.io.ExtensionPlugins.PluginsEntry")
...
func (this *ExtensionPlugins) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ExtensionPlugins)
	if !ok {
		that2, ok := that.(ExtensionPlugins)
		if ok {
			that1 = &that2
		} else {
			return false
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo/projects/gloo/api/v1/plugins.proto", fileDescriptor_plugins_3c435604d56a537a)
}

var fileDescriptor_plugins_3c435604d56a537a = []byte{
	// 777 bytes of a gzipped FileDescriptorProto
	,
}

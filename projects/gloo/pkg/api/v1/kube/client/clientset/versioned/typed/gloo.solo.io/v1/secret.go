...
type SecretInterface interface {
	...
	Apply(ctx context.Context, secret *gloosoloiov1.SecretApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Secret, err error)
	SecretExpansion
}
...
func (c *secrets) Apply(ctx context.Context, secret *gloosoloiov1.SecretApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Secret, err error) {
	if secret == nil {

...
type ProxyInterface interface {
	...
	Apply(ctx context.Context, proxy *gloosoloiov1.ProxyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Proxy, err error)
	ApplyStatus(ctx context.Context, proxy *gloosoloiov1.ProxyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Proxy, err error)
	ProxyExpansion
}
...
func (c *proxies) Apply(ctx context.Context, proxy *gloosoloiov1.ProxyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Proxy, err error) {
	if proxy == nil {
...
func (c *proxies) ApplyStatus(ctx context.Context, proxy *gloosoloiov1.ProxyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Proxy, err error) {
	if proxy == nil {
		return nil, fmt.Errorf("proxy provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()

...
type EndpointInterface interface {
	...
	Apply(ctx context.Context, endpoint *gloosoloiov1.EndpointApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Endpoint, err error)
	EndpointExpansion
}
...
func (c *endpoints) Apply(ctx context.Context, endpoint *gloosoloiov1.EndpointApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Endpoint, err error) {
	if endpoint == nil {

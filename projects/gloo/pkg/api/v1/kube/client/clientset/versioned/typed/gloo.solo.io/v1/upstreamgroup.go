...
type UpstreamGroupInterface interface {
	...
	Apply(ctx context.Context, upstreamGroup *gloosoloiov1.UpstreamGroupApplyConfiguration, opts metav1.ApplyOptions) (result *v1.UpstreamGroup, err error)
	ApplyStatus(ctx context.Context, upstreamGroup *gloosoloiov1.UpstreamGroupApplyConfiguration, opts metav1.ApplyOptions) (result *v1.UpstreamGroup, err error)
...
func (c *upstreamGroups) Apply(ctx context.Context, upstreamGroup *gloosoloiov1.UpstreamGroupApplyConfiguration, opts metav1.ApplyOptions) (result *v1.UpstreamGroup, err error) {
...
func (c *upstreamGroups) ApplyStatus(ctx context.Context, upstreamGroup *gloosoloiov1.UpstreamGroupApplyConfiguration, opts metav1.ApplyOptions) (result *v1.UpstreamGroup, err error) {
	if upstreamGroup == nil {
		return nil, fmt.Errorf("upstreamGroup provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()

...
type SettingsInterface interface {
	...
	Apply(ctx context.Context, settings *gloosoloiov1.SettingsApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Settings, err error)
	ApplyStatus(ctx context.Context, settings *gloosoloiov1.SettingsApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Settings, err error)
	SettingsExpansion
}
...
func (c *settingses) Apply(ctx context.Context, settings *gloosoloiov1.SettingsApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Settings, err error) {
	if settings == nil {
...
func (c *settingses) ApplyStatus(ctx context.Context, settings *gloosoloiov1.SettingsApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Settings, err error) {
	if settings == nil {
		return nil, fmt.Errorf("settings provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()

...
func (c *FakeUpstreams) UpdateStatus(ctx context.Context, upstream *v1.Upstream, opts metav1.UpdateOptions) (*v1.Upstream, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(upstreamsResource, "status", c.ns, upstream), &v1.Upstream{})
...
func (c *FakeUpstreams) Apply(ctx context.Context, upstream *gloosoloiov1.UpstreamApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Upstream, err error) {
	if upstream == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(upstreamsResource, c.ns, *name, types.ApplyPatchType, data), &v1.Upstream{})
...
func (c *FakeUpstreams) ApplyStatus(ctx context.Context, upstream *gloosoloiov1.UpstreamApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Upstream, err error) {
	if upstream == nil {
		return nil, fmt.Errorf("upstream provided to Apply must not be nil")
	}
	data, err := json.Marshal(upstream)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(upstreamsResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1.Upstream{})

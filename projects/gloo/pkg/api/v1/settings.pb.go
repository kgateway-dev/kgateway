...
type GlooOptions struct {
	...
	// Where the `gloo` proxy debug server should bind. Defaults to `0.0.0.0:9966`
...
type Settings_ConsulConfiguration struct {
	...
	// The address of the Consul HTTP server.
	// Used by service discovery and key-value storage (if-enabled).
	// Defaults to the value of the standard CONSUL_HTTP_DDR env if set, otherwise to 127.0.0.1:8500.
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x73, 0x22, 0xd5, 0x0d, 0x0a, 0x0b, 0x47, 0x6c, 0x6f, 0x6f, 0x4f, 0x70, 0x74,
	...
	0x64, 0x64, 0x72, 0x1a, 0xaa, 0x03, 0x0a, 0x0a, 0x41, 0x57, 0x53, 0x4f, 0x70, 0x74, 0x69, 0x6f,

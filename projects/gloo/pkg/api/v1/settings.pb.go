...
type Settings_VaultSecrets_AccessToken struct {
	AccessToken string `protobuf:"bytes,11,opt,name=access_token,json=accessToken,proto3,oneof"`
}

type Settings_VaultSecrets_Aws struct {
	Aws *Settings_VaultAwsAuth `protobuf:"bytes,12,opt,name=aws,proto3,oneof"`
}
...
type Settings_VaultAwsAuth struct {
	...
	//	*Settings_VaultAwsAuth_Iam
	//	*Settings_VaultAwsAuth_Ec2
	LoginMethod       isSettings_VaultAwsAuth_LoginMethod `protobuf_oneof:"login_method"`
	Role              string                              `protobuf:"bytes,3,opt,name=role,proto3" json:"role,omitempty"`
	Region            string                              `protobuf:"bytes,4,opt,name=region,proto3" json:"region,omitempty"`
	IamServerIdHeader string                              `protobuf:"bytes,5,opt,name=iam_server_id_header,json=iamServerIdHeader,proto3" json:"iam_server_id_header,omitempty"`
...
func (m *Settings_VaultAwsAuth) GetLoginMethod() isSettings_VaultAwsAuth_LoginMethod {
	if m != nil {
...
func (x *Settings_VaultAwsAuth) GetIam() *Settings_VaultAwsIam {
	if x, ok := x.GetLoginMethod().(*Settings_VaultAwsAuth_Iam); ok {
		return x.Iam
	}
	return nil
}

func (x *Settings_VaultAwsAuth) GetEc2() *Settings_VaultAwsEc2 {
	if x, ok := x.GetLoginMethod().(*Settings_VaultAwsAuth_Ec2); ok {
		return x.Ec2
	}
	return nil
}

func (x *Settings_VaultAwsAuth) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
type isSettings_VaultAwsAuth_LoginMethod interface {
	isSettings_VaultAwsAuth_LoginMethod()
}

type Settings_VaultAwsAuth_Iam struct {
	Iam *Settings_VaultAwsIam `protobuf:"bytes,1,opt,name=iam,proto3,oneof"`
}

type Settings_VaultAwsAuth_Ec2 struct {
	Ec2 *Settings_VaultAwsEc2 `protobuf:"bytes,2,opt,name=ec2,proto3,oneof"`
}

func (*Settings_VaultAwsAuth_Iam) isSettings_VaultAwsAuth_LoginMethod() {}

func (*Settings_VaultAwsAuth_Ec2) isSettings_VaultAwsAuth_LoginMethod() {}

type Settings_VaultAwsIam struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Settings_VaultAwsIam) Reset() {
	*x = Settings_VaultAwsIam{}
	if protoimpl.UnsafeEnabled {
...
func (x *Settings_VaultAwsIam) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Settings_VaultAwsIam) ProtoMessage() {}

func (x *Settings_VaultAwsIam) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Settings_VaultAwsIam.ProtoReflect.Descriptor instead.
func (*Settings_VaultAwsIam) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDescGZIP(), []int{0, 4}
}

type Settings_VaultAwsEc2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Indicates which signature type to request from the metadata service
	//
	// Types that are assignable to SignatureType:
	//	*Settings_VaultAwsEc2_Pkcs7
	//	*Settings_VaultAwsEc2_Identity
	//	*Settings_VaultAwsEc2_Rsa2048
	SignatureType isSettings_VaultAwsEc2_SignatureType `protobuf_oneof:"signature_type"`
	// Optional: The reauthentication value
	Nonce string `protobuf:"bytes,4,opt,name=nonce,proto3" json:"nonce,omitempty"`
	// Values expected to be in environment variables when a session is created.
	// Session created by Vault api: https://github.com/hashicorp/vault/blob/v1.12.0/api/auth/aws/aws.go#L95
	// Values loaded from env: https://github.com/aws/aws-sdk-go/blob/ff2ebe8a4d96fcb91638d45c8ead4bfc533bf679/aws/session/env_config.go#L292
	RoleArn         string `protobuf:"bytes,5,opt,name=role_arn,json=roleArn,proto3" json:"role_arn,omitempty"`
	RoleSessionName string `protobuf:"bytes,6,opt,name=role_session_name,json=roleSessionName,proto3" json:"role_session_name,omitempty"`
	// this should not be a file path? can't be a secret ref since we're configuring the secrets engine...
	WebIdentityTokenFilePath string `protobuf:"bytes,7,opt,name=web_identity_token_file_path,json=webIdentityTokenFilePath,proto3" json:"web_identity_token_file_path,omitempty"`
	CsmEnabled               string `protobuf:"bytes,8,opt,name=csm_enabled,json=csmEnabled,proto3" json:"csm_enabled,omitempty"`
	CsmHost                  string `protobuf:"bytes,9,opt,name=csm_host,json=csmHost,proto3" json:"csm_host,omitempty"`
	CsmPort                  string `protobuf:"bytes,10,opt,name=csm_port,json=csmPort,proto3" json:"csm_port,omitempty"`
	CsmClientId              string `protobuf:"bytes,11,opt,name=csm_client_id,json=csmClientId,proto3" json:"csm_client_id,omitempty"`
	// string region -- use region defined in VaultAwsAuth
	Profile                   string `protobuf:"bytes,12,opt,name=profile,proto3" json:"profile,omitempty"`
	EnableEndpointDiscovery   bool   `protobuf:"varint,13,opt,name=enable_endpoint_discovery,json=enableEndpointDiscovery,proto3" json:"enable_endpoint_discovery,omitempty"`
	CustomCaBundle            bool   `protobuf:"varint,14,opt,name=custom_ca_bundle,json=customCaBundle,proto3" json:"custom_ca_bundle,omitempty"`
	ClientTlsCert             string `protobuf:"bytes,15,opt,name=client_tls_cert,json=clientTlsCert,proto3" json:"client_tls_cert,omitempty"`
	ClientTlsKey              string `protobuf:"bytes,16,opt,name=client_tls_key,json=clientTlsKey,proto3" json:"client_tls_key,omitempty"`
	StsRegionalEndpoint       string `protobuf:"bytes,17,opt,name=sts_regional_endpoint,json=stsRegionalEndpoint,proto3" json:"sts_regional_endpoint,omitempty"`
	S3UsEast1RegionalEndpoint string `protobuf:"bytes,18,opt,name=s3_us_east1_regional_endpoint,json=s3UsEast1RegionalEndpoint,proto3" json:"s3_us_east1_regional_endpoint,omitempty"`
	S3UseArnRegion            bool   `protobuf:"varint,19,opt,name=s3_use_arn_region,json=s3UseArnRegion,proto3" json:"s3_use_arn_region,omitempty"`
	Ec2ImdsEndpoint           string `protobuf:"bytes,20,opt,name=ec2_imds_endpoint,json=ec2ImdsEndpoint,proto3" json:"ec2_imds_endpoint,omitempty"`
	Ec2ImdsEndpointMode       string `protobuf:"bytes,21,opt,name=ec2_imds_endpoint_mode,json=ec2ImdsEndpointMode,proto3" json:"ec2_imds_endpoint_mode,omitempty"`
	UseDualStackEndpoint      bool   `protobuf:"varint,22,opt,name=use_dual_stack_endpoint,json=useDualStackEndpoint,proto3" json:"use_dual_stack_endpoint,omitempty"`
	UseFipsEndpoint           bool   `protobuf:"varint,23,opt,name=use_fips_endpoint,json=useFipsEndpoint,proto3" json:"use_fips_endpoint,omitempty"`
}

func (x *Settings_VaultAwsEc2) Reset() {
	*x = Settings_VaultAwsEc2{}
	if protoimpl.UnsafeEnabled {
...
func (x *Settings_VaultAwsEc2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Settings_VaultAwsEc2) ProtoMessage() {}

func (x *Settings_VaultAwsEc2) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Settings_VaultAwsEc2.ProtoReflect.Descriptor instead.
func (*Settings_VaultAwsEc2) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDescGZIP(), []int{0, 5}
}

func (m *Settings_VaultAwsEc2) GetSignatureType() isSettings_VaultAwsEc2_SignatureType {
	if m != nil {
...
func (x *Settings_VaultAwsEc2) GetPkcs7() *Settings_VaultAwsEc2_Pkcs7Type {
	if x, ok := x.GetSignatureType().(*Settings_VaultAwsEc2_Pkcs7); ok {
		return x.Pkcs7
	}
	return nil
}

func (x *Settings_VaultAwsEc2) GetIdentity() *Settings_VaultAwsEc2_IdentityType {
	if x, ok := x.GetSignatureType().(*Settings_VaultAwsEc2_Identity); ok {
		return x.Identity
	}
	return nil
}

func (x *Settings_VaultAwsEc2) GetRsa2048() *Settings_VaultAwsEc2_Rsa2048Type {
	if x, ok := x.GetSignatureType().(*Settings_VaultAwsEc2_Rsa2048); ok {
		return x.Rsa2048
	}
	return nil
}

func (x *Settings_VaultAwsEc2) GetNonce() string {
	if x != nil {
		return x.Nonce
	}
	return ""
...
func (x *Settings_VaultAwsEc2) GetRoleArn() string {
	if x != nil {
		return x.RoleArn
	}
	return ""
...
func (x *Settings_VaultAwsEc2) GetRoleSessionName() string {
	if x != nil {
...
func (x *Settings_VaultAwsEc2) GetWebIdentityTokenFilePath() string {
	if x != nil {
		return x.WebIdentityTokenFilePath
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetCsmEnabled() string {
	if x != nil {
		return x.CsmEnabled
	}
	return ""
...
func (x *Settings_VaultAwsEc2) GetCsmHost() string {
	if x != nil {
		return x.CsmHost
	}
	return ""
...
func (x *Settings_VaultAwsEc2) GetCsmPort() string {
	if x != nil {
		return x.CsmPort
	}
	return ""
...
func (x *Settings_VaultAwsEc2) GetCsmClientId() string {
	if x != nil {
		return x.CsmClientId
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *Settings_VaultAwsEc2) GetEnableEndpointDiscovery() bool {
	if x != nil {
		return x.EnableEndpointDiscovery
	}
	return false
}

func (x *Settings_VaultAwsEc2) GetCustomCaBundle() bool {
	if x != nil {
...
func (x *Settings_VaultAwsEc2) GetClientTlsCert() string {
	if x != nil {
...
func (x *Settings_VaultAwsEc2) GetClientTlsKey() string {
	if x != nil {
		return x.ClientTlsKey
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetStsRegionalEndpoint() string {
	if x != nil {
		return x.StsRegionalEndpoint
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetS3UsEast1RegionalEndpoint() string {
	if x != nil {
		return x.S3UsEast1RegionalEndpoint
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetS3UseArnRegion() bool {
	if x != nil {
		return x.S3UseArnRegion
	}
	return false
}

func (x *Settings_VaultAwsEc2) GetEc2ImdsEndpoint() string {
	if x != nil {
		return x.Ec2ImdsEndpoint
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetEc2ImdsEndpointMode() string {
	if x != nil {
		return x.Ec2ImdsEndpointMode
	}
	return ""
}

func (x *Settings_VaultAwsEc2) GetUseDualStackEndpoint() bool {
	if x != nil {
		return x.UseDualStackEndpoint
	}
	return false
}

func (x *Settings_VaultAwsEc2) GetUseFipsEndpoint() bool {
	if x != nil {
		return x.UseFipsEndpoint
	}
	return false
}

type isSettings_VaultAwsEc2_SignatureType interface {
	isSettings_VaultAwsEc2_SignatureType()
}

type Settings_VaultAwsEc2_Pkcs7 struct {
	Pkcs7 *Settings_VaultAwsEc2_Pkcs7Type `protobuf:"bytes,1,opt,name=pkcs7,proto3,oneof"`
}

type Settings_VaultAwsEc2_Identity struct {
	Identity *Settings_VaultAwsEc2_IdentityType `protobuf:"bytes,2,opt,name=identity,proto3,oneof"`
}

type Settings_VaultAwsEc2_Rsa2048 struct {
	Rsa2048 *Settings_VaultAwsEc2_Rsa2048Type `protobuf:"bytes,3,opt,name=rsa2048,proto3,oneof"`
}

func (*Settings_VaultAwsEc2_Pkcs7) isSettings_VaultAwsEc2_SignatureType() {}

func (*Settings_VaultAwsEc2_Identity) isSettings_VaultAwsEc2_SignatureType() {}

func (*Settings_VaultAwsEc2_Rsa2048) isSettings_VaultAwsEc2_SignatureType() {}
...
type Settings_VaultAwsEc2_Pkcs7Type struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Settings_VaultAwsEc2_Pkcs7Type) Reset() {
	*x = Settings_VaultAwsEc2_Pkcs7Type{}
	if protoimpl.UnsafeEnabled {
...
func (x *Settings_VaultAwsEc2_Pkcs7Type) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Settings_VaultAwsEc2_Pkcs7Type) ProtoMessage() {}

func (x *Settings_VaultAwsEc2_Pkcs7Type) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Settings_VaultAwsEc2_Pkcs7Type.ProtoReflect.Descriptor instead.
func (*Settings_VaultAwsEc2_Pkcs7Type) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDescGZIP(), []int{0, 5, 0}
}

type Settings_VaultAwsEc2_IdentityType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Settings_VaultAwsEc2_IdentityType) Reset() {
	*x = Settings_VaultAwsEc2_IdentityType{}
	if protoimpl.UnsafeEnabled {
...
func (x *Settings_VaultAwsEc2_IdentityType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Settings_VaultAwsEc2_IdentityType) ProtoMessage() {}

func (x *Settings_VaultAwsEc2_IdentityType) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Settings_VaultAwsEc2_IdentityType.ProtoReflect.Descriptor instead.
func (*Settings_VaultAwsEc2_IdentityType) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDescGZIP(), []int{0, 5, 1}
}

type Settings_VaultAwsEc2_Rsa2048Type struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Settings_VaultAwsEc2_Rsa2048Type) Reset() {
	*x = Settings_VaultAwsEc2_Rsa2048Type{}
	if protoimpl.UnsafeEnabled {
...
func (x *Settings_VaultAwsEc2_Rsa2048Type) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Settings_VaultAwsEc2_Rsa2048Type) ProtoMessage() {}

func (x *Settings_VaultAwsEc2_Rsa2048Type) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Settings_VaultAwsEc2_Rsa2048Type.ProtoReflect.Descriptor instead.
func (*Settings_VaultAwsEc2_Rsa2048Type) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDescGZIP(), []int{0, 5, 2}
}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x3d, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
	...
	0x65, 0x74, 0x65, 0x73, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x1a, 0xb9, 0x03, 0x0a, 0x0c,
	...
	0x70, 0x61, 0x74, 0x68, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x23, 0x0a, 0x0c, 0x61, 0x63,
	...
	0x37, 0x0a, 0x03, 0x61, 0x77, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x67,
	...
	,
	...
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x11, 0x69, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x64, 0x48,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x61,
	0x74, 0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x50,
	0x61, 0x74, 0x68, 0x12, 0x22, 0x0a, 0x0d, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x6b, 0x65,
	0x79, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x63, 0x63, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x6f, 0x78, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x1a, 0xff, 0x04, 0x0a, 0x10,
	0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x12, 0x4a, 0x0a, 0x08, 0x66, 0x64, 0x73, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x6f, 0x64, 0x65, 0x52, 0x07, 0x66, 0x64, 0x73, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x53, 0x0a, 0x0b,
	...
	0x73, 0x12, 0x53, 0x0a, 0x0b, 0x66, 0x64, 0x73, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f,
	0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x44,
	...
	,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_goTypes = []interface{}{
	...
	(*Settings_VaultAwsIam)(nil),                          // 13: gloo.solo.io.Settings.VaultAwsIam
	(*Settings_VaultAwsEc2)(nil),                          // 14: gloo.solo.io.Settings.VaultAwsEc2
	...
	(*Settings_VaultAwsEc2_Pkcs7Type)(nil),                // 25: gloo.solo.io.Settings.VaultAwsEc2.Pkcs7Type
	(*Settings_VaultAwsEc2_IdentityType)(nil),             // 26: gloo.solo.io.Settings.VaultAwsEc2.IdentityType
	(*Settings_VaultAwsEc2_Rsa2048Type)(nil),              // 27: gloo.solo.io.Settings.VaultAwsEc2.Rsa2048Type
	...
	(*SslParameters)(nil),                                 // 51: gloo.solo.io.SslParameters
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_depIdxs = []int32{
	...
	16, // 6: gloo.solo.io.Settings.kubernetes_artifact_source:type_name -> gloo.solo.io.Settings.KubernetesConfigmaps
	17, // 7: gloo.solo.io.Settings.directory_artifact_source:type_name -> gloo.solo.io.Settings.Directory
	15, // 8: gloo.solo.io.Settings.consul_kv_artifact_source:type_name -> gloo.solo.io.Settings.ConsulKv
	42, // 9: gloo.solo.io.Settings.refresh_rate:type_name -> google.protobuf.Duration
	18, // 10: gloo.solo.io.Settings.knative:type_name -> gloo.solo.io.Settings.KnativeOptions
	19, // 11: gloo.solo.io.Settings.discovery:type_name -> gloo.solo.io.Settings.DiscoveryOptions
	...
	20, // 14: gloo.solo.io.Settings.consul:type_name -> gloo.solo.io.Settings.ConsulConfiguration
	21, // 15: gloo.solo.io.Settings.consulDiscovery:type_name -> gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration
	22, // 16: gloo.solo.io.Settings.kubernetes:type_name -> gloo.solo.io.Settings.KubernetesConfiguration
	43, // 17: gloo.solo.io.Settings.extensions:type_name -> gloo.solo.io.Extensions
	44, // 18: gloo.solo.io.Settings.ratelimit:type_name -> ratelimit.options.gloo.solo.io.ServiceSettings
	45, // 19: gloo.solo.io.Settings.ratelimit_server:type_name -> ratelimit.options.gloo.solo.io.Settings
	46, // 20: gloo.solo.io.Settings.rbac:type_name -> rbac.options.gloo.solo.io.Settings
	47, // 21: gloo.solo.io.Settings.extauth:type_name -> enterprise.gloo.solo.io.Settings
	23, // 22: gloo.solo.io.Settings.named_extauth:type_name -> gloo.solo.io.Settings.NamedExtauthEntry
	48, // 23: gloo.solo.io.Settings.caching_server:type_name -> caching.options.gloo.solo.io.Settings
	49, // 24: gloo.solo.io.Settings.metadata:type_name -> core.solo.io.Metadata
	50, // 25: gloo.solo.io.Settings.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	24, // 26: gloo.solo.io.Settings.observabilityOptions:type_name -> gloo.solo.io.Settings.ObservabilityOptions
	...
	51, // 30: gloo.solo.io.UpstreamOptions.ssl_parameters:type_name -> gloo.solo.io.SslParameters
	37, // 31: gloo.solo.io.UpstreamOptions.global_annotations:type_name -> gloo.solo.io.UpstreamOptions.GlobalAnnotationsEntry
	52, // 32: gloo.solo.io.GlooOptions.circuit_breakers:type_name -> gloo.solo.io.CircuitBreakerConfig
	42, // 33: gloo.solo.io.GlooOptions.endpoints_warming_timeout:type_name -> google.protobuf.Duration
	38, // 34: gloo.solo.io.GlooOptions.aws_options:type_name -> gloo.solo.io.GlooOptions.AWSOptions
	39, // 35: gloo.solo.io.GlooOptions.invalid_config_policy:type_name -> gloo.solo.io.GlooOptions.InvalidConfigPolicy
	53, // 36: gloo.solo.io.GlooOptions.disable_grpc_web:type_name -> google.protobuf.BoolValue
	53, // 37: gloo.solo.io.GlooOptions.disable_proxy_garbage_collection:type_name -> google.protobuf.BoolValue
	54, // 38: gloo.solo.io.GlooOptions.regex_max_program_size:type_name -> google.protobuf.UInt32Value
	53, // 39: gloo.solo.io.GlooOptions.enable_rest_eds:type_name -> google.protobuf.BoolValue
	42, // 40: gloo.solo.io.GlooOptions.failover_upstream_dns_polling_interval:type_name -> google.protobuf.Duration
	53, // 41: gloo.solo.io.GlooOptions.remove_unused_filters:type_name -> google.protobuf.BoolValue
	53, // 42: gloo.solo.io.VirtualServiceOptions.one_way_tls:type_name -> google.protobuf.BoolValue
	40, // 43: gloo.solo.io.GatewayOptions.validation:type_name -> gloo.solo.io.GatewayOptions.ValidationOptions
	5,  // 44: gloo.solo.io.GatewayOptions.virtual_service_options:type_name -> gloo.solo.io.VirtualServiceOptions
	53, // 45: gloo.solo.io.GatewayOptions.persist_proxy_spec:type_name -> google.protobuf.BoolValue
	53, // 46: gloo.solo.io.GatewayOptions.enable_gateway_controller:type_name -> google.protobuf.BoolValue
	53, // 47: gloo.solo.io.GatewayOptions.isolate_virtual_hosts_by_ssl_config:type_name -> google.protobuf.BoolValue
	53, // 48: gloo.solo.io.ConsoleOptions.read_only:type_name -> google.protobuf.BoolValue
	53, // 49: gloo.solo.io.ConsoleOptions.api_explorer_enabled:type_name -> google.protobuf.BoolValue
	41, // 50: gloo.solo.io.GraphqlOptions.schema_change_validation_options:type_name -> gloo.solo.io.GraphqlOptions.SchemaChangeValidationOptions
	53, // 51: gloo.solo.io.Settings.VaultSecrets.insecure:type_name -> google.protobuf.BoolValue
	12, // 52: gloo.solo.io.Settings.VaultSecrets.aws:type_name -> gloo.solo.io.Settings.VaultAwsAuth
	13, // 53: gloo.solo.io.Settings.VaultAwsAuth.iam:type_name -> gloo.solo.io.Settings.VaultAwsIam
	14, // 54: gloo.solo.io.Settings.VaultAwsAuth.ec2:type_name -> gloo.solo.io.Settings.VaultAwsEc2
	25, // 55: gloo.solo.io.Settings.VaultAwsEc2.pkcs7:type_name -> gloo.solo.io.Settings.VaultAwsEc2.Pkcs7Type
	26, // 56: gloo.solo.io.Settings.VaultAwsEc2.identity:type_name -> gloo.solo.io.Settings.VaultAwsEc2.IdentityType
	27, // 57: gloo.solo.io.Settings.VaultAwsEc2.rsa2048:type_name -> gloo.solo.io.Settings.VaultAwsEc2.Rsa2048Type
	0,  // 58: gloo.solo.io.Settings.DiscoveryOptions.fds_mode:type_name -> gloo.solo.io.Settings.DiscoveryOptions.FdsMode
	28, // 59: gloo.solo.io.Settings.DiscoveryOptions.uds_options:type_name -> gloo.solo.io.Settings.DiscoveryOptions.UdsOptions
	29, // 60: gloo.solo.io.Settings.DiscoveryOptions.fds_options:type_name -> gloo.solo.io.Settings.DiscoveryOptions.FdsOptions
	53, // 61: gloo.solo.io.Settings.ConsulConfiguration.insecure_skip_verify:type_name -> google.protobuf.BoolValue
	42, // 62: gloo.solo.io.Settings.ConsulConfiguration.wait_time:type_name -> google.protobuf.Duration
	31, // 63: gloo.solo.io.Settings.ConsulConfiguration.service_discovery:type_name -> gloo.solo.io.Settings.ConsulConfiguration.ServiceDiscoveryOptions
	42, // 64: gloo.solo.io.Settings.ConsulConfiguration.dns_polling_interval:type_name -> google.protobuf.Duration
	55, // 65: gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration.rootCa:type_name -> core.solo.io.ResourceRef
	56, // 66: gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration.consistencyMode:type_name -> consul.options.gloo.solo.io.ConsulConsistencyModes
	57, // 67: gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration.query_options:type_name -> consul.options.gloo.solo.io.QueryOptions
	53, // 68: gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration.eds_blocking_queries:type_name -> google.protobuf.BoolValue
	32, // 69: gloo.solo.io.Settings.KubernetesConfiguration.rate_limits:type_name -> gloo.solo.io.Settings.KubernetesConfiguration.RateLimits
	47, // 70: gloo.solo.io.Settings.NamedExtauthEntry.value:type_name -> enterprise.gloo.solo.io.Settings
	33, // 71: gloo.solo.io.Settings.ObservabilityOptions.grafanaIntegration:type_name -> gloo.solo.io.Settings.ObservabilityOptions.GrafanaIntegration
	35, // 72: gloo.solo.io.Settings.ObservabilityOptions.configStatusMetricLabels:type_name -> gloo.solo.io.Settings.ObservabilityOptions.ConfigStatusMetricLabelsEntry
	53, // 73: gloo.solo.io.Settings.DiscoveryOptions.UdsOptions.enabled:type_name -> google.protobuf.BoolValue
	30, // 74: gloo.solo.io.Settings.DiscoveryOptions.UdsOptions.watch_labels:type_name -> gloo.solo.io.Settings.DiscoveryOptions.UdsOptions.WatchLabelsEntry
	53, // 75: gloo.solo.io.Settings.DiscoveryOptions.FdsOptions.graphql_enabled:type_name -> google.protobuf.BoolValue
	54, // 76: gloo.solo.io.Settings.ObservabilityOptions.GrafanaIntegration.default_dashboard_folder_id:type_name -> google.protobuf.UInt32Value
	36, // 77: gloo.solo.io.Settings.ObservabilityOptions.MetricLabels.labelToPath:type_name -> gloo.solo.io.Settings.ObservabilityOptions.MetricLabels.LabelToPathEntry
	34, // 78: gloo.solo.io.Settings.ObservabilityOptions.ConfigStatusMetricLabelsEntry.value:type_name -> gloo.solo.io.Settings.ObservabilityOptions.MetricLabels
	58, // 79: gloo.solo.io.GlooOptions.AWSOptions.service_account_credentials:type_name -> envoy.config.filter.http.aws_lambda.v2.AWSLambdaConfig.ServiceAccountCredentials
	53, // 80: gloo.solo.io.GlooOptions.AWSOptions.propagate_original_routing:type_name -> google.protobuf.BoolValue
	42, // 81: gloo.solo.io.GlooOptions.AWSOptions.credential_refresh_delay:type_name -> google.protobuf.Duration
	53, // 82: gloo.solo.io.GlooOptions.AWSOptions.fallback_to_first_function:type_name -> google.protobuf.BoolValue
	53, // 83: gloo.solo.io.GatewayOptions.ValidationOptions.always_accept:type_name -> google.protobuf.BoolValue
	53, // 84: gloo.solo.io.GatewayOptions.ValidationOptions.allow_warnings:type_name -> google.protobuf.BoolValue
	53, // 85: gloo.solo.io.GatewayOptions.ValidationOptions.warn_route_short_circuiting:type_name -> google.protobuf.BoolValue
	53, // 86: gloo.solo.io.GatewayOptions.ValidationOptions.disable_transformation_validation:type_name -> google.protobuf.BoolValue
	59, // 87: gloo.solo.io.GatewayOptions.ValidationOptions.validation_server_grpc_max_size_bytes:type_name -> google.protobuf.Int32Value
	53, // 88: gloo.solo.io.GatewayOptions.ValidationOptions.server_enabled:type_name -> google.protobuf.BoolValue
	53, // 89: gloo.solo.io.GraphqlOptions.SchemaChangeValidationOptions.reject_breaking_changes:type_name -> google.protobuf.BoolValue
	1,  // 90: gloo.solo.io.GraphqlOptions.SchemaChangeValidationOptions.processing_rules:type_name -> gloo.solo.io.GraphqlOptions.SchemaChangeValidationOptions.ProcessingRule
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Settings_VaultAwsIam); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Settings_VaultAwsEc2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Settings_VaultAwsEc2_Pkcs7Type); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Settings_VaultAwsEc2_IdentityType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Settings_VaultAwsEc2_Rsa2048Type); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*Settings_VaultAwsAuth_Iam)(nil),
		(*Settings_VaultAwsAuth_Ec2)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*Settings_VaultAwsEc2_Pkcs7)(nil),
		(*Settings_VaultAwsEc2_Identity)(nil),
		(*Settings_VaultAwsEc2_Rsa2048)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_msgTypes[36].OneofWrappers = []interface{}{

...
type GlooOptions struct {
	...
	// set to true if you wish to reset the envoy configuration to a clean slate with no routes.
	// set to false if you wish to keep envoy serving the routes from the latest valid configuration.
	// If not specified, defaults to `false`.
	ProxyGarbageCollection *types.BoolValue `protobuf:"bytes,9,opt,name=proxy_garbage_collection,json=proxyGarbageCollection,proto3" json:"proxy_garbage_collection,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}         `json:"-"`
	XXX_unrecognized       []byte           `json:"-"`
	XXX_sizecache          int32            `json:"-"`
}
...
func (m *GlooOptions) GetProxyGarbageCollection() *types.BoolValue {
	if m != nil {
		return m.ProxyGarbageCollection
	}
	return nil
}
...
var fileDescriptor_bd7533c2495e1752 = []byte{
	...
	,
}
...
func (this *GlooOptions) Equal(that interface{}) bool {
	...
	if !this.ProxyGarbageCollection.Equal(that1.ProxyGarbageCollection) {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false

...
type Settings_ConsulConfiguration struct {
	...
	// The name of the root CA resource to be used by discovered consul TLS upstreams.
	RootCaName string `protobuf:"bytes,19,opt,name=rootCaName,proto3" json:"rootCaName,omitempty"`
	...
	// with the noTlsTagName tag are sorted into the non-TLS upstream. ServiceInstances with both tags have no sorting
	// guarantee, while those with neither will be effectively lost. Requires noTlsTagName to be set if true.
	SplitTlsServices bool `protobuf:"varint,20,opt,name=splitTlsServices,proto3" json:"splitTlsServices,omitempty"`
	// The tag that gloo should use to identity serviceInstances that should not use TLS if SplitTlsServices is true.
	NoTlsTagName         string   `protobuf:"bytes,21,opt,name=noTlsTagName,proto3" json:"noTlsTagName,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Settings_ConsulConfiguration) GetUseTlsTagging() bool {
	if m != nil {
...
func (m *Settings_ConsulConfiguration) GetTlsTagName() string {
	if m != nil {
		return m.TlsTagName
	}
	return ""
...
func (m *Settings_ConsulConfiguration) GetRootCaNamespace() string {
	if m != nil {
		return m.RootCaNamespace
	}
	return ""
}

func (m *Settings_ConsulConfiguration) GetRootCaName() string {
	if m != nil {
		return m.RootCaName
	}
	return ""
...
func (m *Settings_ConsulConfiguration) GetSplitTlsServices() bool {
	if m != nil {
...
func (m *Settings_ConsulConfiguration) GetNoTlsTagName() string {
	if m != nil {
		return m.NoTlsTagName
	}
	return ""
}
...
var fileDescriptor_bd7533c2495e1752 = []byte{
	...
	,
}
...
func (this *Settings_ConsulConfiguration) Equal(that interface{}) bool {
	...
	if this.RootCaNamespace != that1.RootCaNamespace {
		return false
	}
	if this.RootCaName != that1.RootCaName {
		return false
	}
	if this.SplitTlsServices != that1.SplitTlsServices {
		return false
	}
	if this.NoTlsTagName != that1.NoTlsTagName {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false

...
type GatewayOptions_ValidationOptions struct {
	...
	ValidationServerGrpcMaxSize *wrappers.Int32Value `protobuf:"bytes,10,opt,name=validation_server_grpc_max_size,json=validationServerGrpcMaxSize,proto3" json:"validation_server_grpc_max_size,omitempty"`
}
...
func (x *GatewayOptions_ValidationOptions) GetValidationServerGrpcMaxSize() *wrappers.Int32Value {
	if x != nil {
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_rawDesc = []byte{
	...
	0x75, 0x66, 0x2e, 0x49, 0x6e, 0x74, 0x33, 0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x1b, 0x76,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_settings_proto_depIdxs = []int32{
	...
	39, // 56: gloo.solo.io.GatewayOptions.ValidationOptions.validation_server_grpc_max_size:type_name -> google.protobuf.Int32Value

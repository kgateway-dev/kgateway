...
type Upstream struct {
	...
	// Metadata inherited from the original service (e.g. Kubernetes labels)
	ServiceMetadata      map[string]string `protobuf:"bytes,19,rep,name=service_metadata,json=serviceMetadata,proto3" json:"service_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Upstream) GetServiceMetadata() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "gloo.solo.io.Upstream.ServiceMetadataEntry")
...
var fileDescriptor_b74df493149f644d = []byte{
	...
	,
}
...
func (this *Upstream) Equal(that interface{}) bool {
	...
	if len(this.ServiceMetadata) != len(that1.ServiceMetadata) {
		return false
	}
	for i := range this.ServiceMetadata {
		if this.ServiceMetadata[i] != that1.ServiceMetadata[i] {
			return false
		}
	}

...
type Upstream struct {
	...
	// If set, the observability deployment will try to create/move this uptream's dashboard to the specified folder
	// after verifying that a folder with such an ID exists.
	// Be aware that grafana requires a folder's ID, which
	// should not be confused with the similar and more easily accessible UID value.
	// Folder IDs can be retrieved with a pair of terminal commands:
	// 1. Port forward the grafana deployment to surface its API:
	// kubectl -n gloo-system port-forward deployment/glooe-grafana 3000
	// 2. Request all folder data (after admin:admin with the correct credentials):
	// curl http://admin:admin@localhost:3000/api/search
	DashboardFolderId *wrappers.UInt32Value `protobuf:"bytes,21,opt,name=dashboard_folder_id,json=dashboardFolderId,proto3" json:"dashboard_folder_id,omitempty"`
}
...
func (x *Upstream) GetDashboardFolderId() *wrappers.UInt32Value {
	if x != nil {
		return x.DashboardFolderId
	}
	return nil
}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_upstream_proto_rawDesc = []byte{
	...
	0x64, 0x6f, 0x77, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x4c, 0x0a, 0x13, 0x64, 0x61, 0x73, 0x68, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x5f, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x15,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x55, 0x49, 0x6e, 0x74, 0x33, 0x32, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x52, 0x11, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x46, 0x6f, 0x6c,
	0x64, 0x65, 0x72, 0x49, 0x64, 0x3a, 0x17, 0x82, 0xf1, 0x04, 0x04, 0x0a, 0x02, 0x75, 0x73, 0x82,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_upstream_proto_depIdxs = []int32{
	...
	20, // 20: gloo.solo.io.Upstream.dashboard_folder_id:type_name -> google.protobuf.UInt32Value

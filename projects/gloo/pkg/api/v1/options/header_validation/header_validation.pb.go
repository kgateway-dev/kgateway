...
type HeaderValidationSettings struct {
	...
	// values/allow all/custom allow-list).
	// we can use the (as of yet undocumented) Envoy universal header
	// validation options as inspirations for how we want to write this API

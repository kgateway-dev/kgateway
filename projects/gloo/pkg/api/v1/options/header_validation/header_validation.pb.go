...
type HeaderValidationSettings struct {
	...
	// Whether header methods should be validated. By default, Envoy will
	// validate that the HTTP method is valid on HTTP/1 connections. The default
	// allowed methods can be found here:

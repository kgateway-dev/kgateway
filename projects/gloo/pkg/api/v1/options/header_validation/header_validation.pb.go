...
type HeaderValidationSettings struct {
	...
	// Whether header methods should be validated. Envoy has a hard-coded list
	// of allowed HTTP methods that can be found here:
	...
	// Requests that use a method that is not present in this list will default
	// to being rejected with a HTTP 400 response.
	//
	// Types that are assignable to HeaderMethodValidation:
	//
	//	*HeaderValidationSettings_DisableMethodValidation
...
func (x *HeaderValidationSettings) GetDisableMethodValidation() *empty.Empty {
	if x, ok := x.GetHeaderMethodValidation().(*HeaderValidationSettings_DisableMethodValidation); ok {
		return x.DisableMethodValidation
	}
	return nil
}
...
type HeaderValidationSettings_DisableMethodValidation struct {
	// Disable method validation. Envoy will not perform any validation on
	// the method provided in the HTTP header.
	DisableMethodValidation *empty.Empty `protobuf:"bytes,1,opt,name=disable_method_validation,json=disableMethodValidation,proto3,oneof"`
}

func (*HeaderValidationSettings_DisableMethodValidation) isHeaderValidationSettings_HeaderMethodValidation() {
}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_header_validation_header_validation_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x01, 0x0a, 0x18, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e,
	0x67, 0x73, 0x12, 0x54, 0x0a, 0x19, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6d, 0x65,
	0x74, 0x68, 0x6f, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x17, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x1a, 0x0a, 0x18, 0x68, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x5f, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_header_validation_header_validation_proto_depIdxs = []int32{
	1, // 0: header_validation.options.gloo.solo.io.HeaderValidationSettings.disable_method_validation:type_name -> google.protobuf.Empty
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_header_validation_header_validation_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_header_validation_header_validation_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*HeaderValidationSettings_DisableMethodValidation)(nil),
	}
	type x struct{}

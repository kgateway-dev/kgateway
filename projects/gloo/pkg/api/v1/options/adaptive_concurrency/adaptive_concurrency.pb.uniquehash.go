...
func (m *AdaptiveRequestConcurrencyPolicySpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("adaptive_concurrency.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/adaptive_concurrency.AdaptiveRequestConcurrencyPolicySpec")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *AdaptiveRequestConcurrencyPolicySpec_MinRoundtripTimeCalculationParams) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("adaptive_concurrency.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/adaptive_concurrency.AdaptiveRequestConcurrencyPolicySpec_MinRoundtripTimeCalculationParams")); err != nil {
		return 0, err
	}

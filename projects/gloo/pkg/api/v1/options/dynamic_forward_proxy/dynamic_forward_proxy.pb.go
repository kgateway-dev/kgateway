...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x43, 0x61, 0x63, 0x68, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x69, 0x0a,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0xc3, 0x03, 0x0a, 0x0e, 0x44, 0x6e, 0x73,
	...
	0x10, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x51, 0x0a, 0x10, 0x64, 0x6e, 0x73, 0x5f,
	...
	0x6e, 0x73, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x8a,
	...
	0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0x5c, 0x5a, 0x4e, 0x67,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_goTypes = []interface{}{
	(*FilterConfig)(nil),            // 0: dfp.options.gloo.solo.io.FilterConfig
	(*DnsCacheCircuitBreakers)(nil), // 1: dfp.options.gloo.solo.io.DnsCacheCircuitBreakers
	(*DnsCacheConfig)(nil),          // 2: dfp.options.gloo.solo.io.DnsCacheConfig
	(*PerRouteConfig)(nil),          // 3: dfp.options.gloo.solo.io.PerRouteConfig
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_depIdxs = []int32{
	2, // 0: dfp.options.gloo.solo.io.FilterConfig.dns_cache_config:type_name -> dfp.options.gloo.solo.io.DnsCacheConfig
	4, // 1: dfp.options.gloo.solo.io.DnsCacheCircuitBreakers.max_pending_requests:type_name -> google.protobuf.UInt32Value
	5, // 2: dfp.options.gloo.solo.io.DnsCacheConfig.dns_refresh_rate:type_name -> google.protobuf.Duration
	5, // 3: dfp.options.gloo.solo.io.DnsCacheConfig.host_ttl:type_name -> google.protobuf.Duration
	4, // 4: dfp.options.gloo.solo.io.DnsCacheConfig.max_hosts:type_name -> google.protobuf.UInt32Value
	1, // 5: dfp.options.gloo.solo.io.DnsCacheConfig.dns_cache_circuit_breaker:type_name -> dfp.options.gloo.solo.io.DnsCacheCircuitBreakers
	5, // 6: dfp.options.gloo.solo.io.DnsCacheConfig.dns_query_timeout:type_name -> google.protobuf.Duration
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_msgTypes[3].OneofWrappers = []interface{}{

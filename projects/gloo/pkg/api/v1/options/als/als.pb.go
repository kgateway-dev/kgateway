// Mostly taken from
// https://github.com/envoyproxy/envoy/blob/317efa53c6add02fa9533fc8f93f10f590077dca/api/envoy/config/accesslog/v3/accesslog.proto
// because we are passing through the filter settings and therefore using the
...
type FileSink_JsonFormat struct {
	// the format object by which to envoy will emit the logs in a structured
	// way.

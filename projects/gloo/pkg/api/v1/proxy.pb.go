...
func (x *RouteAction) GetGraphqlSchemaRef() *core.ResourceRef {
	if x, ok := x.GetDestination().(*RouteAction_GraphqlSchemaRef); ok {
		return x.GraphqlSchemaRef
	}
	return nil
}
...
type RouteAction_GraphqlSchemaRef struct {
	// Enterprise-Only: THIS FEATURE IS IN TECH PREVIEW. APIs are versioned as alpha and subject to change.
	// A reference to a GraphQLSchema CR. Resolution of the client request to upstream(s) will be delegated to
	// the resolution policies defined in the GraphQLSchema CR. If configured, the graphql filter will operate
	// instead of the envoy router filter, so configuration (such as retries) that applies to the router filter
	// will not be applied.
	GraphqlSchemaRef *core.ResourceRef `protobuf:"bytes,5,opt,name=graphql_schema_ref,json=graphqlSchemaRef,proto3,oneof"`
}
...
func (*RouteAction_GraphqlSchemaRef) isRouteAction_Destination() {}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_rawDesc = []byte{
	...
	0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xc1, 0x02, 0x0a, 0x0b, 0x52, 0x6f, 0x75,
	...
	0x65, 0x72, 0x12, 0x49, 0x0a, 0x12, 0x67, 0x72, 0x61, 0x70, 0x68, 0x71, 0x6c, 0x5f, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19,
	...
	0x70, 0x68, 0x71, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x65, 0x66, 0x42, 0x0d, 0x0a,
	...
	0x64, 0x79, 0x42, 0x3a, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x67, 0x6c, 0x6f, 0x6f, 0x2f, 0x70, 0x72,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_depIdxs = []int32{
	...
	29, // 29: gloo.solo.io.RouteAction.graphql_schema_ref:type_name -> core.solo.io.ResourceRef
	29, // 30: gloo.solo.io.Destination.upstream:type_name -> core.solo.io.ResourceRef
	10, // 31: gloo.solo.io.Destination.kube:type_name -> gloo.solo.io.KubernetesServiceDestination
	11, // 32: gloo.solo.io.Destination.consul:type_name -> gloo.solo.io.ConsulServiceDestination
	31, // 33: gloo.solo.io.Destination.destination_spec:type_name -> gloo.solo.io.DestinationSpec
	32, // 34: gloo.solo.io.Destination.subset:type_name -> gloo.solo.io.Subset
	29, // 35: gloo.solo.io.KubernetesServiceDestination.ref:type_name -> core.solo.io.ResourceRef
	14, // 36: gloo.solo.io.UpstreamGroup.destinations:type_name -> gloo.solo.io.WeightedDestination
	18, // 37: gloo.solo.io.UpstreamGroup.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	19, // 38: gloo.solo.io.UpstreamGroup.metadata:type_name -> core.solo.io.Metadata
	...
	33, // 41: gloo.solo.io.WeightedDestination.options:type_name -> gloo.solo.io.WeightedDestinationOptions
	...
	29, // 45: gloo.solo.io.TcpHost.TcpAction.upstream_group:type_name -> core.solo.io.ResourceRef
	34, // 46: gloo.solo.io.TcpHost.TcpAction.forward_sni_cluster_name:type_name -> google.protobuf.Empty
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_msgTypes[7].OneofWrappers = []interface{}{
		...
		(*RouteAction_GraphqlSchemaRef)(nil),
	}

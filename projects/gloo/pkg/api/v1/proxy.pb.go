...
type Proxy struct {
	...
	//
	// Note to devs: we include the status in the proxy hash to avoid a race condition between the gateway writing
	// a new proxy in the proxy reconciler that is functionally equivalent (but with pending status) and gloo syncing
	// the proxy status of the same new snapshot.
...
var fileDescriptor_c6a47f72e9923590 = []byte{
	...
	,
}

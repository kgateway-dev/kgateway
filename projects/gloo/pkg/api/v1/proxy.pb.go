...
type Destination struct {
	...
	//	*Destination_Kube
	//	*Destination_Consul
	//	*Destination_DynamicForwardProxy
...
func (x *Destination) GetDynamicForwardProxy() *dynamic_forward_proxy.PerRouteConfig {
	if x, ok := x.GetDestinationType().(*Destination_DynamicForwardProxy); ok {
...
type Destination_DynamicForwardProxy struct {
	...
	DynamicForwardProxy *dynamic_forward_proxy.PerRouteConfig `protobuf:"bytes,13,opt,name=dynamic_forward_proxy,json=dynamicForwardProxy,proto3,oneof"`
}
...
func (*Destination_DynamicForwardProxy) isDestination_DestinationType() {}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_rawDesc = []byte{
	...
	0x73, 0x4a, 0x04, 0x08, 0x06, 0x10, 0x07, 0x22, 0x8c, 0x05, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74,
	...
	0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb6, 0x03, 0x0a, 0x0b, 0x44,
	...
	0x63, 0x65, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52,
	0x06, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x12, 0x5e, 0x0a, 0x15, 0x64, 0x79, 0x6e, 0x61, 0x6d,
	0x69, 0x63, 0x5f, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x78, 0x79,
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x64, 0x66, 0x70, 0x2e, 0x6f, 0x70, 0x74,
	...
	0x72, 0x64, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x12, 0x48, 0x0a, 0x10, 0x64, 0x65, 0x73, 0x74, 0x69,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_goTypes = []interface{}{
	...
	(*dynamic_forward_proxy.PerRouteConfig)(nil), // 35: dfp.options.gloo.solo.io.PerRouteConfig
	(*DestinationSpec)(nil),                      // 36: gloo.solo.io.DestinationSpec
	(*Subset)(nil),                               // 37: gloo.solo.io.Subset
	(*WeightedDestinationOptions)(nil),           // 38: gloo.solo.io.WeightedDestinationOptions
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_depIdxs = []int32{
	...
	35, // 40: gloo.solo.io.Destination.dynamic_forward_proxy:type_name -> dfp.options.gloo.solo.io.PerRouteConfig
	36, // 41: gloo.solo.io.Destination.destination_spec:type_name -> gloo.solo.io.DestinationSpec
	37, // 42: gloo.solo.io.Destination.subset:type_name -> gloo.solo.io.Subset
	33, // 43: gloo.solo.io.KubernetesServiceDestination.ref:type_name -> core.solo.io.ResourceRef
	17, // 44: gloo.solo.io.UpstreamGroup.destinations:type_name -> gloo.solo.io.WeightedDestination
	21, // 45: gloo.solo.io.UpstreamGroup.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	22, // 46: gloo.solo.io.UpstreamGroup.metadata:type_name -> core.solo.io.Metadata
	17, // 47: gloo.solo.io.MultiDestination.destinations:type_name -> gloo.solo.io.WeightedDestination
	12, // 48: gloo.solo.io.WeightedDestination.destination:type_name -> gloo.solo.io.Destination
	38, // 49: gloo.solo.io.WeightedDestination.options:type_name -> gloo.solo.io.WeightedDestinationOptions
	0,  // 50: gloo.solo.io.RedirectAction.response_code:type_name -> gloo.solo.io.RedirectAction.RedirectResponseCode
	12, // 51: gloo.solo.io.TcpHost.TcpAction.single:type_name -> gloo.solo.io.Destination
	16, // 52: gloo.solo.io.TcpHost.TcpAction.multi:type_name -> gloo.solo.io.MultiDestination
	33, // 53: gloo.solo.io.TcpHost.TcpAction.upstream_group:type_name -> core.solo.io.ResourceRef
	39, // 54: gloo.solo.io.TcpHost.TcpAction.forward_sni_cluster_name:type_name -> google.protobuf.Empty
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_msgTypes[11].OneofWrappers = []interface{}{
		...
		(*Destination_DynamicForwardProxy)(nil),
	}

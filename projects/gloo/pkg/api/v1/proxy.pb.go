...
type TcpHost struct {
	...
	Name        string                  `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Destination *TcpHost_TcpRouteAction `protobuf:"bytes,3,opt,name=destination,proto3" json:"destination,omitempty"`
	// If provided, the Gateway will serve TLS/SSL traffic for this set of routes
	SslConfig            *SslConfig `protobuf:"bytes,4,opt,name=ssl_config,json=sslConfig,proto3" json:"ssl_config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *TcpHost) GetDestination() *TcpHost_TcpRouteAction {
	if m != nil {
...
type TcpHost_TcpRouteAction struct {
	// Types that are valid to be assigned to Destination:
	//	*TcpHost_TcpRouteAction_Single
	//	*TcpHost_TcpRouteAction_Multi
	//	*TcpHost_TcpRouteAction_UpstreamGroup
	//	*TcpHost_TcpRouteAction_ForwardSniClusterName
	Destination          isTcpHost_TcpRouteAction_Destination `protobuf_oneof:"destination"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}

func (m *TcpHost_TcpRouteAction) Reset()         { *m = TcpHost_TcpRouteAction{} }
func (m *TcpHost_TcpRouteAction) String() string { return proto.CompactTextString(m) }
func (*TcpHost_TcpRouteAction) ProtoMessage()    {}
func (*TcpHost_TcpRouteAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6a47f72e9923590, []int{3, 0}
}
func (m *TcpHost_TcpRouteAction) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TcpHost_TcpRouteAction.Unmarshal(m, b)
}
func (m *TcpHost_TcpRouteAction) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TcpHost_TcpRouteAction.Marshal(b, m, deterministic)
}
func (m *TcpHost_TcpRouteAction) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TcpHost_TcpRouteAction.Merge(m, src)
}
func (m *TcpHost_TcpRouteAction) XXX_Size() int {
	return xxx_messageInfo_TcpHost_TcpRouteAction.Size(m)
}
func (m *TcpHost_TcpRouteAction) XXX_DiscardUnknown() {
	xxx_messageInfo_TcpHost_TcpRouteAction.DiscardUnknown(m)
}

var xxx_messageInfo_TcpHost_TcpRouteAction proto.InternalMessageInfo

type isTcpHost_TcpRouteAction_Destination interface {
	isTcpHost_TcpRouteAction_Destination()
	Equal(interface{}) bool
}

type TcpHost_TcpRouteAction_Single struct {
	Single *Destination `protobuf:"bytes,1,opt,name=single,proto3,oneof" json:"single,omitempty"`
}
type TcpHost_TcpRouteAction_Multi struct {
	Multi *MultiDestination `protobuf:"bytes,2,opt,name=multi,proto3,oneof" json:"multi,omitempty"`
}
type TcpHost_TcpRouteAction_UpstreamGroup struct {
...
type TcpHost_TcpRouteAction_ForwardSniClusterName struct {
	ForwardSniClusterName *types.BoolValue `protobuf:"bytes,4,opt,name=forward_sni_cluster_name,json=forwardSniClusterName,proto3,oneof" json:"forward_sni_cluster_name,omitempty"`
}

func (*TcpHost_TcpRouteAction_Single) isTcpHost_TcpRouteAction_Destination()                {}
func (*TcpHost_TcpRouteAction_Multi) isTcpHost_TcpRouteAction_Destination()                 {}
func (*TcpHost_TcpRouteAction_UpstreamGroup) isTcpHost_TcpRouteAction_Destination()         {}
func (*TcpHost_TcpRouteAction_ForwardSniClusterName) isTcpHost_TcpRouteAction_Destination() {}

func (m *TcpHost_TcpRouteAction) GetDestination() isTcpHost_TcpRouteAction_Destination {
	if m != nil {
		return m.Destination
	}
	return nil
...
func (m *TcpHost_TcpRouteAction) GetSingle() *Destination {
	if x, ok := m.GetDestination().(*TcpHost_TcpRouteAction_Single); ok {
		return x.Single
	}
	return nil
}

func (m *TcpHost_TcpRouteAction) GetMulti() *MultiDestination {
	if x, ok := m.GetDestination().(*TcpHost_TcpRouteAction_Multi); ok {
		return x.Multi
	}
	return nil
}

func (m *TcpHost_TcpRouteAction) GetUpstreamGroup() *core.ResourceRef {
	if x, ok := m.GetDestination().(*TcpHost_TcpRouteAction_UpstreamGroup); ok {
		return x.UpstreamGroup
	}
	return nil
}

func (m *TcpHost_TcpRouteAction) GetForwardSniClusterName() *types.BoolValue {
	if x, ok := m.GetDestination().(*TcpHost_TcpRouteAction_ForwardSniClusterName); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*TcpHost_TcpRouteAction) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TcpHost_TcpRouteAction_Single)(nil),
		(*TcpHost_TcpRouteAction_Multi)(nil),
		(*TcpHost_TcpRouteAction_UpstreamGroup)(nil),
		(*TcpHost_TcpRouteAction_ForwardSniClusterName)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*TcpHost_TcpRouteAction)(nil), "gloo.solo.io.TcpHost.TcpRouteAction")
...
var fileDescriptor_c6a47f72e9923590 = []byte{
	...
	,
}
...
func (this *TcpHost_TcpRouteAction) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TcpHost_TcpRouteAction)
	if !ok {
		that2, ok := that.(TcpHost_TcpRouteAction)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TcpHost_TcpRouteAction_Single) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TcpHost_TcpRouteAction_Single)
	if !ok {
		that2, ok := that.(TcpHost_TcpRouteAction_Single)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TcpHost_TcpRouteAction_Multi) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TcpHost_TcpRouteAction_Multi)
	if !ok {
		that2, ok := that.(TcpHost_TcpRouteAction_Multi)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TcpHost_TcpRouteAction_UpstreamGroup) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TcpHost_TcpRouteAction_UpstreamGroup)
	if !ok {
		that2, ok := that.(TcpHost_TcpRouteAction_UpstreamGroup)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TcpHost_TcpRouteAction_ForwardSniClusterName) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TcpHost_TcpRouteAction_ForwardSniClusterName)
	if !ok {
		that2, ok := that.(TcpHost_TcpRouteAction_ForwardSniClusterName)
		if ok {
			that1 = &that2
		} else {
			return false

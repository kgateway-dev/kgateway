...
func (r *Proxy) SetNamespacedStatuses(statuses *core.NamespacedStatuses) {
...
func (r *Proxy) SetStatusForNamespace(status *core.Status) error {
...
// Note: POD_NAMESPACE environment variable must be set for this function to behave as expected.
// If unset, a podNamespaceErr is returned.
func (r *Proxy) GetStatusForNamespace() (*core.Status, error) {
	podNamespace := os.Getenv(envutils.PodNamespaceEnvName)
	if podNamespace == "" {

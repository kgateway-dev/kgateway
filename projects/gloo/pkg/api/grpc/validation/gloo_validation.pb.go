...
var file_github_com_solo_io_gloo_projects_gloo_api_grpc_validation_gloo_validation_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7f, 0x0a, 0x1c, 0x47, 0x6c, 0x6f, 0x6f,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x22, 0x99, 0x01, 0x0a, 0x10, 0x56, 0x61,
	...
	0x70, 0x6f, 0x72, 0x74, 0x73, 0x22, 0x82, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
...
var file_github_com_solo_io_gloo_projects_gloo_api_grpc_validation_gloo_validation_proto_depIdxs = []int32{
	...
	29, // 5: gloo.solo.io.ResourceReport.resource_ref:type_name -> core.solo.io.ResourceRef
	14, // 6: gloo.solo.io.ProxyReport.listener_reports:type_name -> gloo.solo.io.ListenerReport
	20, // 7: gloo.solo.io.ListenerReport.errors:type_name -> gloo.solo.io.ListenerReport.Error
	15, // 8: gloo.solo.io.ListenerReport.http_listener_report:type_name -> gloo.solo.io.HttpListenerReport
	18, // 9: gloo.solo.io.ListenerReport.tcp_listener_report:type_name -> gloo.solo.io.TcpListenerReport
	21, // 10: gloo.solo.io.HttpListenerReport.errors:type_name -> gloo.solo.io.HttpListenerReport.Error
	16, // 11: gloo.solo.io.HttpListenerReport.virtual_host_reports:type_name -> gloo.solo.io.VirtualHostReport
	22, // 12: gloo.solo.io.VirtualHostReport.errors:type_name -> gloo.solo.io.VirtualHostReport.Error
	17, // 13: gloo.solo.io.VirtualHostReport.route_reports:type_name -> gloo.solo.io.RouteReport
	23, // 14: gloo.solo.io.RouteReport.errors:type_name -> gloo.solo.io.RouteReport.Error
	24, // 15: gloo.solo.io.RouteReport.warnings:type_name -> gloo.solo.io.RouteReport.Warning
	25, // 16: gloo.solo.io.TcpListenerReport.errors:type_name -> gloo.solo.io.TcpListenerReport.Error
	19, // 17: gloo.solo.io.TcpListenerReport.tcp_host_reports:type_name -> gloo.solo.io.TcpHostReport
	26, // 18: gloo.solo.io.TcpHostReport.errors:type_name -> gloo.solo.io.TcpHostReport.Error
	...
	11, // 26: gloo.solo.io.GlooValidationService.NotifyOnResync:input_type -> gloo.solo.io.NotifyOnResyncRequest
	7,  // 27: gloo.solo.io.GlooValidationService.Validate:input_type -> gloo.solo.io.GlooValidationServiceRequest
	12, // 28: gloo.solo.io.GlooValidationService.NotifyOnResync:output_type -> gloo.solo.io.NotifyOnResyncResponse

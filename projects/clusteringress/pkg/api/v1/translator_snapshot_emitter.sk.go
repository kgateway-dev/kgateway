...
var (
	mTranslatorSnapshotIn  = stats.Int64("translator.clusteringress.solo.io/snap_emitter/snap_in", "The number of snapshots in", "1")
	mTranslatorSnapshotOut = stats.Int64("translator.clusteringress.solo.io/snap_emitter/snap_out", "The number of snapshots out", "1")

	translatorsnapshotInView = &view.View{
		Name:        "translator.clusteringress.solo.io_snap_emitter/snap_in",
	...
	translatorsnapshotOutView = &view.View{
		Name:        "translator.clusteringress.solo.io/snap_emitter/snap_out",

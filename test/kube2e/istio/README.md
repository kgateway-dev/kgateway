...
<<<<<<< HEAD:test/kube2e/istio/README.md
...
>>>>>>> d38bd51de (introduce test coverage reporting, update devel with Gloo Gateway references (#9646)):devel/architecture/istio-integration.md

...
func (c *TestContext) PatchDefaultVirtualService(mutator func(vs *v1.VirtualService)) {
	err := helpers.PatchResourceWithOffset(
		...
		func(resource resources.Resource) {
			mutator(resource.(*v1.VirtualService))
		},
...
func (c *TestContext) PatchDefaultGateway(mutator func(gw *v1.Gateway)) {
	err := helpers.PatchResourceWithOffset(
		1,
		c.ctx,
		&core.ResourceRef{
...
func (c *TestContext) PatchDefaultUpstream(mutator func(us *gloov1.Upstream)) {
	...
	err := helpers.PatchResourceWithOffset(
		...
		usRef,
		func(resource resources.Resource) {
			mutator(resource.(*gloov1.Upstream))
		},

...
```bash
# Run all container structure tests against existing images
make container-structure-test

# Run tests for a specific image (images must already exist, e.g. from goreleaser)

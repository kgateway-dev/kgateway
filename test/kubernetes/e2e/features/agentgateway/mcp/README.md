...
- User container uses `ghcr.io/peterj/mcp-website-fetcher:main` as a source and copied closer to the CI in GH `ghcr.io/kgateway-dev/mcp-website-fetcher:0.0.1`

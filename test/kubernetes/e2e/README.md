...
- **Cluster provisioning**: We rely on the [setup-kind](/hack/hack/setup-kind.sh) script to provision a cluster. We should make this more flexible by providing a configurable, declarative way to do this.

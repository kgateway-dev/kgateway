...
A [ClusterAction](./action.go) is a function that will be executed against the cluster, to mutate it's state.
...
- The `ClusterAction` that you add should live in the package associated with that tool

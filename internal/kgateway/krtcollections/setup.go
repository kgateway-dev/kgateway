...
func InitCollections(
	...
	routes := NewRoutesIndex(krtopts, httpRoutes, grpcRoutes, tcproutes, tlsRoutes, kubeRawGateways, kubeRawListenerSets, policies, backendIndex, refgrants, globalSettings)

...
// the accompanying PerClientClusterOverlay. KRT retains equal base rows, so
...
// are safe but cause unnecessary client recomputation. Overlays without this
// declaration fall back to tracking the whole backing object.

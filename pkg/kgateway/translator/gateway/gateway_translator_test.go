...
func TestBasic(t *testing.T) {
	...
	t.Run("TrafficPolicy retry with host selection attempts", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFile:  "traffic-policy/timeout-retry-host-selection.yaml",
			outputFile: "traffic-policy/timeout-retry-host-selection.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},

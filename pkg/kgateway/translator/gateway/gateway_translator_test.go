...
func TestBasic(t *testing.T) {
	...
	t.Run("JWT Policy with claimsToHeaders overwrite strips inbound headers before authn", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"jwt/claims-to-headers-overwrite.yaml"},
			outputFile: "jwt/claims-to-headers-overwrite.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},

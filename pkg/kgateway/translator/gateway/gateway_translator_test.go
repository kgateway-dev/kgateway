...
func TestBasic(t *testing.T) {
	...
	t.Run("TrafficPolicy RateLimit Quota with cross-namespace GatewayExtension", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/rate-limit-quota-cross-namespace.yaml"},
			outputFile: "traffic-policy/rate-limit-quota-cross-namespace.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},

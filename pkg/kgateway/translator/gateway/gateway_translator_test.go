...
func TestBasic(t *testing.T) {
	...
	t.Run("TrafficPolicy retry with rate limited back-off", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/rate-limited-retry-backoff.yaml"},
			outputFile: "traffic-policy/rate-limited-retry-backoff.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},

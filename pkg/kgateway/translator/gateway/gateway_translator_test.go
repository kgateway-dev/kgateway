...
func TestBasic(t *testing.T) {
	...
	t.Run("TrafficPolicy with local rate limiting descriptors", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/local-rate-limit-with-descriptors.yaml"},
			outputFile: "traffic-policy/local-rate-limit-with-descriptors.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},

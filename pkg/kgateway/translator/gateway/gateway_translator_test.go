...
func TestBasic(t *testing.T) {
	...
	t.Run("ListenerPolicy with opentelemetry http service", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"listener-policy-http/opentelemetry-http.yaml"},
			outputFile: "listener-policy-http/opentelemetry-http.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},

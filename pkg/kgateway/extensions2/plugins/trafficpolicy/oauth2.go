...
func buildOAuth2ProviderConfig(
	...
	hmacSecret, err := pluginutils.GetSecretIr(secrets, krtctx, wellknown.OAuth2HMACSecret.Name, wellknown.OAuth2HMACSecret.Namespace, wellknown.GatewayExtensionGVK.GroupKind())
	if err != nil {
		return nil, err
	}

...
func NewAgwCollections(
	...
	agwCollections := &AgwCollections{
		...
		// inference extensions are implicitly enabled
		InferencePools: krt.WrapClient(kclient.NewDelayedInformer[*inf.InferencePool](commoncol.Client, wellknown.InferencePoolGVK.GroupVersion().WithResource("inferencepools"), kubetypes.StandardInformer, kclient.Filter{ObjectFilter: commoncol.Client.ObjectFilter()}), commoncol.KrtOpts.ToOptions("informer/InferencePools")...),

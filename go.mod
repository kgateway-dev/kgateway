...
replace k8s.io/api v0.0.0-20190830074751-c43c3e1d5a79 => k8s.io/api v0.0.0-20190111032252-67edc246be36

replace k8s.io/client-go v10.0.0+incompatible => k8s.io/client-go v0.0.0-20190111032708-6bf63545bd02

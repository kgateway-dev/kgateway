...
.PHONY: setup
setup: setup-base kind-build-and-load package-kgateway-charts package-agentgateway-charts dummy-auth0-docker kind-load-dummy-auth0 ## Setup the complete infrastructure (base setup plus images and charts)

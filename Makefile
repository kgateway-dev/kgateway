...
generate-client-mocks: ## Use gomock (https://github.com/golang/mock) to generate mocks for our resource clients.
...
publish-security-scan: ## Publish results generated by run-security-scan

...
1. Create or use an existing cluster that runs Kubernetes a version supported by both [your version of Gloo Gateway]({{< versioned_link_path fromRoot="/reference/support" >}}) and the [version of Istio you intend to install](https://istio.io/latest/docs/releases/supported-releases/). 

...
This guide was tested with Gloo v1.5.0-beta21.

{{% notice warning %}}

The Gloo integration with Istio 1.6.x requires Gloo version 1.4.10, or 1.5.0-beta21 or higher.
...
or with helm:
```
kubectl create ns gloo-system; helm install --namespace gloo-system --version 1.5.0-beta21 gloo gloo/gloo
```
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        image: quay.io/solo-io/gloo-envoy-wrapper:1.5.0-beta21
        ...
        - mountPath: /etc/envoy
          name: envoy-config
      - name: cert-rotator
        image: quay.io/solo-io/sds:1.5.0-beta21
        imagePullPolicy: IfNotPresent
        ports:
        - containerPort: 8234
          name: sds

...
The source code for the Http service can be found in the Gloo Gateway repository [here](https://github.com/solo-io/gloo/tree/master/docs/examples/http-passthrough-auth).

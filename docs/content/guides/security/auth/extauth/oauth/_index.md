...
{{% notice note %}}
Support for PKCE-secured OAuth flows with Okta OIDC providers is planned to be added in Gloo Edge Enterprise version 1.15.0. 
{{% /notice %}}

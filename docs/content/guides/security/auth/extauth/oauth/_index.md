...
trigger a deletion of the user session and revokes the refresh token. This returns with an empty 200 OK response.
...
When this url is accessed, the user session, cookie, and refresh token will be deleted.

...
Now we are ready to test our configuration. Let's port-forward the Gloo Edge Gateway Proxy service so that it is reachable from you machine at `localhost:8080`:

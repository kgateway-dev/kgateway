...
If you want to automatically rotate certs based on a schedule, you can enable a cert rotation CronJob. In your Helm values file for Gloo Gateway installation, set `gateway.certGenJob.cron.enabled` to `true`, and specify a rotation schedule:

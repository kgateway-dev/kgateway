...
If upgrading from version 1.9.0+ to a newer version, the recommended upgrade path is a canary upgrade, which is
described further [here]({{< versioned_link_path fromRoot="/operations/upgrading/canary" >}}).

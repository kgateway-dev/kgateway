...
weight: 45
description: Upgrading to Gloo Gateway 1.10.x and Gloo Gateway Enterprise 1.10.x
---

Follow these steps to upgrade your Gloo Gateway or Gloo Gateway Enterprise deployments to version 1.10 from previous verisions. 
...
Gloo Gateway v1.10.0 introduces {{< protobuf name="graphql.gloo.solo.io.GraphQLSchema" display="The GraphQLSchema CRD">}}.
Gloo Gateway v1.10.8 introduces {{< protobuf name="gateway.solo.io.MatchableHttpGateway" display="The MatchableHttpGateway CRD">}}.
...
- Prior to Gloo Gateway Enterprise version v1.10, `license_secret_name` could be specified at the top level of your helm

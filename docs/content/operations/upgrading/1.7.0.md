...
Gloo Edge's default helm configurations for v1.6 and v1.7 will smoothly transistion from v2 to v3. However, if you're 
using a heavily customized configuration, you may need to remove v2 references yourself by removing the 
following value wherever it is has been added.

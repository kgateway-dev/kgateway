...
| `resources` | [[]google.protobuf.Any]({{< versioned_link_path fromRoot="/reference/api/github.com/solo-io/solo-kit/api/external/google/protobuf/any.proto.sk/#any" >}}) | The response resources. These resources are typed and depend on the API being called. |  |

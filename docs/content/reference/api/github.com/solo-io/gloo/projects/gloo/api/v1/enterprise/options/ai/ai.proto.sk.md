...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `headerName` | `string` | Name of the header the token is in. If not set Authorization will be used. |

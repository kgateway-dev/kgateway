...
### Package: `solo.io.envoy.config.filter.http.aws_lambda.v2` 
#### Types:
...
"serviceAccountCredentials": .solo.io.envoy.config.filter.http.aws_lambda.v2.AWSLambdaConfig.ServiceAccountCredentials

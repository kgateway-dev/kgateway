...
| `options` | [.gloo.solo.io.ListenerOptions](../../options.proto.sk/#listeneroptions) | top level optional configuration for all routes on the gateway. |
...
| `routeOptions` | [.gloo.solo.io.RouteConfigurationOptions](../../options.proto.sk/#routeconfigurationoptions) | Route configuration options that live under Envoy's [RouteConfigurationOptions](https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/route/v3/route.proto#config-route-v3-routeconfiguration). |
...
| `options` | [.gloo.solo.io.HttpListenerOptions](../../options.proto.sk/#httplisteneroptions) | HTTP Gateway configuration. |

...
| `roleArn` | `string` | (Optional): role_arn to use when assuming a role for a given request via STS. This option will only be respected if STS credentials are enabled. |  |

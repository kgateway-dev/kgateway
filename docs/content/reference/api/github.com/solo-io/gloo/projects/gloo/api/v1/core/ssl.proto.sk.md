...
##### Source File: [github.com/solo-io/gloo/projects/gloo/api/v1/core/ssl.proto](https://github.com/solo-io/gloo/blob/master/projects/gloo/api/v1/core/ssl.proto)
...
"sslFiles": .core.gloo.solo.io.SSLFiles
"sds": .core.gloo.solo.io.SDSConfig
"sniDomains": []string
"verifySubjectAltName": []string
"parameters": .core.gloo.solo.io.SslParameters
...
| `sslFiles` | [.core.gloo.solo.io.SSLFiles](../ssl.proto.sk/#sslfiles) | SSLFiles reference paths to certificates which are local to the proxy. Only one of `sslFiles`, or `sds` can be set. |  |
| `sds` | [.core.gloo.solo.io.SDSConfig](../ssl.proto.sk/#sdsconfig) | Use secret discovery service. Only one of `sds`, or `sslFiles` can be set. |  |
...
| `parameters` | [.core.gloo.solo.io.SslParameters](../ssl.proto.sk/#sslparameters) |  |  |
...
```yaml
"targetUri": string
"callCredentials": .core.gloo.solo.io.CallCredentials
...
| `callCredentials` | [.core.gloo.solo.io.CallCredentials](../ssl.proto.sk/#callcredentials) | Call credentials. |  |
...
```yaml
"fileCredentialSource": .core.gloo.solo.io.CallCredentials.FileCredentialSource

```

| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `fileCredentialSource` | [.core.gloo.solo.io.CallCredentials.FileCredentialSource](../ssl.proto.sk/#filecredentialsource) | Call credentials are coming from a file,. |  |
...
```yaml
"minimumProtocolVersion": .core.gloo.solo.io.SslParameters.ProtocolVersion
"maximumProtocolVersion": .core.gloo.solo.io.SslParameters.ProtocolVersion
"cipherSuites": []string
"ecdhCurves": []string
...
| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `minimumProtocolVersion` | [.core.gloo.solo.io.SslParameters.ProtocolVersion](../ssl.proto.sk/#protocolversion) |  |  |
| `maximumProtocolVersion` | [.core.gloo.solo.io.SslParameters.ProtocolVersion](../ssl.proto.sk/#protocolversion) |  |  |
| `cipherSuites` | `[]string` |  |  |
| `ecdhCurves` | `[]string` |  |  |

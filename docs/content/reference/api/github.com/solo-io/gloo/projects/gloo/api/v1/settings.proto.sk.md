...
"fallbackFirstToFunction": .google.protobuf.BoolValue
...
| `fallbackFirstToFunction` | [.google.protobuf.BoolValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/bool-value) | Sets the unsafe behavior where a route can specify a lambda upstream but not set the function to target. If will use the first function. Defaults to false. |

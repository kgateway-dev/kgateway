...
| `cachingServer` | [.caching.options.gloo.solo.io.Settings](../enterprise/options/caching/caching.proto.sk/#settings) | Enterprise-only: Settings for the caching server itself Can be configured per listener and is used to configure the envoy filter. |

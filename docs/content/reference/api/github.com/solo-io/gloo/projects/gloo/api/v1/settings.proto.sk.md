...
| `watchLabels` | `map<string, string>` | Map of Kubernetes labels to watch. Only services which match all of the selectors specified here will be discovered by UDS. |

...
| `queryParams` | `map<string, string>` | map of query name extraction type: e.g. 'query': '{$metadata.namespace.name}' translate this into: https://github.com/solo-io/envoy-gloo-ee/blob/master/api/envoy/config/filter/http/graphql/v2/graphql.proto#L506-L508. |
| `spanName` | `string` |  |

...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `httpUri` | [.solo.io.envoy.config.core.v3.HttpUri](../../../../../../../../../../../../solo-kit/api/external/envoy/config/core/v3/http_uri.proto.sk/#httpuri) | The HTTP URI to fetch the JWKS. For example: .. code-block:: yaml http_uri: uri: https://www.googleapis.com/oauth2/v1/certs cluster: jwt.www.googleapis.com|443 timeout: 1s. |

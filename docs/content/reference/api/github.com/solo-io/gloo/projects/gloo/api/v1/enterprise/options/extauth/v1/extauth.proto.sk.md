...
| `disableGroupChecking` | `bool` | Disables group checking regardless of what exists in allowedGroups Disables validation of the membership attribute of the user entry Group checking is enabled by default. |

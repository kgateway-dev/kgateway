...
| `disableGroupChecking` | `bool` | Sometimes, it's enough to check for the user credentials so this flag disables group checking group checking is enabled by default. |

...
"preExpiryRefreshOffset": .google.protobuf.Duration
...
| `preExpiryRefreshOffset` | [.google.protobuf.Duration](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/duration) | Specifies an offset in which an id-token will be refreshed prior to its actual expiration. Defaults to 2 seconds. A duration of 0 will wait to refresh a token until it has expired. |

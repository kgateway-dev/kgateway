...
| `ratelimitStaged` | [.ratelimit.options.gloo.solo.io.RateLimitStagedVhostExtension](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitstagedvhostextension) | TODO (sam-heilbron). Only one of `ratelimitStaged`, `ratelimit`, `rateLimitConfigs`, or `rateLimitStagedConfigs` can be set. |
...
| `rateLimitStagedConfigs` | [.ratelimit.options.gloo.solo.io.RateLimitStagedConfigRefs](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitstagedconfigrefs) |  Only one of `rateLimitStagedConfigs`, `ratelimit`, `ratelimitStaged`, or `rateLimitConfigs` can be set. |
| `waf` | [.waf.options.gloo.solo.io.Settings](../enterprise/options/waf/waf.proto.sk/#settings) | Enterprise-only: Config for Web Application Firewall (WAF), supporting the popular ModSecurity 3.0 ruleset. |

...
| `extProc` | [.extproc.options.gloo.solo.io.Settings](../enterprise/options/extproc/extproc.proto.sk/#settings) | Enterprise-only: External Processing filter settings. The HttpListenerOptions settings can override the defaults from the global settings, or be overridden by the settings on VirtualHostOptions (via shallow merge). |
...
| `extProc` | [.extproc.options.gloo.solo.io.Settings](../enterprise/options/extproc/extproc.proto.sk/#settings) | Enterprise-only: External Processing filter settings. The VirtualHostOptions settings can override both the global settings and HttpListenerOptions settings (via shallow merge). RouteOptions settings can override certain VirtualHostOptions settings. |
...
| `extProc` | [.extproc.options.gloo.solo.io.RouteSettings](../enterprise/options/extproc/extproc.proto.sk/#routesettings) | Enterprise-only: Per-route External Processing filter settings. This can be used to override certain external processor settings on the virtual host or listener. |

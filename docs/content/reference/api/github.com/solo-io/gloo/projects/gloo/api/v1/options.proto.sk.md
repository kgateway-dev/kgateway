...
"graphql": .solo.io.envoy.config.filter.http.graphql.v2.GraphQLRouteConfig
...
| `graphql` | [.solo.io.envoy.config.filter.http.graphql.v2.GraphQLRouteConfig](../../external/envoy/extensions/filters/http/graphql/v2/graphql.proto.sk/#graphqlrouteconfig) | Enterprise-Only. If configured, requests will be handled by graphql rather than router filter. |

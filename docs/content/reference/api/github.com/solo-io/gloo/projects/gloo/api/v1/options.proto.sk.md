...
"graphql": .envoy.config.filter.http.graphql.v2.GraphQLRouteConfig
...
| `graphql` | [.envoy.config.filter.http.graphql.v2.GraphQLRouteConfig](../../external/envoy/extensions/graphql/graphql.proto.sk/#graphqlrouteconfig) | Enterprise-Only. If configured, requests will be handled by graphql rather than router filter. |

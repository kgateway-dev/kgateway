...
| `cors` | [.cors.options.gloo.solo.io.CorsPolicy](../options/cors/cors.proto.sk/#corspolicy) | Defines a CORS policy for the route If a CORS policy is also defined on the route's virtual host any fields set here override the virtual host configuration unless an alternate behavior is defined on the virtual host via CorsMergeSettings. |

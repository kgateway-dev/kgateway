...
| `headerValidationSettings` | [.header_validation.options.gloo.solo.io.HeaderValidationSettings](../options/header_validation/header_validation.proto.sk/#headervalidationsettings) | Header Validation Settings. These can be used to configure Gloo with rules to customize whether requests should be accepted or rejected, based on the contents of the HTTP header. TODO: include some kind of warning that the behavior of these fields may change when we update Envoy to a new version. |

...
"ratelimitStaged": .ratelimit.options.gloo.solo.io.RateLimitStagedVhostExtension
"rateLimitConfigs": .ratelimit.options.gloo.solo.io.RateLimitConfigRefs
"rateLimitStagedConfigs": .ratelimit.options.gloo.solo.io.RateLimitStagedConfigRefs
"waf": .waf.options.gloo.solo.io.Settings
...
| `ratelimit` | [.ratelimit.options.gloo.solo.io.RateLimitVhostExtension](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitvhostextension) | Enterprise-only: Partial config for GlooE rate-limiting based on Envoy's rate-limit service; supports Envoy's rate-limit service API. (reference here: https://github.com/lyft/ratelimit#configuration) Configure rate-limit *actions* here, which define how request characteristics get translated into descriptors used by the rate-limit service for rate-limiting. Configure rate-limit *descriptors* and their associated limits on the Gloo settings. Only one of `ratelimit`, `ratelimit_staged`, `rate_limit_configs` or `rate_limit_staged_configs` can be set. Only one of `ratelimit`, `ratelimitStaged`, `rateLimitConfigs`, or `rateLimitStagedConfigs` can be set. |
| `ratelimitStaged` | [.ratelimit.options.gloo.solo.io.RateLimitStagedVhostExtension](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitstagedvhostextension) | Enterprise-only: Partial config for GlooE rate-limiting based on Envoy's rate-limit service; supports Envoy's rate-limit service API. (reference here: https://github.com/lyft/ratelimit#configuration) Configure rate-limit *actions* here, which define how request characteristics get translated into descriptors used by the rate-limit service for rate-limiting. Configure rate-limit *descriptors* and their associated limits on the Gloo settings. Only one of `ratelimit`, `ratelimit_staged`, `rate_limit_configs` or `rate_limit_staged_configs` can be set. Only one of `ratelimitStaged`, `ratelimit`, `rateLimitConfigs`, or `rateLimitStagedConfigs` can be set. |
| `rateLimitConfigs` | [.ratelimit.options.gloo.solo.io.RateLimitConfigRefs](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitconfigrefs) | References to RateLimitConfig resources. This is used to configure the GlooE rate limit server. Only one of `ratelimit`, `ratelimit_staged`, `rate_limit_configs` or `rate_limit_staged_configs` can be set. Only one of `rateLimitConfigs`, `ratelimit`, `ratelimitStaged`, or `rateLimitStagedConfigs` can be set. |
| `rateLimitStagedConfigs` | [.ratelimit.options.gloo.solo.io.RateLimitStagedConfigRefs](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitstagedconfigrefs) | References to RateLimitConfig resources. This is used to configure the GlooE rate limit server. Only one of `ratelimit`, `ratelimit_staged`, `rate_limit_configs` or `rate_limit_staged_configs` can be set. Only one of `rateLimitStagedConfigs`, `ratelimit`, `ratelimitStaged`, or `rateLimitConfigs` can be set. |
| `waf` | [.waf.options.gloo.solo.io.Settings](../enterprise/options/waf/waf.proto.sk/#settings) | Enterprise-only: Config for Web Application Firewall (WAF), supporting the popular ModSecurity 3.0 ruleset. |
...
"ratelimitStaged": .ratelimit.options.gloo.solo.io.RateLimitStagedRouteExtension
"rateLimitConfigs": .ratelimit.options.gloo.solo.io.RateLimitConfigRefs
"rateLimitStagedConfigs": .ratelimit.options.gloo.solo.io.RateLimitStagedConfigRefs
"waf": .waf.options.gloo.solo.io.Settings
...
| `ratelimitStaged` | [.ratelimit.options.gloo.solo.io.RateLimitStagedRouteExtension](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitstagedrouteextension) | TODO (sam-heilbron). Only one of `ratelimitStaged`, `ratelimit`, `rateLimitConfigs`, or `rateLimitStagedConfigs` can be set. |
...
| `rateLimitStagedConfigs` | [.ratelimit.options.gloo.solo.io.RateLimitStagedConfigRefs](../enterprise/options/ratelimit/ratelimit.proto.sk/#ratelimitstagedconfigrefs) | TODO (sam-heilbron). Only one of `rateLimitStagedConfigs`, `ratelimit`, `ratelimitStaged`, or `rateLimitConfigs` can be set. |
| `waf` | [.waf.options.gloo.solo.io.Settings](../enterprise/options/waf/waf.proto.sk/#settings) | Enterprise-only: Config for Web Application Firewall (WAF), supporting the popular ModSecurity 3.0 ruleset. |

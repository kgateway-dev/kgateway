...
| `statefulSession` | [.statefulsession.options.gloo.solo.io.StatefulSession](../enterprise/options/statefulsession/statefulsession.proto.sk/#statefulsession) | (DO_NOT_SUBMIT: make enterprise only) Enterprise only: Listener-level stateful session settings. |

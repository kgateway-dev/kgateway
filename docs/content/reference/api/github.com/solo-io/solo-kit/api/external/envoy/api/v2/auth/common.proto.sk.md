...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `certificateChain` | [.solo.io.envoy.api.v2.core.DataSource](../../core/base.proto.sk/#datasource) | The TLS certificate chain. |
| `privateKey` | [.solo.io.envoy.api.v2.core.DataSource](../../core/base.proto.sk/#datasource) | The TLS private key. |
| `privateKeyProvider` | [.solo.io.envoy.api.v2.auth.PrivateKeyProvider](../common.proto.sk/#privatekeyprovider) | BoringSSL private key method provider. This is an alternative to :ref:`private_key <envoy_api_field_auth.TlsCertificate.private_key>` field. This can't be marked as ``oneof`` due to API compatibility reasons. Setting both :ref:`private_key <envoy_api_field_auth.TlsCertificate.private_key>` and :ref:`private_key_provider <envoy_api_field_auth.TlsCertificate.private_key_provider>` fields will result in an error. |
| `password` | [.solo.io.envoy.api.v2.core.DataSource](../../core/base.proto.sk/#datasource) | The password to decrypt the TLS private key. If this field is not set, it is assumed that the TLS private key is not password encrypted. |
| `ocspStaple` | [.solo.io.envoy.api.v2.core.DataSource](../../core/base.proto.sk/#datasource) | [#not-implemented-hide:]. |
| `signedCertificateTimestamp` | [[]solo.io.envoy.api.v2.core.DataSource](../../core/base.proto.sk/#datasource) | [#not-implemented-hide:]. |

...
```yaml
"versionInfo": string
"node": .solo.io.envoy.config.core.v3.Node
...
| `node` | [.solo.io.envoy.config.core.v3.Node](../../../../config/core/v3/base.proto.sk/#node) | The node making the request. |
...
"typeUrl": string
"nonce": string
"controlPlane": .solo.io.envoy.config.core.v3.ControlPlane
...
| `controlPlane` | [.solo.io.envoy.config.core.v3.ControlPlane](../../../../config/core/v3/base.proto.sk/#controlplane) | The control plane instance that sent the response. |
...
| `controlPlane` | [.solo.io.envoy.config.core.v3.ControlPlane](../../../../config/core/v3/base.proto.sk/#controlplane) | [#not-implemented-hide:] The control plane instance that sent the response. |

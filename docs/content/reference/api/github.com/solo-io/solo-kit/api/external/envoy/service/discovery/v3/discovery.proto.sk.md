...
##### Source File: [github.com/solo-io/solo-kit/api/external/envoy/service/discovery/v3/discovery.proto](https://github.com/solo-io/solo-kit/blob/master/api/external/envoy/service/discovery/v3/discovery.proto)
...
```yaml
"versionInfo": string
"node": .solo.io.kit.envoy.config.core.v3.Node
...
| `node` | [.solo.io.kit.envoy.config.core.v3.Node](../../../../config/core/v3/base.proto.sk/#node) | The node making the request. |
...
| `errorDetail` | [.google.rpc.Status](../../../../../google/rpc/status.proto.sk/#status) | This is populated when the previous :ref:`DiscoveryResponse <envoy_api_msg_service.discovery.v3.DiscoveryResponse>` failed to update configuration. The *message* field in *error_details* provides the Envoy internal exception related to the failure. It is only intended for consumption during manual debugging, the string provided is not guaranteed to be stable across Envoy versions. |
...
"typeUrl": string
"nonce": string
"controlPlane": .solo.io.kit.envoy.config.core.v3.ControlPlane
...
| `controlPlane` | [.solo.io.kit.envoy.config.core.v3.ControlPlane](../../../../config/core/v3/base.proto.sk/#controlplane) | The control plane instance that sent the response. |
...
| ----- | ---- | ----------- | 
| `node` | [.solo.io.kit.envoy.config.core.v3.Node](../../../../config/core/v3/base.proto.sk/#node) | The node making the request. |
| `typeUrl` | `string` | Type of the resource that is being requested, e.g. "type.googleapis.com/envoy.api.v2.ClusterLoadAssignment". This does not need to be set if resources are only referenced via *xds_resource_subscribe* and *xds_resources_unsubscribe*. |
...
| `errorDetail` | [.google.rpc.Status](../../../../../google/rpc/status.proto.sk/#status) | This is populated when the previous :ref:`DiscoveryResponse <envoy_api_msg_service.discovery.v3.DiscoveryResponse>` failed to update configuration. The *message* field in *error_details* provides the Envoy internal exception related to the failure. |
...
"resources": []envoy.service.discovery.v3.Resource
"typeUrl": string
...
| `resources` | [[]envoy.service.discovery.v3.Resource](../discovery.proto.sk/#resource) | The response resources. These are typed resources, whose types must match the type_url field. |
...
| `controlPlane` | [.solo.io.kit.envoy.config.core.v3.ControlPlane](../../../../config/core/v3/base.proto.sk/#controlplane) | [#not-implemented-hide:] The control plane instance that sent the response. |
...
"cacheControl": .envoy.service.discovery.v3.Resource.CacheControl
...
| `aliases` | `[]string` | The aliases are a list of other names that this resource can go by. |
...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `doNotCache` | `bool` | If true, xDS proxies may not cache this resource. Note that this does not apply to clients other than xDS proxies, which must cache resources for their own use, regardless of the value of this field. |

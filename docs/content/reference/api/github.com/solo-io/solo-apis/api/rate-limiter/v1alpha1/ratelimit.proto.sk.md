...
```yaml
"raw": .ratelimit.solo.io.RateLimitConfigSpec.Raw

```

| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `raw` | [.ratelimit.solo.io.RateLimitConfigSpec.Raw](../ratelimit.proto.sk/#raw) | Define a policy using the raw configuration format used by the server and the client (Envoy). |  |
...
| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `descriptors` | [[]ratelimit.solo.io.Descriptor](../ratelimit.proto.sk/#descriptor) | The descriptors that will be applied to the server. |  |
| `rateLimits` | [[]ratelimit.solo.io.RateLimitActions](../ratelimit.proto.sk/#ratelimitactions) | Actions specify how the client (Envoy) will compose the descriptors that will be sent to the server to make a rate limiting decision. |  |
...
```yaml
"state": .ratelimit.solo.io.RateLimitConfigStatus.State
"message": string
...
| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `state` | [.ratelimit.solo.io.RateLimitConfigStatus.State](../ratelimit.proto.sk/#state) | The current state of the `RateLimitConfig`. |  |
...
"key": string
"value": string
"rateLimit": .ratelimit.solo.io.RateLimit
"descriptors": []ratelimit.solo.io.Descriptor
"weight": int
"alwaysApply": bool
...
| `rateLimit` | [.ratelimit.solo.io.RateLimit](../ratelimit.proto.sk/#ratelimit) | Optional rate limit rule for the descriptor. |  |
| `descriptors` | [[]ratelimit.solo.io.Descriptor](../ratelimit.proto.sk/#descriptor) | Nested descriptors. |  |
...
```yaml
"actions": []ratelimit.solo.io.Action

```

| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `actions` | [[]ratelimit.solo.io.Action](../ratelimit.proto.sk/#action) |  |  |
...
```yaml
"unit": .ratelimit.solo.io.RateLimit.Unit
"requestsPerUnit": int
...
| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `unit` | [.ratelimit.solo.io.RateLimit.Unit](../ratelimit.proto.sk/#unit) |  |  |
| `requestsPerUnit` | `int` |  |  |
...
```yaml
"sourceCluster": .ratelimit.solo.io.Action.SourceCluster
"destinationCluster": .ratelimit.solo.io.Action.DestinationCluster
"requestHeaders": .ratelimit.solo.io.Action.RequestHeaders
"remoteAddress": .ratelimit.solo.io.Action.RemoteAddress
"genericKey": .ratelimit.solo.io.Action.GenericKey
"headerValueMatch": .ratelimit.solo.io.Action.HeaderValueMatch

```

| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `sourceCluster` | [.ratelimit.solo.io.Action.SourceCluster](../ratelimit.proto.sk/#sourcecluster) | Rate limit on source cluster. Only one of `sourceCluster`, `destinationCluster`, `requestHeaders`, `remoteAddress`, or `headerValueMatch` can be set. |  |
| `destinationCluster` | [.ratelimit.solo.io.Action.DestinationCluster](../ratelimit.proto.sk/#destinationcluster) | Rate limit on destination cluster. Only one of `destinationCluster`, `sourceCluster`, `requestHeaders`, `remoteAddress`, or `headerValueMatch` can be set. |  |
| `requestHeaders` | [.ratelimit.solo.io.Action.RequestHeaders](../ratelimit.proto.sk/#requestheaders) | Rate limit on request headers. Only one of `requestHeaders`, `sourceCluster`, `destinationCluster`, `remoteAddress`, or `headerValueMatch` can be set. |  |
| `remoteAddress` | [.ratelimit.solo.io.Action.RemoteAddress](../ratelimit.proto.sk/#remoteaddress) | Rate limit on remote address. Only one of `remoteAddress`, `sourceCluster`, `destinationCluster`, `requestHeaders`, or `headerValueMatch` can be set. |  |
| `genericKey` | [.ratelimit.solo.io.Action.GenericKey](../ratelimit.proto.sk/#generickey) | Rate limit on a generic key. Only one of `genericKey`, `sourceCluster`, `destinationCluster`, `requestHeaders`, or `headerValueMatch` can be set. |  |
| `headerValueMatch` | [.ratelimit.solo.io.Action.HeaderValueMatch](../ratelimit.proto.sk/#headervaluematch) | Rate limit on the existence of request headers. Only one of `headerValueMatch`, `sourceCluster`, `destinationCluster`, `requestHeaders`, or `genericKey` can be set. |  |
...
"headers": []ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher
...
"exactMatch": string
"regexMatch": string
"rangeMatch": .ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher.Int64Range
"presentMatch": bool
"prefixMatch": string
"suffixMatch": string
"invertMatch": bool

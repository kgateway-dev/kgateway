...
{{< readfile file="security/security/ldap/vs-echo-no-auth.sh">}}
{{< /highlight >}}
...
```bash
{{< readfile file="security/security/ldap/setup-ldap.sh" >}}
```
{{% /expand %}}
...
{{< readfile file="security/security/ldap/vs-auth-ldap.sh" >}}
{{< /highlight >}}

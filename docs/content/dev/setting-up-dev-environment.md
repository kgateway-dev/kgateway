...
Awesome! You're ready to start developing on Gloo! Check out the [Writing Upstream Plugins Guide]({{% versioned_link_path fromRoot="/dev/writing-upstream-plugins.md" %}}) to see how to add plugins to gloo.

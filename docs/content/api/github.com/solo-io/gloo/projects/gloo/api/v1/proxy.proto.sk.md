...
- [UpstreamDestination](#upstreamdestination)
...
```yaml
"upstream": .gloo.solo.io.UpstreamDestination
...
| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `upstream` | [.gloo.solo.io.UpstreamDestination](../proxy.proto.sk/#upstreamdestination) | Route requests to a Gloo upstream. Only one of `upstream`, or `consul` can be set. |  |
...
| Field | Type | Description | Default |
| ----- | ---- | ----------- |----------- | 
| `ref` | [.core.solo.io.ResourceRef](../../../../../../solo-kit/api/v1/ref.proto.sk/#resourceref) | Route requests to a Gloo upstream. |  |

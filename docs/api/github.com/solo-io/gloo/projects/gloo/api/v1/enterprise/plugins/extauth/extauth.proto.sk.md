...
| `requestBody` | [.auth.glooe.solo.io.BufferSettings](../extauth.proto.sk#buffersettings) | Set this if you also want to send the body of the request, and not just the headers. |  |
...
```yaml
"pathPrefix": string
"request": .auth.glooe.solo.io.HttpService.Request
"response": .auth.glooe.solo.io.HttpService.Response
...
| `request` | [.auth.glooe.solo.io.HttpService.Request](../extauth.proto.sk#request) |  |  |
| `response` | [.auth.glooe.solo.io.HttpService.Response](../extauth.proto.sk#response) |  |  |
